...
/*@ nullable_by_default @*/ 
public class JMLEqualsToObjectRelationImageEnumerator
    ...
    /*@ normal_behavior
      ...
      @    ensures owner == null;
      @*/
    JMLEqualsToObjectRelationImageEnumerator(/*@ non_null @*/
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLEqualsToObjectRelationImageEnumerator(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
             || !(oth instanceof JMLEqualsToObjectRelationImageEnumerator)){
            return false;
        } else {
            JMLEqualsToObjectRelationImageEnumerator js
                = (JMLEqualsToObjectRelationImageEnumerator) oth;
        ...
        JMLValueSet abstractValue()
    {
        ...
        JMLEqualsToObjectRelationImageEnumerator enum2
