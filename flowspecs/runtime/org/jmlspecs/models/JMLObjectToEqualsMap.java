...
/*@ nullable_by_default @*/ 
class JMLObjectToEqualsMap extends JMLObjectToEqualsRelation {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLObjectToEqualsMap(/*@ non_null @*/ Object dv,
                                   /*@ non_null @*/ Object rv)
    {
        super(dv, rv);
    }
     ...
     * @see #JMLObjectToEqualsMap(Object, Object)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLObjectToEqualsMap(dv, rv));
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        ...
        singletonMap(/*@ non_null @*/ Object dv,
                     /*@ non_null @*/ Object rv)
    {
        return new JMLObjectToEqualsMap(dv, rv);
    }
    ...
    public static /*@ pure @*/ /*@ non_null @*/
        JMLObjectToEqualsMap
        singletonMap(/*@ non_null @*/ JMLObjectEqualsPair pair)
    {
        return new JMLObjectToEqualsMap(pair);
    }
    ...
    /*@ also
      @   public normal_behavior
      @     ensures \result instanceof JMLObjectToEqualsMap
      @          && ((JMLObjectToEqualsMap)\result)
      @                .theRelation.equals(this.theRelation);
      @*/
    //@ pure
    public /*@ non_null @*/ Object clone() 
    {
        return new JMLObjectToEqualsMap(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
     ...
     * @see JMLObjectToEqualsRelation#insert(JMLObjectEqualsPair)
     */
    /*@  public normal_behavior
      @    requires dv != null && rv != null;
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectToEqualsMap extend(/*@ non_null @*/ Object dv,
                                       /*@ non_null @*/ Object rv) 
    {
        JMLObjectToEqualsMap newMap = this.removeDomainElement(dv);
        newMap = newMap.disjointUnion(new JMLObjectToEqualsMap(dv, rv));
        return newMap;
    } //@ nowarn Exception;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectToEqualsMap removeDomainElement(Object dv)
    {
    ...
    public /*@ non_null @*/ 
        JMLObjectToEqualsMap
        extendUnion(/*@ non_null @*/ JMLObjectToEqualsMap othMap) 
        throws IllegalStateException
    {
        JMLObjectToEqualsMap newMap 
            = this.restrictedTo(this.domain_.difference(othMap.domain_));
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            return
                new JMLObjectToEqualsMap(newMap.imagePairSet_
        ...
        throws IllegalStateException
    {
        ...
        JMLObjectToEqualsRelation newRel;
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            newRel = new JMLObjectToEqualsRelation(newMap.imagePairSet_
                                                      .union(othMap
                                                             .imagePairSet_),
                                                      newMap.domain_
                                                      .union(othMap.domain_),
    ...
    public /*@ non_null @*/ 
        JMLObjectToEqualsMap 
        disjointUnion(/*@ non_null @*/ JMLObjectToEqualsMap othMap) 
        throws JMLMapException, IllegalStateException
    {
        ...
        if (overlappingDom.isEmpty()) {
            if (this.size_ <= Integer.MAX_VALUE - othMap.size_) {
                return new JMLObjectToEqualsMap(this.imagePairSet_
                                                   .union(othMap
                                                          .imagePairSet_),
                                                   this.domain_
                                                   .union(othMap.domain_),
