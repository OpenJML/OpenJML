...
import static org.jmlspecs.openjml.JmlToken.CHANNEL;
...
import static org.jmlspecs.openjml.JmlToken.LEVEL;
...
//        }
    ...
    public final JmlToken[] allowedMethodAnnotations =
        ...
        PEER, REP, READONLY, CHANNEL, LEVEL // FIXME - allowing these until the rules are really implemented
...
//      and are subject to definite assignment checking.
    ...
    public JmlToken[] allowedFormalParameterModifiers = new JmlToken[] {
            NONNULL, NULLABLE, READONLY, REP, PEER, SECRET, CHANNEL, LEVEL
       };
       
    public JmlToken[] allowedLocalVarModifiers = new JmlToken[] {
            NONNULL, NULLABLE, GHOST, UNINITIALIZED, READONLY, REP, PEER, SECRET, LEVEL
       };
    ...
    public void allAllowed(List<JCTree.JCAnnotation> annotations, JmlToken[] allowed, String place) {
        outer: for (JCTree.JCAnnotation a: annotations) {
            ...
            if (a.annotationType.type.tsym.packge().flatName().equals(annotationPackageName)) { // FIXME - change to comparing symbols instead of strings?
                ...
                // make these new messages a little more descriptive.
                if(a.annotationType.type.tsym.flatName().equals(tokenToAnnotationName.get(JmlToken.CHANNEL))){
                    log.error(a.pos,"jml.channel.misplaced",place);
                }else if(a.annotationType.type.tsym.flatName().equals(tokenToAnnotationName.get(JmlToken.LEVEL))){
                    log.error(a.pos,"jml.level.misplaced",place);
                }else{
