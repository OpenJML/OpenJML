...
public @Pure final strictfp class JMLMath {
     ...
     */
    //@ public static model \real PI;

    // Trig functions, etc.

    /**
     * Returns the correctly rounded non-negative square root of a 
     * <code>\real</code> value.
     * 
     * @param   a   a value.
     * <!--@return  the value of &radic;&nbsp;<code>a</code>.-->
     * @return  the non-negative square root of <code>a</code>.
     */
    /*@
      @ public normal_behavior
      @  ensures \result >= 0 && \result * \result == a;
      @*/
    //@ model public static \real sqrt(\real a);
    ...
    /*@
      ...
      @  ensures \result - a < 1;
      @*/
    //@ model public static \real ceil(\real a);
    ...
    /*@
      ...
      @  ensures a - \result < 1;
      @*/
    //@ model public static  \real floor(\real a);
    ...
    /*@
      ...
      @*/
    //@ model public static \real rint(\real a);

    /*@
    @ public normal_behavior
    @  ensures \result - a <= 0.5 && \result - a >= -0.5 &&
    @          abs(\result - a) == 0.5 ==> \result % 2 == 0;
    @  ensures isInteger(\result);
    @*/
  //@ model public static \bigint nearestInteger(\real a);

    /*@
    @ public normal_behavior
    @  ensures (* a is an integer *);
    @*/
  //@ model public static boolean isInteger(\real a);
    ...
    /*@
      ...
      @  ensures (* \result == TBC *);
      @*/
    //@ model public static \real pow(\real a, \real b);
    ...
    /*@
      ...
      @
      @ model public static \bigint round(\real a) {
    ...
    /*@
      ...
      @
      @ model public static \bigint abs(\bigint a) {
      @   return (a < 0) ? -a : a;
      @ }
      @*/
    ...
    /*@
      ...
      @  ensures \result == ((a < 0) ? - a : a);
      @
      @ model public static \real abs(\real a) {
      @   return (a < 0) ? - a : a;
      @ }
      @*/
    ...
    /*@
      ...
      @
      @ model public static \bigint max(\bigint a, \bigint b) {
      @   return (a >= b) ? a : b;
      @ }
      @*/
    ...
    /*@
      ...
      @  ensures \result == ((a >= b) ? a : b);
      @
      @ model public static \real max(\real a, \real b) {
      @   return (a >= b) ? a : b;
      @ }
      @*/
    ...
    /*@
      ...
      @  ensures \result == ((a <= b) ? a : b);
      @
      @ model public static \bigint min(\bigint a, \bigint b) {
      @   return (a <= b) ? a : b;
      @ }
      @*/
    ...
    /*@
      ...
      @  ensures \result == ((a <= b) ? a : b);
      @
      @ model public static \real min(\real a, \real b) {
      @   return (a <= b) ? a : b;
      @ }
      @*/
