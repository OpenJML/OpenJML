...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify /modifiesOnLoop /noinfer CallLoop.dll
...
{
  var $Heap$block1377$LoopPreheader: [ref,<x>name]x;
  ...
  block1360:
    goto block1377$LoopPreheader;

  block1377:
    // ----- default loop invariant: allocation and ownership are stable
    assume (forall $o: ref :: $Heap$block1377$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block1377$LoopPreheader[$ot, $allocated] == true && $Heap$block1377$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block1377$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block1377$LoopPreheader[$ot, $ownerFrame]) && $Heap$block1377$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field
    assume (forall $o: ref :: ($Heap$block1377$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block1377$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block1377$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block1377$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields
    assert (forall $o: ref :: $o != null && $Heap$block1377$LoopPreheader[$o, $allocated] == true ==> $Heap$block1377$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block1377$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- default loop invariant: modifies
    assert (forall $o: ref, $f: name :: { $Heap[$o, $f] } $f != $inv && $f != $localinv && $f != $FirstConsistentOwner && (!IsStaticField($f) || !IsDirectlyModifiableField($f)) && $o != null && old($Heap)[$o, $allocated] == true && (old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame]) || old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])) && old(true) && old($o != this || $f != $exposeVersion) ==> $Heap$block1377$LoopPreheader[$o, $f] == $Heap[$o, $f]);
    goto block1394;

  block1394:
    // ----- call  ----- CallLoop.ssc(8,7)
    assert this != null;
    call Test.Other(this);
    // ----- branch  ----- CallLoop.ssc(9,6)
    goto block1377;

  block1377$LoopPreheader:
    $Heap$block1377$LoopPreheader := $Heap;
    goto block1377;
