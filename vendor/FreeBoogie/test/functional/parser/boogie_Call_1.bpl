...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify Call.exe
...
{
  var stack50000o: ref, stack0o: ref, d: ref where $Is(d, Call), local1: ref where $Is(local1, Call), stack1s: struct, stack1o: ref, temp0: exposeVersionType, stack0i: int, temp1: exposeVersionType, c: ref where $Is(c, Call);
  ...
  block1955:
    // ----- new object  ----- Call.ssc(10,5)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Call;
    ...
    // ----- copy  ----- Call.ssc(11,13)
    stack0o := local1;
    // ----- load token  ----- Call.ssc(11,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Call);
    // ----- statically resolved GetTypeFromHandle call  ----- Call.ssc(11,13)
    stack1o := TypeObject(Call);
    // ----- local unpack  ----- Call.ssc(11,13)
    assert stack0o != null;
    assert ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && $Heap[stack0o, $inv] <: Call && $Heap[stack0o, $localinv] == $typeof(stack0o);
  ...
  block1972:
    // ----- load constant 5  ----- Call.ssc(13,7)
    stack0i := 5;
    // ----- store field  ----- Call.ssc(13,7)
    assert d != null;
    havoc temp1;
    $Heap[d, $exposeVersion] := temp1;
    $Heap[d, Call.x] := stack0i;
    assume IsHeap($Heap);
    // ----- branch
    goto block2023;
  ...
  block2023:
    // ----- copy  ----- Call.ssc(14,5)
    stack0o := local1;
    // ----- load token  ----- Call.ssc(14,5)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Call);
    // ----- statically resolved GetTypeFromHandle call  ----- Call.ssc(14,5)
    stack1o := TypeObject(Call);
    // ----- local pack  ----- Call.ssc(14,5)
    assert stack0o != null;
    assert $Heap[stack0o, $localinv] == System.Object;
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == stack0o && $Heap[$p, $ownerFrame] == Call ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
  ...
  block1989:
    // ----- load field  ----- Call.ssc(15,5)
    assert d != null;
    stack0i := $Heap[d, Call.x];
    // ----- call  ----- Call.ssc(15,5)
    assert d != null;
    call Call.M$System.Int32(d, stack0i);
    // ----- new object  ----- Call.ssc(17,5)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Call;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    ...
    // ----- copy  ----- Call.ssc(17,5)
    c := stack0o;
    // ----- load constant 5  ----- Call.ssc(18,5)
    stack0i := 5;
    // ----- call  ----- Call.ssc(18,5)
    assert c != null;
    call Call.M$System.Int32(c, stack0i);
    // ----- return  ----- Call.ssc(19,3)
    return;
...
implementation Call..ctor(this: ref)
{
  ...
  block2635:
    ...
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Call ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Call;
    assume IsHeap($Heap);
    return;
