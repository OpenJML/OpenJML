...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify SimpleWhile0.dll /infer:i
...
{
  var i: int where InRange(i, System.Int32), counter: int where InRange(counter, System.Int32), stack0i: int, stack0b: bool, stack0o: ref, $Heap$block1394$LoopPreheader: [ref,<x>name]x;

  entry:
    assume $IsNotNull(this, SimpleWhile0);
  ...
  block1377:
    // ----- load constant 0  ----- SimpleWhile0.ssc(5,3)
    i := 0;
    // ----- load constant 0  ----- SimpleWhile0.ssc(6,3)
    counter := 0;
    goto block1394$LoopPreheader;

  block1394:
    // ----- default loop invariant: allocation and ownership are stable  ----- SimpleWhile0.ssc(8,3)
    assume (forall $o: ref :: $Heap$block1394$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block1394$LoopPreheader[$ot, $allocated] == true && $Heap$block1394$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block1394$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block1394$LoopPreheader[$ot, $ownerFrame]) && $Heap$block1394$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- SimpleWhile0.ssc(8,3)
    assume (forall $o: ref :: ($Heap$block1394$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block1394$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block1394$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block1394$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- SimpleWhile0.ssc(8,3)
    assert (forall $o: ref :: $o != null && $Heap$block1394$LoopPreheader[$o, $allocated] == true ==> $Heap$block1394$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block1394$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 100  ----- SimpleWhile0.ssc(8,3)
    stack0i := 100;
    // ----- binary operator  ----- SimpleWhile0.ssc(8,3)
    // ----- branch  ----- SimpleWhile0.ssc(8,3)
    goto true1394to1513, false1394to1411;

  true1394to1513:
    assume counter >= stack0i;
    goto block1513;
  ...
  block1513:
    // ----- serialized AssertStatement  ----- SimpleWhile0.ssc(15,3)
    assert i >= 0;
    goto block1598;

  block1411:
    // ----- serialized AssertStatement  ----- SimpleWhile0.ssc(10,4)
    assert counter >= 0;
    goto block1496;

  block1496:
    // ----- nop
    // ----- load constant 1  ----- SimpleWhile0.ssc(11,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile0.ssc(11,4)
    stack0i := counter + stack0i;
    // ----- copy  ----- SimpleWhile0.ssc(11,4)
    counter := stack0i;
    // ----- load constant 1  ----- SimpleWhile0.ssc(12,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile0.ssc(12,4)
    stack0i := i + stack0i;
    // ----- copy  ----- SimpleWhile0.ssc(12,4)
    i := stack0i;
    // ----- branch  ----- SimpleWhile0.ssc(13,4)
    goto block1394;

  block1598:
    // ----- nop
    // ----- return  ----- SimpleWhile0.ssc(16,2)
    return;

  block1394$LoopPreheader:
    $Heap$block1394$LoopPreheader := $Heap;
    goto block1394;
...
implementation SimpleWhile0..ctor(this: ref)
{
  ...
  block2125:
    // ----- call  ----- SimpleWhile0.ssc(1,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == SimpleWhile0 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := SimpleWhile0;
    assume IsHeap($Heap);
    return;
