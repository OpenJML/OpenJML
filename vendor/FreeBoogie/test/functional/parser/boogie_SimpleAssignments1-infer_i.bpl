...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify SimpleAssignments1.dll /infer:i
...
{
  var val: int where InRange(val, System.Int32), a: int where InRange(a, System.Int32), stack0i: int, stack0b: bool, b: int where InRange(b, System.Int32), stack1i: int, stack0o: ref, c: int where InRange(c, System.Int32), d: int where InRange(d, System.Int32);

  entry:
    assume $IsNotNull(this, SimpleAssignments1);
  ...
  block1530:
    // ----- load constant 3  ----- SimpleAssignments1.ssc(10,3)
    a := 3;
    // ----- load constant 0  ----- SimpleAssignments1.ssc(12,3)
    stack0i := 0;
    // ----- binary operator  ----- SimpleAssignments1.ssc(12,3)
    // ----- branch  ----- SimpleAssignments1.ssc(12,3)
    goto true1530to1564, false1530to1547;
  ...
  block1564:
    // ----- load constant 13  ----- SimpleAssignments1.ssc(18,4)
    stack0i := 13;
    // ----- load constant 5  ----- SimpleAssignments1.ssc(18,4)
    stack1i := 5;
    // ----- binary operator  ----- SimpleAssignments1.ssc(18,4)
    stack1i := stack1i + a;
    // ----- binary operator  ----- SimpleAssignments1.ssc(18,4)
    stack0i := stack0i * stack1i;
    // ----- copy  ----- SimpleAssignments1.ssc(18,4)
    b := stack0i;
    // ----- nop  ----- SimpleAssignments1.ssc(21,3)
    goto block1581;

  block1547:
    // ----- load constant 2  ----- SimpleAssignments1.ssc(14,4)
    stack0i := 2;
    // ----- binary operator  ----- SimpleAssignments1.ssc(14,4)
    stack0i := stack0i + a;
    // ----- unary operator  ----- SimpleAssignments1.ssc(14,4)
    stack0i := 0 - stack0i;
    // ----- copy  ----- SimpleAssignments1.ssc(14,4)
    b := stack0i;
    // ----- branch  ----- SimpleAssignments1.ssc(16,3)
    goto block1581;

  block1581:
    // ----- serialized AssertStatement  ----- SimpleAssignments1.ssc(21,3)
    assert -5 <= b && b <= 104;
    goto block1700;

  block1700:
    // ----- nop
    // ----- binary operator  ----- SimpleAssignments1.ssc(23,3)
    stack0i := a * b;
    // ----- copy  ----- SimpleAssignments1.ssc(23,3)
    c := stack0i;
    // ----- serialized AssertStatement  ----- SimpleAssignments1.ssc(25,3)
    assert -15 <= c && c <= 312;
    goto block1819;

  block1819:
    // ----- nop
    // ----- binary operator  ----- SimpleAssignments1.ssc(27,3)
    stack0i := c - c;
    // ----- copy  ----- SimpleAssignments1.ssc(27,3)
    d := stack0i;
    // ----- serialized AssertStatement  ----- SimpleAssignments1.ssc(29,3)
    assert d == 0;
    goto block1904;

  block1904:
    // ----- nop
    // ----- return  ----- SimpleAssignments1.ssc(31,2)
    return;
...
implementation SimpleAssignments1..ctor(this: ref)
{
  ...
  block2618:
    // ----- call  ----- SimpleAssignments1.ssc(4,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == SimpleAssignments1 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := SimpleAssignments1;
    assume IsHeap($Heap);
    return;
