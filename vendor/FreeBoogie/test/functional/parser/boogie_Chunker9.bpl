...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker9
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3723:
    // ----- load constant 0  ----- Chunker9.ssc(5,13)
    stack0i := 0;
    // ----- load field  ----- Chunker9.ssc(5,17)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker9.ssc(5,13)
    // ----- branch
    goto true3723to3842, false3723to3740;
  ...
  block3740:
    ...
    // ----- unary operator
    // ----- branch
    goto true3740to3791, false3740to3757;
  ...
  block3876:
    // ----- load constant 0  ----- Chunker9.ssc(7,13)
    stack0i := 0;
    // ----- load field  ----- Chunker9.ssc(7,18)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- binary operator  ----- Chunker9.ssc(7,13)
    // ----- branch
  ...
  block3893:
    // ----- load field  ----- Chunker9.ssc(7,23)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker9.ssc(7,28)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker9.ssc(7,28)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker9.ssc(7,23)
    // ----- branch
    goto true3893to3927, false3893to3910;
  ...
  block3961:
    assume false;
    // ----- new object  ----- Chunker9.ssc(7,3)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Chunker9.ssc(7,3)
    assert stack50000o != null;
    call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o);
    // ----- copy  ----- Chunker9.ssc(7,3)
    stack0o := stack50000o;
    // ----- throw  ----- Chunker9.ssc(7,3)
    assert stack0o != null;
    assume false;
    return;
...
{
  var stack0i: int, stack1i: int, stack1o: ref, stack0b: bool, stack0o: ref, stack2i: int, s: ref where $Is(s, System.String), return.value: ref where $IsNotNull(return.value, System.String), SS$Display.Return.Local: ref where $IsNotNull(SS$Display.Return.Local, System.String);
  ...
  block5219:
    // ----- load field  ----- Chunker9.ssc(13,9)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker9.ssc(13,13)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker9.ssc(13,9)
    stack0i := stack0i + stack1i;
    // ----- load field  ----- Chunker9.ssc(13,26)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker9.ssc(13,26)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker9.ssc(13,9)
    // ----- branch  ----- Chunker9.ssc(13,5)
    goto true5219to5270, false5219to5236;
  ...
  block5270:
    // ----- load field  ----- Chunker9.ssc(16,11)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker9.ssc(16,25)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- call  ----- Chunker9.ssc(16,7)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32(stack0o, stack1i);
    // ----- nop  ----- Chunker9.ssc(18,5)
    goto block5287;

  block5236:
    // ----- load field  ----- Chunker9.ssc(14,11)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker9.ssc(14,25)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker9.ssc(14,28)
    assert this != null;
    stack2i := $Heap[this, Chunker.ChunkSize];
    // ----- call  ----- Chunker9.ssc(14,7)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i);
    goto block5253;

  block5253:
    // ----- branch  ----- Chunker9.ssc(15,7)
    goto block5287;
  ...
  block5304:
    // ----- load field  ----- Chunker9.ssc(18,5)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker9.ssc(18,10)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker9.ssc(18,5)
    stack0i := stack0i + stack1i;
    // ----- store field  ----- Chunker9.ssc(18,5)
    assert this != null;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this: ref, source$in: ref, chunkSize$in: int)
{
  ...
  block6732:
    // ----- store field  ----- Chunker9.ssc(25,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker9.ssc(26,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker9.ssc(27,9)
    stack0i := 0;
    // ----- store field  ----- Chunker9.ssc(27,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.n] := stack0i;
    assume IsHeap($Heap);
  ...
  block6919:
    // ----- FrameGuard processing  ----- Chunker9.ssc(29,3)
    temp0 := this;
    // ----- classic pack  ----- Chunker9.ssc(29,3)
    assert temp0 != null;
