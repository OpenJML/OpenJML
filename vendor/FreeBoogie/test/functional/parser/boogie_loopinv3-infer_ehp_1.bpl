...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify /infer:ehp loopinv3.dll
...
{
  var a: ref where $IsNotNull(a, ValueArray(System.Int32, 1)), local1: ref where $Is(local1, Foreach), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType, stack0i: int, temp1: exposeVersionType, sum: int where InRange(sum, System.Int32), local3: ref where $Is(local3, ValueArray(System.Int32, 1)), stack0b: bool, local4: int where InRange(local4, System.Int32), foreachIndex^.54267293: int where InRange(foreachIndex^.54267293, System.Int32), stack1i: int, local6: int where InRange(local6, System.Int32), k: int where InRange(k, System.Int32), $Heap$block1938$LoopPreheader: [ref,<x>name]x;

  entry:
    assume $IsNotNull(this, Foreach);
  ...
  block1870:
    // ----- nop
    // ----- copy  ----- loopinv3.ssc(10,13)
    local1 := this;
    // ----- copy  ----- loopinv3.ssc(10,13)
    stack0o := local1;
    // ----- load token  ----- loopinv3.ssc(10,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Foreach);
    // ----- statically resolved GetTypeFromHandle call  ----- loopinv3.ssc(10,13)
    stack1o := TypeObject(Foreach);
    // ----- local unpack  ----- loopinv3.ssc(10,13)
    assert stack0o != null;
    assert ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && $Heap[stack0o, $inv] <: Foreach && $Heap[stack0o, $localinv] == $typeof(stack0o);
  ...
  block1887:
    // ----- load constant 42  ----- loopinv3.ssc(10,21)
    stack0i := 42;
    // ----- store field  ----- loopinv3.ssc(10,21)
    assert this != null;
    havoc temp1;
    $Heap[this, $exposeVersion] := temp1;
    $Heap[this, Foreach.x] := stack0i;
    assume IsHeap($Heap);
    // ----- branch
    goto block2091;

  block2091:
    // ----- copy  ----- loopinv3.ssc(10,34)
    stack0o := local1;
    // ----- load token  ----- loopinv3.ssc(10,34)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Foreach);
    // ----- statically resolved GetTypeFromHandle call  ----- loopinv3.ssc(10,34)
    stack1o := TypeObject(Foreach);
    // ----- local pack  ----- loopinv3.ssc(10,34)
    assert stack0o != null;
    assert $Heap[stack0o, $localinv] == System.Object;
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == stack0o && $Heap[$p, $ownerFrame] == Foreach ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
  ...
  block1904:
    // ----- load constant 0  ----- loopinv3.ssc(12,5)
    sum := 0;
    // ----- copy  ----- loopinv3.ssc(13,5)
    local3 := a;
    // ----- copy
    stack0o := local3;
    // ----- unary operator
    // ----- branch
    goto true1904to1972, false1904to1921;
  ...
  block1972:
    // ----- serialized AssertStatement  ----- loopinv3.ssc(18,5)
    assert $Heap[this, Foreach.x] == 42;
    goto block2057;
  ...
  block1921:
    ...
    local4 := stack0i;
    // ----- load constant 0
    foreachIndex^.54267293 := 0;
    goto block1938$LoopPreheader;

  block1938:
    // ----- default loop invariant: allocation and ownership are stable  ----- loopinv3.ssc(13,5)
    assume (forall $o: ref :: $Heap$block1938$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block1938$LoopPreheader[$ot, $allocated] == true && $Heap$block1938$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block1938$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block1938$LoopPreheader[$ot, $ownerFrame]) && $Heap$block1938$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- loopinv3.ssc(13,5)
    assume (forall $o: ref :: ($Heap$block1938$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block1938$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block1938$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block1938$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- loopinv3.ssc(13,5)
    assert (forall $o: ref :: $o != null && $Heap$block1938$LoopPreheader[$o, $allocated] == true ==> $Heap$block1938$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block1938$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- serialized LoopInvariant  ----- loopinv3.ssc(13,5)
    assert foreachIndex^.54267293 >= 0;
    // ----- binary operator  ----- loopinv3.ssc(13,18)
    // ----- branch  ----- loopinv3.ssc(13,18)
    goto true1938to1972, false1938to1955;

  true1938to1972:
    assume foreachIndex^.54267293 >= local4;
    goto block1972;
  ...
  block1955:
    // ----- copy  ----- loopinv3.ssc(13,18)
    stack0o := local3;
    // ----- copy  ----- loopinv3.ssc(13,18)
    stack1i := foreachIndex^.54267293;
    // ----- load element  ----- loopinv3.ssc(13,18)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
    local6 := cast(ValueArrayGet($Heap[stack0o, $elements], stack1i),int);
    // ----- load constant 1
    stack0i := 1;
    // ----- binary operator
    stack0i := foreachIndex^.54267293 + stack0i;
    // ----- copy
    foreachIndex^.54267293 := stack0i;
    // ----- copy  ----- loopinv3.ssc(13,18)
    k := local6;
    // ----- binary operator  ----- loopinv3.ssc(15,7)
    stack0i := sum + k;
    // ----- copy  ----- loopinv3.ssc(15,7)
    sum := stack0i;
    // ----- branch
    goto block1938;
  ...
  block1938$LoopPreheader:
    $Heap$block1938$LoopPreheader := $Heap;
    goto block1938;
...
implementation Foreach..ctor(this: ref)
{
  ...
  block3009:
    // ----- call  ----- loopinv3.ssc(4,21)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Foreach ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Foreach;
    assume IsHeap($Heap);
    return;
