...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify quant0.dll
...
function #Test.Blah$System.Int32([ref,<x>name]x, int) returns (bool);
...
axiom (forall $Heap: [ref,<x>name]x, i$in: int :: { #Test.Blah$System.Int32($Heap, i$in) } IsHeap($Heap) && InRange(i$in, System.Int32) ==> true && #Test.Blah$System.Int32($Heap, i$in) == true);
...
{
  var i: int where InRange(i, System.Int32), return.value: bool where true, SS$Display.Return.Local: bool where true, stack0b: bool;
  ...
  block1258:
    // ----- load constant 1  ----- quant0.ssc(7,9)
    return.value := true;
    // ----- branch
    goto block1275;
...
{
  var args: ref where $Is(args, RefArray(System.String, 1)), stack0o: ref;
  ...
  block2329:
    // ----- nop
    // ----- serialized AssumeStatement  ----- quant0.ssc(24,9)
    assume args != null;
    goto block2414;

  block2414:
    // ----- nop
    // ----- copy  ----- quant0.ssc(25,9)
    stack0o := args;
    // ----- call  ----- quant0.ssc(25,9)
    call Test.MainX$System.optional...NonNullType.String.array$notnull(stack0o);
    // ----- return
    return;
...
{
  var args: ref where $IsNotNull(args, NonNullRefArray(System.String, 1)), stack0o: ref;
  ...
  block4250:
    // ----- nop
    // ----- serialized AssertStatement  ----- quant0.ssc(30,9)
    assert (forall ^i: int :: 0 <= ^i && ^i <= $Length(args) - 1 ==> RefArrayGet($Heap[args, $elements], ^i) != null);
    goto block4471;
...
{
  var args: ref where $IsNotNull(args, RefArray(System.String, 1)), stack0o: ref;
  ...
  block5185:
    // ----- nop
    // ----- serialized AssertStatement  ----- quant0.ssc(35,9)
    assert (forall ^i: int :: 0 <= ^i && ^i <= $Length(args) - 1 ==> RefArrayGet($Heap[args, $elements], ^i) != null);
    goto block5406;
