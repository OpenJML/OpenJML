...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify Array2.dll
...
{
  var a: ref where $IsNotNull(a, ValueArray(System.Int32, 1)), stack0o: ref, stack1i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32), stack0i: int;

  entry:
    assume $IsNotNull(this, test3.MyClass2);
  ...
  block2601:
    ...
    // ----- copy  ----- Array2.ssc(8,7)
    stack0o := a;
    // ----- load constant 0  ----- Array2.ssc(8,7)
    stack1i := 0;
    // ----- load element  ----- Array2.ssc(8,7)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
    return.value := cast(ValueArrayGet($Heap[stack0o, $elements], stack1i),int);
    // ----- branch
    goto block2618;
...
{
  var a: ref where $IsNotNull(a, RefArray(ValueArray(System.Int32, 1), 1)), stack0o: ref, stack1i: int, b: ref where $Is(b, ValueArray(System.Int32, 1)), stack0b: bool, stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block3638:
    // ----- nop
    // ----- copy  ----- Array2.ssc(14,7)
    stack0o := a;
    // ----- load constant 2  ----- Array2.ssc(14,7)
    stack1i := 2;
    // ----- load element  ----- Array2.ssc(14,7)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
    b := RefArrayGet($Heap[stack0o, $elements], stack1i);
    stack0o := null;
    // ----- binary operator  ----- Array2.ssc(15,7)
    // ----- branch  ----- Array2.ssc(15,7)
    goto true3638to3757, false3638to3655;
  ...
  block3757:
    // ----- load constant 4  ----- Array2.ssc(22,7)
    return.value := 4;
    // ----- branch
    goto block3774;

  block3655:
    // ----- array length  ----- Array2.ssc(16,9)
    assert b != null;
    stack0i := $Length(b);
    // ----- load constant 8  ----- Array2.ssc(16,9)
    stack1i := 8;
    // ----- binary operator  ----- Array2.ssc(16,9)
    // ----- branch  ----- Array2.ssc(16,9)
    goto true3655to3706, false3655to3672;
  ...
  block3706:
    // ----- array length  ----- Array2.ssc(18,16)
    assert b != null;
    stack0i := $Length(b);
    // ----- load constant 7  ----- Array2.ssc(18,16)
    stack1i := 7;
    // ----- binary operator  ----- Array2.ssc(18,16)
    // ----- branch  ----- Array2.ssc(18,16)
    goto true3706to3740, false3706to3723;

  block3672:
    // ----- copy  ----- Array2.ssc(17,11)
    stack0o := b;
    // ----- load constant 3  ----- Array2.ssc(17,11)
    stack1i := 3;
    // ----- load element  ----- Array2.ssc(17,11)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
    return.value := cast(ValueArrayGet($Heap[stack0o, $elements], stack1i),int);
  ...
  block3723:
    // ----- copy  ----- Array2.ssc(19,11)
    stack0o := a;
    // ----- load constant 2  ----- Array2.ssc(19,11)
    stack1i := 2;
    // ----- load element  ----- Array2.ssc(19,11)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
    ...
    assert stack0o != null;
    stack0o := stack0o;
    // ----- load constant 3  ----- Array2.ssc(19,11)
    stack1i := 3;
    // ----- load element  ----- Array2.ssc(19,11)
    assert stack0o != null;
    assert 0 <= stack1i;
...
{
  var a: ref where $IsNotNull(a, ValueArray(System.Int32, 2)), stack0i: int, stack1i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block4743:
    // ----- nop
    // ----- load constant 2  ----- Array2.ssc(28,7)
    stack0i := 2;
    // ----- load constant 3  ----- Array2.ssc(28,7)
    stack1i := 3;
    // ----- array getter rank 2  ----- Array2.ssc(28,7)
    assert a != null;
    assert 0 <= stack0i;
    assert stack0i < $DimLength(a, 0);
    assert 0 <= stack1i;
    assert stack1i < $DimLength(a, 1);
    return.value := cast(ValueArrayGet($Heap[a, $elements], ArrayIndex(a, 1, stack1i, stack0i)),int);
    // ----- branch
    goto block4760;
...
implementation test3.MyClass2..ctor(this: ref)
{
  ...
  block5083:
    // ----- call  ----- Array2.ssc(3,16)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == test3.MyClass2 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := test3.MyClass2;
    assume IsHeap($Heap);
    return;
