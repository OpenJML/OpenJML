...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker7
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3655:
    // ----- load constant 0  ----- Chunker7.ssc(5,13)
    stack0i := 0;
    // ----- load field  ----- Chunker7.ssc(5,17)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker7.ssc(5,13)
    // ----- branch
    goto true3655to3774, false3655to3672;
  ...
  block3808:
    // ----- load constant 0  ----- Chunker7.ssc(7,13)
    stack0i := 0;
    // ----- load field  ----- Chunker7.ssc(7,18)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- binary operator  ----- Chunker7.ssc(7,13)
    // ----- branch
    goto true3808to3927, false3808to3825;
  ...
  block3842:
    assume false;
    // ----- new object  ----- Chunker7.ssc(7,3)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Chunker7.ssc(7,3)
    assert stack50000o != null;
    call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o);
    // ----- copy  ----- Chunker7.ssc(7,3)
    stack0o := stack50000o;
    // ----- throw  ----- Chunker7.ssc(7,3)
    assert stack0o != null;
    assume false;
    return;
...
{
  var stack0o: ref, stack1i: int, stack2i: int, s: ref where $Is(s, System.String), stack0i: int, return.value: ref where $IsNotNull(return.value, System.String), SS$Display.Return.Local: ref where $IsNotNull(SS$Display.Return.Local, System.String);
  ...
  block4998:
    // ----- load field  ----- Chunker7.ssc(12,16)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker7.ssc(12,30)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker7.ssc(12,33)
    assert this != null;
    stack2i := $Heap[this, Chunker.ChunkSize];
    // ----- call  ----- Chunker7.ssc(12,5)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i);
    goto block5015;

  block5015:
    // ----- load field  ----- Chunker7.ssc(13,5)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker7.ssc(13,10)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker7.ssc(13,5)
    stack0i := stack0i + stack1i;
    // ----- store field  ----- Chunker7.ssc(13,5)
    assert this != null;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this: ref, source$in: ref, chunkSize$in: int)
{
  ...
  block6477:
    // ----- store field  ----- Chunker7.ssc(20,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker7.ssc(21,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker7.ssc(22,9)
    stack0i := 0;
    // ----- store field  ----- Chunker7.ssc(22,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.n] := stack0i;
    assume IsHeap($Heap);
  ...
  block6664:
    // ----- FrameGuard processing  ----- Chunker7.ssc(24,3)
    temp1 := this;
    // ----- classic pack  ----- Chunker7.ssc(24,3)
    assert temp1 != null;
