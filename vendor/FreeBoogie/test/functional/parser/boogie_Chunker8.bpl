...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker8
...
axiom (forall $oi: ref, $h: [ref,<x>name]x :: { $h[$oi, $inv] <: Chunker } IsHeap($h) && $h[$oi, $inv] <: Chunker && $h[$oi, $localinv] != System.Object ==> 0 < $h[$oi, Chunker.ChunkSize] && 0 <= $h[$oi, Chunker.n]);
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3672:
    // ----- load constant 0  ----- Chunker8.ssc(5,13)
    stack0i := 0;
    // ----- load field  ----- Chunker8.ssc(5,17)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker8.ssc(5,13)
    // ----- branch
    goto true3672to3791, false3672to3689;
  ...
  block3825:
    // ----- load constant 0  ----- Chunker8.ssc(7,13)
    stack0i := 0;
    // ----- load field  ----- Chunker8.ssc(7,18)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- binary operator  ----- Chunker8.ssc(7,13)
    // ----- branch
    goto true3825to3944, false3825to3842;
  ...
  block3859:
    assume false;
    // ----- new object  ----- Chunker8.ssc(7,3)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Chunker8.ssc(7,3)
    assert stack50000o != null;
    call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o);
    // ----- copy  ----- Chunker8.ssc(7,3)
    stack0o := stack50000o;
    // ----- throw  ----- Chunker8.ssc(7,3)
    assert stack0o != null;
    assume false;
    return;
...
{
  var stack0i: int, stack1i: int, stack1o: ref, stack0b: bool, stack0o: ref, s: ref where $Is(s, System.String), stack2i: int, return.value: ref where $IsNotNull(return.value, System.String), SS$Display.Return.Local: ref where $IsNotNull(SS$Display.Return.Local, System.String);
  ...
  block5100:
    // ----- load field  ----- Chunker8.ssc(13,9)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker8.ssc(13,13)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker8.ssc(13,9)
    stack0i := stack0i + stack1i;
    // ----- load field  ----- Chunker8.ssc(13,26)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker8.ssc(13,26)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker8.ssc(13,9)
    // ----- branch  ----- Chunker8.ssc(13,5)
  ...
  block5151:
    // ----- load field  ----- Chunker8.ssc(16,11)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker8.ssc(16,25)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- call  ----- Chunker8.ssc(16,7)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32(stack0o, stack1i);
    // ----- nop  ----- Chunker8.ssc(18,5)
    goto block5168;

  block5117:
    // ----- load field  ----- Chunker8.ssc(14,11)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker8.ssc(14,25)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker8.ssc(14,28)
    assert this != null;
    stack2i := $Heap[this, Chunker.ChunkSize];
    // ----- call  ----- Chunker8.ssc(14,7)
    assert stack0o != null;
  ...
  block5134:
    // ----- branch  ----- Chunker8.ssc(15,7)
    goto block5168;

  block5185:
    // ----- load field  ----- Chunker8.ssc(18,5)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker8.ssc(18,10)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker8.ssc(18,5)
    stack0i := stack0i + stack1i;
    // ----- store field  ----- Chunker8.ssc(18,5)
    assert this != null;
...
{
  var source: ref where $IsNotNull(source, System.String), chunkSize: int where InRange(chunkSize, System.Int32), temp0: exposeVersionType, stack0i: int, temp1: ref;
  ...
  block6647:
    // ----- store field  ----- Chunker8.ssc(25,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker8.ssc(26,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker8.ssc(27,9)
    stack0i := 0;
    // ----- store field  ----- Chunker8.ssc(27,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.n] := stack0i;
    assume IsHeap($Heap);
  ...
  block6834:
    // ----- FrameGuard processing  ----- Chunker8.ssc(29,3)
    temp1 := this;
    // ----- classic pack  ----- Chunker8.ssc(29,3)
    assert temp1 != null;
    assert $Heap[temp1, $inv] == System.Object && $Heap[temp1, $localinv] == $typeof(temp1);
    assert 0 < $Heap[temp1, Chunker.ChunkSize];
    assert 0 <= $Heap[temp1, Chunker.n];
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == temp1 && $Heap[$p, $ownerFrame] == Chunker ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[temp1, $inv] := Chunker;
    assume IsHeap($Heap);
    // ----- return
    return;
