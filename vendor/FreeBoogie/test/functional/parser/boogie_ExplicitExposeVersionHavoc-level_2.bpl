...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify /level:2 ExplicitExposeVersionHavoc.dll
...
function #D.Foo([ref,<x>name]x, ref) returns (int);

function ##D.Foo(exposeVersionType) returns (int);
...
implementation C.Foo(this: ref) returns ($result: int)
{
  ...
  block1360:
    // ----- load field  ----- ExplicitExposeVersionHavoc.ssc(13,5)
    assert this != null;
  ...
  block1377:
    ...
    // ----- copy  ----- ExplicitExposeVersionHavoc.ssc(14,3)
    stack0i := return.value;
    // ----- return  ----- ExplicitExposeVersionHavoc.ssc(14,3)
    $result := stack0i;
    return;
...
{
  var stack0o: ref, stack0i: int, temp0: exposeVersionType;
  ...
  block1785:
    // ----- serialized AssumeStatement  ----- ExplicitExposeVersionHavoc.ssc(19,5)
    assume #C.Foo($Heap, this) == 5;
    goto block1870;

  block1870:
    // ----- nop
    // ----- load constant 6  ----- ExplicitExposeVersionHavoc.ssc(20,5)
    stack0i := 6;
    // ----- store field  ----- ExplicitExposeVersionHavoc.ssc(20,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, C.x] := stack0i;
    assume IsHeap($Heap);
    // ----- serialized AssertStatement  ----- ExplicitExposeVersionHavoc.ssc(21,5)
    assert #C.Foo($Heap, this) == 5;
    goto block1955;

  block1955:
    // ----- nop
    // ----- return  ----- ExplicitExposeVersionHavoc.ssc(22,3)
    return;
...
implementation C..ctor(this: ref)
{
  ...
  block2329:
    // ----- call  ----- ExplicitExposeVersionHavoc.ssc(7,7)
    assert this != null;
...
{
  var stack0o: ref, stack1i: int, temp0: exposeVersionType;
  ...
  block2686:
    // ----- serialized AssumeStatement  ----- ExplicitExposeVersionHavoc.ssc(32,5)
    assume #C.Foo($Heap, $Heap[this, A.c]) == 5;
    goto block2771;

  block2771:
    // ----- nop
    // ----- load field  ----- ExplicitExposeVersionHavoc.ssc(33,5)
    assert this != null;
    stack0o := $Heap[this, A.c];
    // ----- load constant 6  ----- ExplicitExposeVersionHavoc.ssc(33,5)
    stack1i := 6;
    // ----- store field  ----- ExplicitExposeVersionHavoc.ssc(33,5)
    assert stack0o != null;
    havoc temp0;
    $Heap[stack0o, $exposeVersion] := temp0;
    $Heap[stack0o, C.x] := stack1i;
    assume IsHeap($Heap);
    // ----- serialized AssertStatement  ----- ExplicitExposeVersionHavoc.ssc(34,5)
    assert #C.Foo($Heap, $Heap[this, A.c]) == 5;
    goto block2856;

  block2856:
    // ----- nop
    // ----- return  ----- ExplicitExposeVersionHavoc.ssc(35,3)
    return;
...
implementation A..ctor(this: ref)
{
  ...
  block3247:
    // ----- new object  ----- ExplicitExposeVersionHavoc.ssc(27,3)
    havoc stack50000o;
    ...
    // ----- call  ----- ExplicitExposeVersionHavoc.ssc(27,3)
    assert stack50000o != null;
    call C..ctor(stack50000o);
    // ----- copy  ----- ExplicitExposeVersionHavoc.ssc(27,3)
    stack0o := stack50000o;
    // ----- store field  ----- ExplicitExposeVersionHavoc.ssc(27,3)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, A.c] := stack0o;
    assume IsHeap($Heap);
    // ----- call  ----- ExplicitExposeVersionHavoc.ssc(26,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
...
axiom (forall $oi: ref, $h: [ref,<x>name]x :: { $h[$oi, $inv] <: D } IsHeap($h) && $h[$oi, $inv] <: D && $h[$oi, $localinv] != System.Object ==> $h[$oi, D.x] >= 0);
...
implementation D.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3621:
    // ----- load field  ----- ExplicitExposeVersionHavoc.ssc(41,3)
    assert this != null;
    stack0i := $Heap[this, D.x];
    // ----- load constant 0  ----- ExplicitExposeVersionHavoc.ssc(41,3)
    stack1i := 0;
    // ----- binary operator  ----- ExplicitExposeVersionHavoc.ssc(41,3)
    // ----- branch  ----- ExplicitExposeVersionHavoc.ssc(41,3)
    goto true3621to3723, false3621to3638;
  ...
  block3638:
    ...
    // ----- unary operator
    // ----- branch
    goto true3638to3689, false3638to3655;
...
axiom (forall $Heap: [ref,<x>name]x, this: ref :: { #D.Foo($Heap, this) } IsHeap($Heap) && (forall $pc: ref :: $pc != null && $Heap[$pc, $allocated] == true && $Heap[$pc, $ownerRef] == $Heap[this, $ownerRef] && $Heap[$pc, $ownerFrame] == $Heap[this, $ownerFrame] ==> $Heap[$pc, $inv] == $typeof($pc) && $Heap[$pc, $localinv] == $typeof($pc)) ==> InRange(#D.Foo($Heap, this), System.Int32));

axiom (forall $Heap: [ref,<x>name]x, this: ref :: { #D.Foo($Heap, this) } this != null && $typeof(this) <: D && $Heap[this, $inv] == $typeof(this) && $Heap[this, $localinv] == $typeof(this) && IsHeap($Heap) && $Heap[this, $allocated] == true ==> #D.Foo($Heap, this) == ##D.Foo($Heap[this, $exposeVersion]));
...
implementation D.Foo(this: ref) returns ($result: int)
{
  ...
  block4369:
    // ----- nop
    // ----- load field  ----- ExplicitExposeVersionHavoc.ssc(46,5)
    assert this != null;
    return.value := $Heap[this, D.x];
    // ----- branch
    goto block4386;
...
implementation D.Unsound(this: ref)
{
  ...
  block5015:
    // ----- nop
    // ----- serialized AssumeStatement  ----- ExplicitExposeVersionHavoc.ssc(52,5)
    assume #D.Foo($Heap, this) == 5;
    goto block5100;

  block5100:
    // ----- nop
    // ----- load constant 6  ----- ExplicitExposeVersionHavoc.ssc(53,5)
    stack0i := 6;
    // ----- store field  ----- ExplicitExposeVersionHavoc.ssc(53,5)
    assert this != null;
    assert !($Heap[this, $inv] <: D) || $Heap[this, $localinv] == System.Object;
    $Heap[this, D.x] := stack0i;
    assume IsHeap($Heap);
    // ----- serialized AssertStatement  ----- ExplicitExposeVersionHavoc.ssc(54,5)
    assert #D.Foo($Heap, this) == 5;
    goto block5185;
...
implementation D..ctor(this: ref)
{
  ...
  block5678:
    // ----- call  ----- ExplicitExposeVersionHavoc.ssc(38,7)
    assert this != null;
    call System.Object..ctor(this);
    goto block5746;

  block5746:
    // ----- FrameGuard processing  ----- ExplicitExposeVersionHavoc.ssc(38,7)
    temp0 := this;
    // ----- classic pack  ----- ExplicitExposeVersionHavoc.ssc(38,7)
    assert temp0 != null;
    assert $Heap[temp0, $inv] == System.Object && $Heap[temp0, $localinv] == $typeof(temp0);
    assert $Heap[temp0, D.x] >= 0;
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == temp0 && $Heap[$p, $ownerFrame] == D ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[temp0, $inv] := D;
    assume IsHeap($Heap);
    // ----- return
    return;
