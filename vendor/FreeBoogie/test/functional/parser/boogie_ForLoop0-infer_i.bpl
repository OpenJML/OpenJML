...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify ForLoop0.dll /infer:i
...
{
  var N: int where InRange(N, System.Int32), i: int where InRange(i, System.Int32), stack0b: bool, stack0o: ref, local2: int where InRange(local2, System.Int32), stack0i: int, $Heap$block1309$LoopPreheader: [ref,<x>name]x;

  entry:
    assume $IsNotNull(this, ForLoop0);
  ...
  block1292:
    // ----- load constant 0  ----- ForLoop0.ssc(5,7)
    i := 0;
    goto block1309$LoopPreheader;

  block1309:
    // ----- default loop invariant: allocation and ownership are stable  ----- ForLoop0.ssc(5,18)
    ...
    // ----- default loop invariant: $inv field  ----- ForLoop0.ssc(5,18)
    ...
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- ForLoop0.ssc(5,18)
    ...
    // ----- binary operator  ----- ForLoop0.ssc(5,18)
    // ----- branch  ----- ForLoop0.ssc(5,18)
    goto true1309to1428, false1309to1326;
  ...
  block1428:
    // ----- return  ----- ForLoop0.ssc(10,2)
    return;

  block1326:
    // ----- serialized AssertStatement  ----- ForLoop0.ssc(7,4)
    assert i >= 0;
    goto block1411;

  block1411:
    // ----- nop
    // ----- copy  ----- ForLoop0.ssc(5,25)
    local2 := i;
    // ----- load constant 1  ----- ForLoop0.ssc(5,25)
    stack0i := 1;
    // ----- binary operator  ----- ForLoop0.ssc(5,25)
...
implementation ForLoop0..ctor(this: ref)
{
  ...
  block1819:
    // ----- call  ----- ForLoop0.ssc(1,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == ForLoop0 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := ForLoop0;
    assume IsHeap($Heap);
    return;
