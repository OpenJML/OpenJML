...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify /modifiesOnLoop loopinv0-nonnull.dll
...
const TestEnumerable.field: <ref>name;
...
implementation F.M(this: ref)
{
  ...
  block1581:
    // ----- copy  ----- loopinv0-nonnull.ssc(6,28)
    local0 := this;
    // ----- copy  ----- loopinv0-nonnull.ssc(6,28)
    stack0o := local0;
    // ----- load token  ----- loopinv0-nonnull.ssc(6,28)
    havoc stack1s;
    assume $IsTokenForType(stack1s, F);
    // ----- statically resolved GetTypeFromHandle call  ----- loopinv0-nonnull.ssc(6,28)
    stack1o := TypeObject(F);
    // ----- local unpack  ----- loopinv0-nonnull.ssc(6,28)
    assert stack0o != null;
  ...
  block1598:
    // ----- load constant 4  ----- loopinv0-nonnull.ssc(6,36)
    stack0i := 4;
    // ----- store field  ----- loopinv0-nonnull.ssc(6,36)
    assert this != null;
  ...
  block1649:
    // ----- copy  ----- loopinv0-nonnull.ssc(6,43)
    stack0o := local0;
    // ----- load token  ----- loopinv0-nonnull.ssc(6,43)
    havoc stack1s;
    assume $IsTokenForType(stack1s, F);
    // ----- statically resolved GetTypeFromHandle call  ----- loopinv0-nonnull.ssc(6,43)
    stack1o := TypeObject(F);
    // ----- local pack  ----- loopinv0-nonnull.ssc(6,43)
    assert stack0o != null;
  ...
  block1615:
    // ----- return  ----- loopinv0-nonnull.ssc(6,45)
    return;
...
implementation F..ctor(this: ref)
{
  ...
  block2057:
    // ----- load constant 0  ----- loopinv0-nonnull.ssc(5,3)
    stack0i := 0;
    // ----- store field  ----- loopinv0-nonnull.ssc(5,3)
    assert this != null;
    assert !($Heap[this, $inv] <: F) || $Heap[this, $localinv] == System.Object;
    $Heap[this, F.X] := stack0i;
    assume IsHeap($Heap);
    // ----- call  ----- loopinv0-nonnull.ssc(3,21)
    assert this != null;
...
{
  var other: ref where $IsNotNull(other, F), local1: ref where $Is(local1, TestEnumerable), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType, stack50000o: ref, i: int where InRange(i, System.Int32), stack0i: int, stack0b: bool, local3: int where InRange(local3, System.Int32), $Heap$block2754$LoopPreheader: [ref,<x>name]x;

  entry:
    assume $IsNotNull(this, TestEnumerable);
    assume $Heap[this, $allocated] == true;
    other := other$in;
    goto block2550;
  ...
  block2703:
    // ----- nop
    // ----- copy  ----- loopinv0-nonnull.ssc(61,15)
    local1 := this;
    // ----- copy  ----- loopinv0-nonnull.ssc(61,15)
    stack0o := local1;
    // ----- load token  ----- loopinv0-nonnull.ssc(61,15)
    havoc stack1s;
    assume $IsTokenForType(stack1s, TestEnumerable);
    // ----- statically resolved GetTypeFromHandle call  ----- loopinv0-nonnull.ssc(61,15)
    stack1o := TypeObject(TestEnumerable);
    // ----- local unpack  ----- loopinv0-nonnull.ssc(61,15)
    assert stack0o != null;
    assert ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && $Heap[stack0o, $inv] <: TestEnumerable && $Heap[stack0o, $localinv] == $typeof(stack0o);
    $Heap[stack0o, $localinv] := System.Object;
    havoc temp0;
    $Heap[stack0o, $exposeVersion] := temp0;
    assume IsHeap($Heap);
  ...
  block2720:
    // ----- new object  ----- loopinv0-nonnull.ssc(63,9)
    havoc stack50000o;
    ...
    // ----- call  ----- loopinv0-nonnull.ssc(63,9)
    assert stack50000o != null;
    call F..ctor(stack50000o);
    // ----- copy  ----- loopinv0-nonnull.ssc(63,9)
    stack0o := stack50000o;
    // ----- store field  ----- loopinv0-nonnull.ssc(63,9)
    assert this != null;
    assert !($Heap[this, $inv] <: TestEnumerable) || $Heap[this, $localinv] == System.Object;
    $Heap[this, TestEnumerable.field] := stack0o;
    assume IsHeap($Heap);
    // ----- branch
    goto block2907;

  block2907:
    // ----- copy  ----- loopinv0-nonnull.ssc(64,7)
    stack0o := local1;
    // ----- load token  ----- loopinv0-nonnull.ssc(64,7)
    havoc stack1s;
    assume $IsTokenForType(stack1s, TestEnumerable);
    // ----- statically resolved GetTypeFromHandle call  ----- loopinv0-nonnull.ssc(64,7)
    stack1o := TypeObject(TestEnumerable);
    // ----- local pack  ----- loopinv0-nonnull.ssc(64,7)
    assert stack0o != null;
    assert $Heap[stack0o, $localinv] == System.Object;
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == stack0o && $Heap[$p, $ownerFrame] == TestEnumerable ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[stack0o, $localinv] := $typeof(stack0o);
    assume IsHeap($Heap);
    // ----- nop
    // ----- branch
  ...
  block2737:
    // ----- load constant 0  ----- loopinv0-nonnull.ssc(66,12)
    i := 0;
    goto block2754$LoopPreheader;

  block2754:
    // ----- default loop invariant: allocation and ownership are stable  ----- loopinv0-nonnull.ssc(66,23)
    ...
    // ----- default loop invariant: $inv field  ----- loopinv0-nonnull.ssc(66,23)
    ...
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- loopinv0-nonnull.ssc(66,23)
    ...
    // ----- default loop invariant: modifies  ----- loopinv0-nonnull.ssc(66,23)
    assert (forall $o: ref, $f: name :: { $Heap[$o, $f] } $f != $inv && $f != $localinv && $f != $FirstConsistentOwner && (!IsStaticField($f) || !IsDirectlyModifiableField($f)) && $o != null && old($Heap)[$o, $allocated] == true && (old($Heap)[$o, $ownerFrame] == $PeerGroupPlaceholder || !(old($Heap)[old($Heap)[$o, $ownerRef], $inv] <: old($Heap)[$o, $ownerFrame]) || old($Heap)[old($Heap)[$o, $ownerRef], $localinv] == $BaseClass(old($Heap)[$o, $ownerFrame])) && old(($o != this || $f != TestEnumerable.field) && ($o != other || !($typeof(other) <: DeclType($f)))) && old($o != this || $f != $exposeVersion) ==> $Heap$block2754$LoopPreheader[$o, $f] == $Heap[$o, $f]);
    // ----- load constant 10  ----- loopinv0-nonnull.ssc(66,23)
    stack0i := 10;
    // ----- binary operator  ----- loopinv0-nonnull.ssc(66,23)
    // ----- branch  ----- loopinv0-nonnull.ssc(66,23)
  ...
  block2771:
    // ----- call  ----- loopinv0-nonnull.ssc(68,9)
    assert other != null;
    call F.M(other);
    // ----- copy  ----- loopinv0-nonnull.ssc(66,31)
    local3 := i;
    // ----- load constant 1  ----- loopinv0-nonnull.ssc(66,31)
    stack0i := 1;
    // ----- binary operator  ----- loopinv0-nonnull.ssc(66,31)
...
implementation TestEnumerable..ctor(this: ref)
{
  ...
  entry:
    ...
    assume $Heap[this, $allocated] == true;
    assume ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame]) || $Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame])) && $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assume $Heap[this, TestEnumerable.field] == null;
    goto block3604;
  ...
  block3621:
    // ----- call  ----- loopinv0-nonnull.ssc(9,21)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == TestEnumerable ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := TestEnumerable;
    assume IsHeap($Heap);
    return;
