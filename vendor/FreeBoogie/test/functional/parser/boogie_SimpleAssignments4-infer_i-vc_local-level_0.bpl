...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify SimpleAssignments4.dll /infer:i /vc:local /level:0
...
{
  var Input: int where InRange(Input, System.Int32), stack0i: int, stack0b: bool, x: int where InRange(x, System.Int32), y: int where InRange(y, System.Int32), stack0o: ref;

  entry:
    assume $IsNotNull(this, SimpleAssignment4);
  ...
  block1360:
    // ----- load constant 223  ----- SimpleAssignments4.ssc(10,3)
    stack0i := 223;
    // ----- binary operator  ----- SimpleAssignments4.ssc(10,3)
    // ----- branch  ----- SimpleAssignments4.ssc(10,3)
    goto true1360to1394, false1360to1377;

  true1360to1394:
    assume Input >= stack0i;
    goto block1394;
  ...
  block1394:
    // ----- load constant 20  ----- SimpleAssignments4.ssc(13,4)
    x := 20;
    // ----- nop  ----- SimpleAssignments4.ssc(13,9)
    goto block1411;

  block1377:
    // ----- load constant -10  ----- SimpleAssignments4.ssc(11,4)
    x := -10;
    // ----- branch  ----- SimpleAssignments4.ssc(12,3)
    goto block1411;

  block1411:
    // ----- copy  ----- SimpleAssignments4.ssc(15,3)
    y := x;
    // ----- load constant 0  ----- SimpleAssignments4.ssc(17,3)
    stack0i := 0;
    // ----- binary operator  ----- SimpleAssignments4.ssc(17,3)
    // ----- branch  ----- SimpleAssignments4.ssc(17,3)
    goto true1411to1445, false1411to1428;
  ...
  block1445:
    // ----- serialized AssertStatement  ----- SimpleAssignments4.ssc(24,3)
    assert 0 <= y && y <= 20;
    goto block1564;

  block1428:
    // ----- copy  ----- SimpleAssignments4.ssc(19,4)
    stack0i := x;
    // ----- unary operator  ----- SimpleAssignments4.ssc(19,4)
    stack0i := 0 - stack0i;
    // ----- copy  ----- SimpleAssignments4.ssc(19,4)
    y := stack0i;
    goto block1445;
  ...
  block1564:
    // ----- nop
    // ----- return  ----- SimpleAssignments4.ssc(25,2)
    return;
...
implementation SimpleAssignment4..ctor(this: ref)
{
  ...
  block2023:
    // ----- call  ----- SimpleAssignments4.ssc(29,3)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return  ----- SimpleAssignments4.ssc(30,2)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == SimpleAssignment4 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := SimpleAssignment4;
    assume IsHeap($Heap);
    return;
