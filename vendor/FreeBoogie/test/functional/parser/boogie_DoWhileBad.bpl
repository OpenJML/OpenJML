...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo DoWhileBad
...
{
  var n: int where InRange(n, System.Int32), m: int where InRange(m, System.Int32), i: int where InRange(i, System.Int32), stack0o: ref, local3774: int where InRange(local3774, System.Int32), stack0i: int, stack0b: bool, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32), $Heap$block3264$LoopPreheader: [ref,<x>name]x;
  ...
  block3230:
    // ----- load constant 0  ----- DoWhileBad.ssc(6,9)
    m := 0;
    goto block3247;

  block3247:
    // ----- load constant 0  ----- DoWhileBad.ssc(7,9)
    i := 0;
    goto block3264$LoopPreheader;

  block3264:
    // ----- default loop invariant: allocation and ownership are stable  ----- DoWhileBad.ssc(9,23)
    assume (forall $o: ref :: $Heap$block3264$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block3264$LoopPreheader[$ot, $allocated] == true && $Heap$block3264$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block3264$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block3264$LoopPreheader[$ot, $ownerFrame]) && $Heap$block3264$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- DoWhileBad.ssc(9,23)
    assume (forall $o: ref :: ($Heap$block3264$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block3264$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block3264$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block3264$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- DoWhileBad.ssc(9,23)
    assert (forall $o: ref :: $o != null && $Heap$block3264$LoopPreheader[$o, $allocated] == true ==> $Heap$block3264$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block3264$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- serialized LoopInvariant  ----- DoWhileBad.ssc(9,23)
    assert m == i;
    goto block3417;
  ...
  block3434:
    // ----- copy  ----- DoWhileBad.ssc(11,13)
    m := i;
    goto block3451;

  block3451:
    // ----- copy  ----- DoWhileBad.ssc(12,13)
    local3774 := i;
    // ----- load constant 1  ----- DoWhileBad.ssc(12,13)
    stack0i := 1;
    // ----- binary operator  ----- DoWhileBad.ssc(12,13)
    stack0i := local3774 + stack0i;
    // ----- copy  ----- DoWhileBad.ssc(12,13)
    i := stack0i;
    // ----- copy  ----- DoWhileBad.ssc(12,13)
    stack0i := local3774;
  ...
  block3502:
    // ----- binary operator  ----- DoWhileBad.ssc(14,16)
    // ----- branch  ----- DoWhileBad.ssc(14,16)
    goto true3502to3264, false3502to3519;
  ...
  block3264$LoopPreheader:
    $Heap$block3264$LoopPreheader := $Heap;
    goto block3264;
