...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Generic
...
{
  var stack50000o: ref, stack0o: ref, l: ref where $Is(l, System.Collections.Generic.List`1...System.Int32), stack0i: int;
  ...
  block8262:
    // ----- new object  ----- Generic.ssc(7,21)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == System.Collections.Generic.List`1...System.Int32;
    ...
    // ----- call  ----- Generic.ssc(7,21)
    assert stack50000o != null;
    call System.Collections.Generic.List`1...System.Int32..ctor(stack50000o);
    // ----- copy  ----- Generic.ssc(7,7)
    stack0o := stack50000o;
    // ----- copy  ----- Generic.ssc(7,7)
    l := stack0o;
    goto block8279;
  ...
  block8279:
    // ----- load constant 5  ----- Generic.ssc(8,13)
    stack0i := 5;
    // ----- call  ----- Generic.ssc(8,7)
    assert l != null;
    call System.Collections.Generic.List`1...System.Int32.Add$System.Int32$.Virtual.$(l, stack0i);
    goto block8296;
