...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify Recursion0.dll /infer:i
...
{
  var y: int where InRange(y, System.Int32), v: int where InRange(v, System.Int32), stack0i: int, factorial: int where InRange(factorial, System.Int32), stack0o: ref;

  entry:
    assume $IsNotNull(this, Recursion0);
  ...
  block1258:
    // ----- load constant 3  ----- Recursion0.ssc(5,3)
    v := 3;
    // ----- copy  ----- Recursion0.ssc(6,3)
    stack0i := v;
    // ----- call  ----- Recursion0.ssc(6,3)
    assert this != null;
    call factorial := Recursion0.fact$System.Int32(this, stack0i);
    // ----- serialized AssertStatement  ----- Recursion0.ssc(8,3)
    assert factorial >= 0;
    goto block1343;

  block1343:
    // ----- nop
    // ----- return  ----- Recursion0.ssc(9,2)
    return;
...
{
  var i: int where InRange(i, System.Int32), stack0i: int, stack0b: bool, returnValue: int where InRange(returnValue, System.Int32), stack0o: ref, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block2057:
    // ----- nop
    // ----- load constant 0  ----- Recursion0.ssc(17,3)
    stack0i := 0;
    // ----- binary operator  ----- Recursion0.ssc(17,3)
    // ----- branch  ----- Recursion0.ssc(17,3)
    goto true2057to2091, false2057to2074;
  ...
  block2091:
    // ----- load constant 1  ----- Recursion0.ssc(20,4)
    stack0i := 1;
    // ----- binary operator  ----- Recursion0.ssc(20,4)
    stack0i := i - stack0i;
    // ----- call  ----- Recursion0.ssc(20,4)
    assert this != null;
    call stack0i := Recursion0.fact$System.Int32(this, stack0i);
    // ----- binary operator  ----- Recursion0.ssc(20,4)
    stack0i := i * stack0i;
    // ----- copy  ----- Recursion0.ssc(20,4)
    returnValue := stack0i;
    // ----- nop  ----- Recursion0.ssc(20,30)
    goto block2108;

  block2074:
    // ----- load constant 0  ----- Recursion0.ssc(18,4)
    returnValue := 0;
    // ----- branch  ----- Recursion0.ssc(19,3)
    goto block2108;

  block2108:
    // ----- serialized AssertStatement  ----- Recursion0.ssc(22,3)
    assert returnValue >= 0;
    goto block2193;

  block2193:
    // ----- nop
    // ----- copy  ----- Recursion0.ssc(24,3)
...
implementation Recursion0..ctor(this: ref)
{
  ...
  block2873:
    // ----- call  ----- Recursion0.ssc(1,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Recursion0 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Recursion0;
    assume IsHeap($Heap);
    return;
