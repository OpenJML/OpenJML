...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo DoWhileGood
...
{
  var n: int where InRange(n, System.Int32), m: int where InRange(m, System.Int32), i: int where InRange(i, System.Int32), stack0o: ref, local4318: int where InRange(local4318, System.Int32), stack0i: int, local4335: int where InRange(local4335, System.Int32), stack0b: bool, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32), $Heap$block3570$LoopPreheader: [ref,<x>name]x;
  ...
  block3536:
    // ----- load constant 0  ----- DoWhileGood.ssc(7,9)
    m := 0;
    goto block3553;

  block3553:
    // ----- load constant 0  ----- DoWhileGood.ssc(8,9)
    i := 0;
    goto block3570$LoopPreheader;

  block3570:
    // ----- default loop invariant: allocation and ownership are stable  ----- DoWhileGood.ssc(10,23)
    assume (forall $o: ref :: $Heap$block3570$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block3570$LoopPreheader[$ot, $allocated] == true && $Heap$block3570$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block3570$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block3570$LoopPreheader[$ot, $ownerFrame]) && $Heap$block3570$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- DoWhileGood.ssc(10,23)
    assume (forall $o: ref :: ($Heap$block3570$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block3570$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block3570$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block3570$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- DoWhileGood.ssc(10,23)
    assert (forall $o: ref :: $o != null && $Heap$block3570$LoopPreheader[$o, $allocated] == true ==> $Heap$block3570$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block3570$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- serialized LoopInvariant  ----- DoWhileGood.ssc(10,23)
    assert m == i;
    goto block3723;
  ...
  block3740:
    // ----- copy  ----- DoWhileGood.ssc(12,13)
    local4318 := m;
    // ----- load constant 1  ----- DoWhileGood.ssc(12,13)
    stack0i := 1;
    // ----- binary operator  ----- DoWhileGood.ssc(12,13)
    stack0i := local4318 + stack0i;
    // ----- copy  ----- DoWhileGood.ssc(12,13)
    m := stack0i;
    // ----- copy  ----- DoWhileGood.ssc(12,13)
    stack0i := local4318;
  ...
  block3757:
    // ----- nop  ----- DoWhileGood.ssc(12,13)
    goto block3774;

  block3774:
    // ----- copy  ----- DoWhileGood.ssc(13,13)
    local4335 := i;
    // ----- load constant 1  ----- DoWhileGood.ssc(13,13)
    stack0i := 1;
    // ----- binary operator  ----- DoWhileGood.ssc(13,13)
    stack0i := local4335 + stack0i;
    // ----- copy  ----- DoWhileGood.ssc(13,13)
    i := stack0i;
    // ----- copy  ----- DoWhileGood.ssc(13,13)
    stack0i := local4335;
  ...
  block3825:
    // ----- binary operator  ----- DoWhileGood.ssc(15,16)
    // ----- branch  ----- DoWhileGood.ssc(15,16)
    goto true3825to3570, false3825to3842;
  ...
  block3570$LoopPreheader:
    $Heap$block3570$LoopPreheader := $Heap;
    goto block3570;
