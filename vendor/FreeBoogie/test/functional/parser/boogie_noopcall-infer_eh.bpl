...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify /infer:eh noopcall.dll
...
implementation NoOpCall.NoOp(this: ref)
{
  ...
  entry:
    assume $IsNotNull(this, NoOpCall);
...
{
  var local0: ref where $Is(local0, NoOpCall), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType, stack0i: int;
  ...
  block1836:
    // ----- copy  ----- noopcall.ssc(10,13)
    local0 := this;
    // ----- copy  ----- noopcall.ssc(10,13)
    stack0o := local0;
    // ----- load token  ----- noopcall.ssc(10,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, NoOpCall);
    // ----- statically resolved GetTypeFromHandle call  ----- noopcall.ssc(10,13)
    stack1o := TypeObject(NoOpCall);
    // ----- local unpack  ----- noopcall.ssc(10,13)
    assert stack0o != null;
    assert ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && $Heap[stack0o, $inv] <: NoOpCall && $Heap[stack0o, $localinv] == $typeof(stack0o);
  ...
  block1853:
    // ----- load constant 42  ----- noopcall.ssc(10,21)
    stack0i := 42;
    // ----- store field  ----- noopcall.ssc(10,21)
    assert this != null;
    assert !($Heap[this, $inv] <: NoOpCall) || $Heap[this, $localinv] == System.Object;
    $Heap[this, NoOpCall.X] := stack0i;
    assume IsHeap($Heap);
    // ----- branch
    goto block2006;

  block2006:
    // ----- copy  ----- noopcall.ssc(10,34)
    stack0o := local0;
    // ----- load token  ----- noopcall.ssc(10,34)
    havoc stack1s;
    assume $IsTokenForType(stack1s, NoOpCall);
    // ----- statically resolved GetTypeFromHandle call  ----- noopcall.ssc(10,34)
    stack1o := TypeObject(NoOpCall);
    // ----- local pack  ----- noopcall.ssc(10,34)
    assert stack0o != null;
    assert $Heap[stack0o, $localinv] == System.Object;
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == stack0o && $Heap[$p, $ownerFrame] == NoOpCall ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
  ...
  block1870:
    // ----- call  ----- noopcall.ssc(11,5)
    assert this != null;
    call NoOpCall.NoOp(this);
    goto block1972;

  block1972:
    // ----- nop
    // ----- return  ----- noopcall.ssc(12,3)
    return;
...
implementation NoOpCall..ctor(this: ref)
{
  ...
  block2482:
    // ----- load constant 0  ----- noopcall.ssc(3,3)
    stack0i := 0;
    // ----- store field  ----- noopcall.ssc(3,3)
    assert this != null;
    assert !($Heap[this, $inv] <: NoOpCall) || $Heap[this, $localinv] == System.Object;
    $Heap[this, NoOpCall.X] := stack0i;
    assume IsHeap($Heap);
    // ----- call  ----- noopcall.ssc(1,21)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == NoOpCall ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := NoOpCall;
    assume IsHeap($Heap);
    return;
