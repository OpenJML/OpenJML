...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Irreducible
...
{
  var x: int where InRange(x, System.Int32), stack0i: int, stack0b: bool, $Heap$block2635$LoopPreheader: [ref,<x>name]x, $Heap$block2669$LoopPreheader: [ref,<x>name]x;
  ...
  block2533:
    // ----- load constant 0  ----- Irreducible.ssc(5,13)
    stack0i := 0;
    // ----- binary operator  ----- Irreducible.ssc(5,9)
    // ----- branch  ----- Irreducible.ssc(5,5)
  ...
  block2584:
    // ----- branch  ----- Irreducible.ssc(5,35)
    goto block2669$LoopPreheader;

  block2550:
    // ----- branch  ----- Irreducible.ssc(5,18)
    goto block2635$LoopPreheader;

  block2635:
    // ----- default loop invariant: allocation and ownership are stable  ----- Irreducible.ssc(8,12)
    assume (forall $o: ref :: $Heap$block2635$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block2635$LoopPreheader[$ot, $allocated] == true && $Heap$block2635$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block2635$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block2635$LoopPreheader[$ot, $ownerFrame]) && $Heap$block2635$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- Irreducible.ssc(8,12)
    assume (forall $o: ref :: ($Heap$block2635$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block2635$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block2635$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block2635$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- Irreducible.ssc(8,12)
    assert (forall $o: ref :: $o != null && $Heap$block2635$LoopPreheader[$o, $allocated] == true ==> $Heap$block2635$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block2635$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 1  ----- Irreducible.ssc(8,12)
    stack0i := 1;
    // ----- binary operator  ----- Irreducible.ssc(8,7)
    stack0i := x + stack0i;
    // ----- copy  ----- Irreducible.ssc(8,7)
    x := stack0i;
    goto block2652;

  block2669:
    // ----- default loop invariant: allocation and ownership are stable  ----- Irreducible.ssc(12,12)
    assume (forall $o: ref :: $Heap$block2669$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block2669$LoopPreheader[$ot, $allocated] == true && $Heap$block2669$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block2669$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block2669$LoopPreheader[$ot, $ownerFrame]) && $Heap$block2669$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- Irreducible.ssc(12,12)
    assume (forall $o: ref :: ($Heap$block2669$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block2669$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block2669$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block2669$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- Irreducible.ssc(12,12)
    assert (forall $o: ref :: $o != null && $Heap$block2669$LoopPreheader[$o, $allocated] == true ==> $Heap$block2669$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block2669$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 5  ----- Irreducible.ssc(12,12)
    stack0i := 5;
    // ----- binary operator  ----- Irreducible.ssc(12,7)
    stack0i := x + stack0i;
    // ----- copy  ----- Irreducible.ssc(12,7)
    x := stack0i;
    goto block2686;

  block2652:
    // ----- branch  ----- Irreducible.ssc(9,7)
    goto block2669;

  block2686:
    // ----- branch  ----- Irreducible.ssc(13,7)
    goto block2635;

  block2635$LoopPreheader:
    $Heap$block2635$LoopPreheader := $Heap;
    goto block2635;

  block2669$LoopPreheader:
    $Heap$block2669$LoopPreheader := $Heap;
    goto block2669;
