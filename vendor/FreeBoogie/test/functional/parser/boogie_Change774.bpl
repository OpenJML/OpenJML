...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Change774
...
implementation Test1..ctor(this: ref)
{
  ...
  entry:
    ...
    assume ZeroInit($Heap[this, Test1.s], S);
    goto block2448;
  ...
  block2550:
    // ----- return  ----- Change774.ssc(12,5)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Test1 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Test1;
    assume IsHeap($Heap);
    return;
