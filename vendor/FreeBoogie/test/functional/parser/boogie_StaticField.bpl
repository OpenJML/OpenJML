...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo StaticField
...
implementation Test.Foo(this: ref)
{
  ...
  block2550:
    // ----- load constant 5  ----- StaticField.ssc(7,13)
    stack0i := 5;
    // ----- store field  ----- StaticField.ssc(7,9)
    $Heap[ClassRepr(Test), Test.x] := stack0i;
    assume IsHeap($Heap);
    goto block2567;

  block2567:
    // ----- serialized AssertStatement  ----- StaticField.ssc(8,9)
    assert $Heap[ClassRepr(Test), Test.x] == 5;
    goto block2720;
...
implementation Test.Bar(this: ref)
{
  ...
  block3179:
    // ----- load constant 6  ----- StaticField.ssc(13,13)
    stack0i := 6;
    // ----- store field  ----- StaticField.ssc(13,9)
    $Heap[ClassRepr(Test), Test.x] := stack0i;
    assume IsHeap($Heap);
    goto block3196;

  block3196:
    // ----- serialized AssertStatement  ----- StaticField.ssc(14,9)
    assert $Heap[ClassRepr(Test), Test.x] == 7;
    goto block3349;
