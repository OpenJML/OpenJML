...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker11b
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3876:
    // ----- load constant 0  ----- Chunker11b.ssc(7,13)
    stack0i := 0;
    // ----- load field  ----- Chunker11b.ssc(7,17)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker11b.ssc(7,13)
    // ----- branch
    goto true3876to3995, false3876to3893;
  ...
  block3893:
    ...
    // ----- unary operator
    // ----- branch
    goto true3893to3944, false3893to3910;
  ...
  block4029:
    // ----- load constant 0  ----- Chunker11b.ssc(9,13)
    stack0i := 0;
    // ----- load field  ----- Chunker11b.ssc(9,18)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- binary operator  ----- Chunker11b.ssc(9,13)
    // ----- branch
    goto true4029to4080, false4029to4046;
  ...
  block4046:
    // ----- load field  ----- Chunker11b.ssc(9,23)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker11b.ssc(9,28)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker11b.ssc(9,28)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker11b.ssc(9,23)
    // ----- branch
  ...
  block4097:
    ...
    // ----- unary operator
    // ----- branch
    goto true4097to4148, false4097to4114;
  ...
  block4114:
    assume false;
    // ----- new object  ----- Chunker11b.ssc(9,3)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Chunker11b.ssc(9,3)
    assert stack50000o != null;
    call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o);
    // ----- copy  ----- Chunker11b.ssc(9,3)
    stack0o := stack50000o;
    // ----- throw  ----- Chunker11b.ssc(9,3)
    assert stack0o != null;
    assume false;
    return;
...
implementation Chunker.NextChunk(this: ref) returns ($result: ref)
{
  ...
  block5678:
    // ----- FrameGuard processing  ----- Chunker11b.ssc(14,22)
    temp0 := this;
    // ----- classic unpack  ----- Chunker11b.ssc(14,22)
    assert temp0 != null;
  ...
  block5712:
    // ----- load field  ----- Chunker11b.ssc(16,11)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker11b.ssc(16,15)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker11b.ssc(16,11)
    stack0i := stack0i + stack1i;
    // ----- load field  ----- Chunker11b.ssc(16,28)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker11b.ssc(16,28)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker11b.ssc(16,11)
    // ----- branch  ----- Chunker11b.ssc(16,7)
    goto true5712to5763, false5712to5729;
  ...
  block5763:
    // ----- load field  ----- Chunker11b.ssc(19,13)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker11b.ssc(19,27)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- call  ----- Chunker11b.ssc(19,9)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32(stack0o, stack1i);
    // ----- nop  ----- Chunker11b.ssc(21,7)
    goto block5780;

  block5729:
    // ----- load field  ----- Chunker11b.ssc(17,13)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker11b.ssc(17,27)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker11b.ssc(17,30)
    assert this != null;
    stack2i := $Heap[this, Chunker.ChunkSize];
    // ----- call  ----- Chunker11b.ssc(17,9)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i);
    goto block5746;

  block5746:
    // ----- branch  ----- Chunker11b.ssc(18,9)
    goto block5780;
  ...
  block5797:
    // ----- load field  ----- Chunker11b.ssc(21,7)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker11b.ssc(21,12)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker11b.ssc(21,7)
    stack0i := stack0i + stack1i;
    // ----- store field  ----- Chunker11b.ssc(21,7)
    assert this != null;
  ...
  block6205:
    ...
    // ----- binary operator
    // ----- branch
    goto true6205to6307, false6205to6222;

  true6205to6307:
    assume local6732 == stack0o;
    goto block6307;
  ...
  block6222:
    // ----- is instance
    // ----- branch
    goto true6222to6307, false6222to6239;

  true6222to6307:
    assume $As(local6732, Microsoft.Contracts.ICheckedException) != null;
    goto block6307;
  ...
  block6324:
    // ----- classic pack  ----- Chunker11b.ssc(23,5)
    assert temp0 != null;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this: ref, source$in: ref, chunkSize$in: int)
{
  ...
  block7854:
    // ----- store field  ----- Chunker11b.ssc(29,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker11b.ssc(30,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker11b.ssc(31,9)
    stack0i := 0;
    // ----- store field  ----- Chunker11b.ssc(31,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.n] := stack0i;
    assume IsHeap($Heap);
  ...
  block8041:
    // ----- FrameGuard processing  ----- Chunker11b.ssc(33,3)
    temp0 := this;
    // ----- classic pack  ----- Chunker11b.ssc(33,3)
    assert temp0 != null;
    assert $Heap[temp0, $inv] == System.Object && $Heap[temp0, $localinv] == $typeof(temp0);
    assert 0 < $Heap[temp0, Chunker.ChunkSize];
    assert 0 <= $Heap[temp0, Chunker.n] && $Heap[temp0, Chunker.n] <= $StringLength($Heap[temp0, Chunker.src]);
