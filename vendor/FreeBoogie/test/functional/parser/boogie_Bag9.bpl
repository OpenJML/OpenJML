...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Bag9
...
implementation Bag.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block5168:
    // ----- load constant 0  ----- Bag9.ssc(8,13)
    stack0i := 0;
    // ----- load field  ----- Bag9.ssc(8,18)
    assert this != null;
    stack1i := $Heap[this, Bag.count];
    // ----- binary operator  ----- Bag9.ssc(8,13)
    // ----- branch
  ...
  block5185:
    // ----- load field  ----- Bag9.ssc(8,27)
    assert this != null;
    stack0i := $Heap[this, Bag.count];
    // ----- load field  ----- Bag9.ssc(8,36)
    assert this != null;
    stack1o := $Heap[this, Bag.elems];
    // ----- array length  ----- Bag9.ssc(8,36)
    assert stack1o != null;
    stack1i := $Length(stack1o);
    // ----- binary operator  ----- Bag9.ssc(8,27)
    // ----- branch
...
implementation Bag..ctor$System.Int32.array$notnull(this: ref, initialElements$in: ref)
{
  ...
  block6375:
    // ----- array length  ----- Bag9.ssc(12,23)
    assert initialElements != null;
    stack0i := $Length(initialElements);
    // ----- new array  ----- Bag9.ssc(12,5)
    assert 0 <= stack0i;
    havoc e;
  ...
  block6392:
    ...
    // ----- load constant 0  ----- Bag9.ssc(13,33)
    stack1i := 0;
    // ----- copy  ----- Bag9.ssc(13,36)
    stack2o := e;
    assert stack2o != null;
    stack2o := stack2o;
    // ----- load constant 0  ----- Bag9.ssc(13,39)
    stack3i := 0;
    // ----- array length  ----- Bag9.ssc(13,42)
    assert initialElements != null;
  ...
  block6579:
    // ----- FrameGuard processing  ----- Bag9.ssc(16,3)
    temp0 := this;
    // ----- classic pack  ----- Bag9.ssc(16,3)
    assert temp0 != null;
...
implementation Bag..ctor$System.Int32.array$notnull$System.Int32$System.Int32(this: ref, initialElements$in: ref, start$in: int, howMany$in: int)
{
  ...
  block8058:
    ...
    assert stack2o != null;
    stack2o := stack2o;
    // ----- load constant 0  ----- Bag9.ssc(24,43)
    stack3i := 0;
    // ----- copy  ----- Bag9.ssc(24,46)
    stack4i := howMany;
    // ----- call  ----- Bag9.ssc(24,5)
  ...
  block8245:
    // ----- FrameGuard processing  ----- Bag9.ssc(27,3)
    temp0 := this;
    // ----- classic pack  ----- Bag9.ssc(27,3)
    assert temp0 != null;
    assert $Heap[temp0, $inv] == System.Object && $Heap[temp0, $localinv] == $typeof(temp0);
    assert 0 <= $Heap[temp0, Bag.count] && $Heap[temp0, Bag.count] <= $Length($Heap[temp0, Bag.elems]);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == temp0 && $Heap[$p, $ownerFrame] == Bag ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
...
implementation Bag.RemoveMin(this: ref) returns ($result: int)
{
  ...
  block9996:
    // ----- FrameGuard processing  ----- Bag9.ssc(32,13)
    temp0 := this;
    // ----- load token  ----- Bag9.ssc(32,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Bag);
    // ----- statically resolved GetTypeFromHandle call  ----- Bag9.ssc(32,13)
    stack1o := TypeObject(Bag);
    // ----- local unpack  ----- Bag9.ssc(32,13)
    assert temp0 != null;
  ...
  block10013:
    // ----- load constant 2147483647  ----- Bag9.ssc(34,7)
    m := int#2147483647;
    goto block10030;

  block10030:
    // ----- load constant 0  ----- Bag9.ssc(35,7)
    mindex := 0;
    goto block10047;

  block10047:
    // ----- load constant 0  ----- Bag9.ssc(36,12)
    i := 0;
    goto block10064$LoopPreheader;

  block10064:
    // ----- default loop invariant: allocation and ownership are stable  ----- Bag9.ssc(37,21)
    ...
    // ----- default loop invariant: $inv field  ----- Bag9.ssc(37,21)
    ...
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- Bag9.ssc(37,21)
    ...
    // ----- serialized LoopInvariant  ----- Bag9.ssc(37,21)
  ...
  block10319:
    // ----- load field  ----- Bag9.ssc(36,28)
    assert this != null;
    stack0i := $Heap[this, Bag.count];
    // ----- binary operator  ----- Bag9.ssc(36,23)
    // ----- branch  ----- Bag9.ssc(36,23)
  ...
  block10353:
    // ----- copy  ----- Bag9.ssc(40,11)
    mindex := i;
    // ----- load field  ----- Bag9.ssc(41,15)
    assert this != null;
    stack0o := $Heap[this, Bag.elems];
    // ----- copy  ----- Bag9.ssc(41,21)
    stack1i := i;
    // ----- load element  ----- Bag9.ssc(41,11)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
  ...
  block10472:
    // ----- load field  ----- Bag9.ssc(44,7)
    assert this != null;
    local11305 := $Heap[this, Bag.count];
    // ----- load constant 1  ----- Bag9.ssc(44,7)
    stack0i := 1;
    // ----- binary operator  ----- Bag9.ssc(44,7)
    stack0i := local11305 - stack0i;
    // ----- store field  ----- Bag9.ssc(44,7)
    assert this != null;
    assert !($Heap[this, $inv] <: Bag) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Bag.count] := stack0i;
    assume IsHeap($Heap);
  ...
  block10404:
    // ----- copy  ----- Bag9.ssc(36,35)
    local11356 := i;
    // ----- load constant 1  ----- Bag9.ssc(36,35)
    stack0i := 1;
    // ----- binary operator  ----- Bag9.ssc(36,35)
  ...
  block10812:
    // ----- load token  ----- Bag9.ssc(47,5)
    havoc stack0s;
    assume $IsTokenForType(stack0s, Bag);
    // ----- statically resolved GetTypeFromHandle call  ----- Bag9.ssc(47,5)
    stack0o := TypeObject(Bag);
    // ----- local pack  ----- Bag9.ssc(47,5)
    assert temp0 != null;
...
implementation Bag.Add$System.Int32(this: ref, x$in: int)
{
  ...
  block12393:
    // ----- FrameGuard processing  ----- Bag9.ssc(52,13)
    temp0 := this;
    // ----- load token  ----- Bag9.ssc(52,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Bag);
    // ----- statically resolved GetTypeFromHandle call  ----- Bag9.ssc(52,13)
    stack1o := TypeObject(Bag);
    // ----- local unpack  ----- Bag9.ssc(52,13)
    assert temp0 != null;
    assert ($Heap[temp0, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[temp0, $ownerRef], $inv] <: $Heap[temp0, $ownerFrame]) || $Heap[$Heap[temp0, $ownerRef], $localinv] == $BaseClass($Heap[temp0, $ownerFrame])) && $Heap[temp0, $inv] <: Bag && $Heap[temp0, $localinv] == $typeof(temp0);
    $Heap[temp0, $localinv] := System.Object;
    havoc temp1;
  ...
  block12410:
    // ----- load field  ----- Bag9.ssc(54,11)
    assert this != null;
    stack0i := $Heap[this, Bag.count];
    // ----- load field  ----- Bag9.ssc(54,20)
    assert this != null;
    stack1o := $Heap[this, Bag.elems];
    // ----- array length  ----- Bag9.ssc(54,20)
    assert stack1o != null;
    stack1i := $Length(stack1o);
    // ----- binary operator  ----- Bag9.ssc(54,11)
    // ----- branch  ----- Bag9.ssc(54,7)
  ...
  block12427:
    // ----- load constant 2  ----- Bag9.ssc(56,28)
    stack0i := 2;
    // ----- load field  ----- Bag9.ssc(56,30)
    assert this != null;
    stack1o := $Heap[this, Bag.elems];
    // ----- array length  ----- Bag9.ssc(56,30)
    assert stack1o != null;
    stack1i := $Length(stack1o);
    // ----- binary operator  ----- Bag9.ssc(56,28)
    stack0i := stack0i * stack1i;
    // ----- load constant 1  ----- Bag9.ssc(56,43)
    stack1i := 1;
    // ----- binary operator  ----- Bag9.ssc(56,28)
    stack0i := stack0i + stack1i;
    // ----- new array  ----- Bag9.ssc(56,9)
    assert 0 <= stack0i;
    havoc b;
  ...
  block12444:
    // ----- load field  ----- Bag9.ssc(57,20)
    assert this != null;
    stack0o := $Heap[this, Bag.elems];
    // ----- load constant 0  ----- Bag9.ssc(57,27)
    stack1i := 0;
    // ----- copy  ----- Bag9.ssc(57,30)
    stack2o := b;
    // ----- load constant 0  ----- Bag9.ssc(57,33)
    stack3i := 0;
    // ----- load field  ----- Bag9.ssc(57,36)
    assert this != null;
    stack4o := $Heap[this, Bag.elems];
    // ----- array length  ----- Bag9.ssc(57,36)
    assert stack4o != null;
    stack4i := $Length(stack4o);
    // ----- call  ----- Bag9.ssc(57,9)
    call System.Array.Copy$System.Array$notnull$System.Int32$System.Array$notnull$System.Int32$System.Int32(stack0o, stack1i, stack2o, stack3i, stack4i);
    // ----- store field  ----- Bag9.ssc(58,9)
    assert this != null;
    assert !($Heap[this, $inv] <: Bag) || $Heap[this, $localinv] == System.Object;
  ...
  block12495:
    // ----- load field  ----- Bag9.ssc(60,7)
    assert this != null;
    stack0o := $Heap[this, Bag.elems];
    // ----- load field  ----- Bag9.ssc(60,13)
    assert this != null;
    stack1i := $Heap[this, Bag.count];
    // ----- store element  ----- Bag9.ssc(60,7)
    assert stack0o != null;
    assert 0 <= stack1i;
    assert stack1i < $Length(stack0o);
  ...
  block12512:
    // ----- load field  ----- Bag9.ssc(61,7)
    assert this != null;
    local13124 := $Heap[this, Bag.count];
    // ----- load constant 1  ----- Bag9.ssc(61,7)
    stack0i := 1;
    // ----- binary operator  ----- Bag9.ssc(61,7)
    stack0i := local13124 + stack0i;
    // ----- store field  ----- Bag9.ssc(61,7)
    assert this != null;
    assert !($Heap[this, $inv] <: Bag) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Bag.count] := stack0i;
    assume IsHeap($Heap);
  ...
  block12818:
    // ----- load token  ----- Bag9.ssc(62,5)
    havoc stack0s;
    assume $IsTokenForType(stack0s, Bag);
    // ----- statically resolved GetTypeFromHandle call  ----- Bag9.ssc(62,5)
    stack0o := TypeObject(Bag);
    // ----- local pack  ----- Bag9.ssc(62,5)
    assert temp0 != null;
    assert $Heap[temp0, $localinv] == System.Object;
    assert 0 <= $Heap[temp0, Bag.count] && $Heap[temp0, Bag.count] <= $Length($Heap[temp0, Bag.elems]);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == temp0 && $Heap[$p, $ownerFrame] == Bag ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
