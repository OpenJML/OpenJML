...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo IndexerInExpr
...
procedure Test.Foo$System.Int32.array$notnull(stuff$in: ref where $IsNotNull(stuff$in, ValueArray(System.Int32, 1)));
  ...
  requires 0 < $Length(stuff$in) && 0 <= cast(ValueArrayGet($Heap[stuff$in, $elements], 0),int);
...
{
  var stuff: ref where $IsNotNull(stuff, ValueArray(System.Int32, 1)), stack0o: ref;
  ...
  block4233:
    // ----- serialized AssertStatement  ----- IndexerInExpr.ssc(6,9)
    assert cast(ValueArrayGet($Heap[stuff, $elements], 0),int) != -1;
    goto block4386;
