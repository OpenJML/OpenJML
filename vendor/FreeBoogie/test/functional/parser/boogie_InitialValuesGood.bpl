...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo InitialValuesGood
...
{
  var stack0o: ref, local3604: int where InRange(local3604, System.Int32), stack0i: int;
  ...
  block2992:
    // ----- call  ----- InitialValuesGood.ssc(6,9)
    assert this != null;
    call System.Object..ctor(this);
    goto block3009;

  block3009:
    // ----- serialized AssertStatement  ----- InitialValuesGood.ssc(8,9)
    assert $Heap[this, Cell.Value] == 0;
    goto block3162;
  ...
  block3179:
    // ----- load field  ----- InitialValuesGood.ssc(9,9)
    assert this != null;
    local3604 := $Heap[this, Cell.Value];
    // ----- load constant 1  ----- InitialValuesGood.ssc(9,9)
    stack0i := 1;
    // ----- binary operator  ----- InitialValuesGood.ssc(9,9)
    stack0i := local3604 + stack0i;
    // ----- store field  ----- InitialValuesGood.ssc(9,9)
    assert this != null;
    assert !($Heap[this, $inv] <: Cell) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Cell.Value] := stack0i;
    assume IsHeap($Heap);
    // ----- copy  ----- InitialValuesGood.ssc(9,9)
    stack0i := local3604;
    goto block3196;

  block3196:
    // ----- nop  ----- InitialValuesGood.ssc(9,9)
    goto block3213;
  ...
  block3434:
    // ----- return  ----- InitialValuesGood.ssc(10,5)
    assert this != null;
...
{
  var stack50000o: ref, stack0o: ref, cell: ref where $Is(cell, Cell);
  ...
  block3927:
    // ----- new object  ----- InitialValuesGood.ssc(17,21)
    havoc stack50000o;
    ...
    // ----- call  ----- InitialValuesGood.ssc(17,21)
    assert stack50000o != null;
    call Cell..ctor(stack50000o);
    // ----- copy  ----- InitialValuesGood.ssc(17,9)
    stack0o := stack50000o;
    // ----- copy  ----- InitialValuesGood.ssc(17,9)
    cell := stack0o;
    goto block3944;
  ...
  block3944:
    // ----- serialized AssertStatement  ----- InitialValuesGood.ssc(18,9)
    assert $Heap[cell, Cell.Value] == 1;
    goto block4097;
  ...
  block4131:
    // ----- return  ----- InitialValuesGood.ssc(19,5)
    return;
...
implementation Test..ctor(this: ref)
{
  ...
  block4352:
    // ----- call  ----- InitialValuesGood.ssc(13,14)
    assert this != null;
    call System.Object..ctor(this);
    goto block4369;
