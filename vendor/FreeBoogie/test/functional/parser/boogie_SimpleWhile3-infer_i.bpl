...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify SimpleWhile3.dll /infer:i
...
{
  var i: int where InRange(i, System.Int32), count: int where InRange(count, System.Int32), stack0i: int, stack0b: bool, local2: int where InRange(local2, System.Int32), local3: int where InRange(local3, System.Int32), stack0o: ref, $Heap$block1309$LoopPreheader: [ref,<x>name]x;

  entry:
    assume $IsNotNull(this, SimpleWhile3);
  ...
  block1292:
    // ----- load constant 300476  ----- SimpleWhile3.ssc(6,3)
    i := int#300476;
    // ----- load constant 0  ----- SimpleWhile3.ssc(7,3)
    count := 0;
    goto block1309$LoopPreheader;

  block1309:
    // ----- default loop invariant: allocation and ownership are stable  ----- SimpleWhile3.ssc(9,3)
    assume (forall $o: ref :: $Heap$block1309$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block1309$LoopPreheader[$ot, $allocated] == true && $Heap$block1309$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block1309$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block1309$LoopPreheader[$ot, $ownerFrame]) && $Heap$block1309$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- SimpleWhile3.ssc(9,3)
    assume (forall $o: ref :: ($Heap$block1309$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block1309$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block1309$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block1309$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- SimpleWhile3.ssc(9,3)
    assert (forall $o: ref :: $o != null && $Heap$block1309$LoopPreheader[$o, $allocated] == true ==> $Heap$block1309$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block1309$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 0  ----- SimpleWhile3.ssc(9,3)
    stack0i := 0;
    // ----- binary operator  ----- SimpleWhile3.ssc(9,3)
    // ----- branch  ----- SimpleWhile3.ssc(9,3)
    goto true1309to1343, false1309to1326;
  ...
  block1343:
    // ----- serialized AssertStatement  ----- SimpleWhile3.ssc(15,3)
    assert count < 0;
    goto block1428;

  block1326:
    // ----- copy  ----- SimpleWhile3.ssc(11,4)
    local2 := i;
    // ----- load constant 1  ----- SimpleWhile3.ssc(11,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile3.ssc(11,4)
    stack0i := local2 - stack0i;
    // ----- copy  ----- SimpleWhile3.ssc(11,4)
    i := stack0i;
    // ----- copy
    stack0i := local2;
    // ----- copy  ----- SimpleWhile3.ssc(12,4)
    local3 := count;
    // ----- load constant 1  ----- SimpleWhile3.ssc(12,4)
    stack0i := 1;
    // ----- binary operator  ----- SimpleWhile3.ssc(12,4)
    stack0i := local3 - stack0i;
    // ----- copy  ----- SimpleWhile3.ssc(12,4)
    count := stack0i;
    // ----- copy
    stack0i := local3;
    // ----- branch  ----- SimpleWhile3.ssc(13,4)
    goto block1309;

  block1428:
    // ----- nop
    // ----- return  ----- SimpleWhile3.ssc(16,2)
    return;

  block1309$LoopPreheader:
    $Heap$block1309$LoopPreheader := $Heap;
    goto block1309;
...
implementation SimpleWhile3..ctor(this: ref)
{
  ...
  block1938:
    // ----- call  ----- SimpleWhile3.ssc(1,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == SimpleWhile3 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := SimpleWhile3;
    assume IsHeap($Heap);
    return;
