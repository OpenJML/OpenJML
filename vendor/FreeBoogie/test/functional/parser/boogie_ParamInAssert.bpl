...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo ParamInAssert
...
{
  var x: int where InRange(x, System.Int32), local3468: int where InRange(local3468, System.Int32), stack0i: int, stack0o: ref;
  ...
  block3094:
    // ----- copy  ----- ParamInAssert.ssc(6,5)
    local3468 := x;
    // ----- load constant 1  ----- ParamInAssert.ssc(6,5)
    stack0i := 1;
    // ----- binary operator  ----- ParamInAssert.ssc(6,5)
    stack0i := local3468 + stack0i;
    // ----- copy  ----- ParamInAssert.ssc(6,5)
    x := stack0i;
    // ----- copy  ----- ParamInAssert.ssc(6,5)
    stack0i := local3468;
  ...
  block3111:
    // ----- nop  ----- ParamInAssert.ssc(6,5)
    goto block3128;

  block3128:
    // ----- serialized AssertStatement  ----- ParamInAssert.ssc(7,5)
    assert 1 <= x;
    goto block3281;
...
{
  var x: int where InRange(x, System.Int32), local4607: int where InRange(local4607, System.Int32), stack0i: int, stack0o: ref;
  ...
  block4250:
    // ----- copy  ----- ParamInAssert.ssc(13,5)
    local4607 := x;
    // ----- load constant 1  ----- ParamInAssert.ssc(13,5)
    stack0i := 1;
    // ----- binary operator  ----- ParamInAssert.ssc(13,5)
    stack0i := local4607 - stack0i;
    // ----- copy  ----- ParamInAssert.ssc(13,5)
    x := stack0i;
    // ----- copy  ----- ParamInAssert.ssc(13,5)
    stack0i := local4607;
  ...
  block4267:
    // ----- nop  ----- ParamInAssert.ssc(13,5)
    goto block4284;

  block4284:
    // ----- serialized AssertStatement  ----- ParamInAssert.ssc(14,5)
    assert 0 <= x;
    goto block4437;
