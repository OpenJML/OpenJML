...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify ResultNotNewlyAllocated.dll
...
function #C.M([ref,<x>name]x, ref) returns (ref);
...
{
  var stack50000o: ref, stack0o: ref, return.value: ref where $Is(return.value, System.Object), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, System.Object);
  ...
  block1207:
    // ----- new object  ----- ResultNotNewlyAllocated.ssc(8,5)
    havoc stack50000o;
    ...
    // ----- call  ----- ResultNotNewlyAllocated.ssc(8,5)
    assert stack50000o != null;
    call System.Object..ctor(stack50000o);
    // ----- copy  ----- ResultNotNewlyAllocated.ssc(8,5)
    stack0o := stack50000o;
    // ----- copy  ----- ResultNotNewlyAllocated.ssc(8,5)
  ...
  block1224:
    ...
    // ----- copy  ----- ResultNotNewlyAllocated.ssc(9,3)
    stack0o := return.value;
    // ----- return  ----- ResultNotNewlyAllocated.ssc(9,3)
    $result := stack0o;
    return;
...
{
  var stack50000o: ref, stack0o: ref, return.value: ref where $Is(return.value, C), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, C);
  ...
  block1530:
    // ----- new object  ----- ResultNotNewlyAllocated.ssc(12,5)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == C;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- ResultNotNewlyAllocated.ssc(12,5)
    assert stack50000o != null;
    call C..ctor(stack50000o);
    // ----- copy  ----- ResultNotNewlyAllocated.ssc(12,5)
    stack0o := stack50000o;
    // ----- copy  ----- ResultNotNewlyAllocated.ssc(12,5)
    return.value := stack0o;
    // ----- branch
  ...
  block1547:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- ResultNotNewlyAllocated.ssc(13,3)
    stack0o := return.value;
    // ----- return  ----- ResultNotNewlyAllocated.ssc(13,3)
    $result := stack0o;
    return;
...
{
  var c: ref where $Is(c, C), stack0i: int, temp0: exposeVersionType, return.value: ref where $Is(return.value, C), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, C), stack0o: ref;
  ...
  block1853:
    // ----- call  ----- ResultNotNewlyAllocated.ssc(16,5)
    assert this != null;
    call c := C.O$.Virtual.$(this);
    // ----- load constant 5  ----- ResultNotNewlyAllocated.ssc(17,5)
    stack0i := 5;
    // ----- store field  ----- ResultNotNewlyAllocated.ssc(17,5)
    assert c != null;
    havoc temp0;
    $Heap[c, $exposeVersion] := temp0;
    $Heap[c, C.f] := stack0i;
    assume IsHeap($Heap);
    // ----- copy  ----- ResultNotNewlyAllocated.ssc(18,5)
    return.value := c;
    // ----- branch
    goto block1870;
  ...
  block1870:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- ResultNotNewlyAllocated.ssc(19,3)
    stack0o := return.value;
    // ----- return  ----- ResultNotNewlyAllocated.ssc(19,3)
    $result := stack0o;
    return;
...
implementation C..ctor(this: ref)
{
  ...
  block2159:
    // ----- call  ----- ResultNotNewlyAllocated.ssc(3,7)
    assert this != null;
