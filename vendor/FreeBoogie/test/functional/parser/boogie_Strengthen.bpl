...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo /proverMatchDepth:4 Strengthen
...
{
  var return.value: ref where $Is(return.value, System.String), SS$Display.Return.Local: ref where $Is(SS$Display.Return.Local, System.String), stack0o: ref;
  ...
  block3213:
    ...
    // ----- copy  ----- Strengthen.ssc(6,3)
    stack0o := return.value;
    // ----- return  ----- Strengthen.ssc(6,3)
    $result := stack0o;
    return;
...
implementation U.M(this: ref) returns ($result: ref)
{
  ...
  block4046:
    // ----- load constant "hello"  ----- Strengthen.ssc(13,5)
    return.value := $stringLiteral0;
    // ----- branch
    goto block4063;
  ...
  block4369:
    // ----- copy
    SS$Display.Return.Local := return.value;
    // ----- copy  ----- Strengthen.ssc(14,3)
    stack0o := return.value;
    // ----- return  ----- Strengthen.ssc(14,3)
    $result := stack0o;
    return;
...
implementation U..ctor(this: ref)
{
  ...
  block4658:
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == T && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == U ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := U;
    assume IsHeap($Heap);
    return;
...
{
  var stack50000o: ref, stack0o: ref, t: ref where $Is(t, T), u: ref where $Is(u, U);
  ...
  block4862:
    // ----- new object  ----- Strengthen.ssc(19,11)
    havoc stack50000o;
    ...
    // ----- call  ----- Strengthen.ssc(19,11)
    assert stack50000o != null;
    call T..ctor(stack50000o);
    // ----- copy  ----- Strengthen.ssc(19,5)
    stack0o := stack50000o;
    // ----- copy  ----- Strengthen.ssc(19,5)
    t := stack0o;
    goto block4879;
  ...
  block4879:
    // ----- new object  ----- Strengthen.ssc(20,11)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == U;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Strengthen.ssc(20,11)
    assert stack50000o != null;
    call U..ctor(stack50000o);
    // ----- copy  ----- Strengthen.ssc(20,5)
    stack0o := stack50000o;
    // ----- copy  ----- Strengthen.ssc(20,5)
    u := stack0o;
    goto block4896;
  ...
  block4913:
    // ----- call  ----- Strengthen.ssc(23,5)
    assert t != null;
    call stack0o := T.M$.Virtual.$(t);
    // ----- call  ----- Strengthen.ssc(24,5)
    assert u != null;
    call stack0o := U.M$.Virtual.$(u);
    goto block4930;
...
{
  var t: ref where $IsNotNull(t, T), o: ref where $Is(o, System.Object), stack0o: ref;
  ...
  block5763:
    // ----- call  ----- Strengthen.ssc(28,5)
    assert t != null;
    call o := T.M$.Virtual.$(t);
    goto block5780;

  block5780:
    // ----- serialized AssertStatement  ----- Strengthen.ssc(29,5)
    assert o != null;
    goto block5933;
...
{
  var u: ref where $IsNotNull(u, U), o: ref where $Is(o, System.Object), stack0o: ref;
  ...
  block6868:
    // ----- call  ----- Strengthen.ssc(33,5)
    assert u != null;
    call o := U.M$.Virtual.$(u);
    goto block6885;

  block6885:
    // ----- serialized AssertStatement  ----- Strengthen.ssc(34,5)
    assert o != null;
    goto block7038;
...
implementation MainClass..ctor(this: ref)
{
  ...
  entry:
    assume $IsNotNull(this, MainClass);
    assume $Heap[this, $allocated] == true;
    assume ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame]) || $Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame])) && $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    goto block7310;
  ...
  block7378:
    ...
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == MainClass ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := MainClass;
    assume IsHeap($Heap);
    return;
