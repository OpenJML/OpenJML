...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Subclass
...
implementation Super..ctor(this: ref)
{
  ...
  block2482:
    ...
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Super ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Super;
    assume IsHeap($Heap);
    return;
...
{
  var stack0i: int, temp0: exposeVersionType, stack0o: ref;

  entry:
    assume $IsNotNull(this, Sub);
    assume $Heap[this, $allocated] == true;
    assume ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame]) || $Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame])) && $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assume $Heap[this, Sub.x] == 0;
    goto block2924;
  ...
  block2992:
    // ----- load constant 10  ----- Subclass.ssc(7,14)
    stack0i := 10;
    // ----- store field  ----- Subclass.ssc(7,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Sub.x] := stack0i;
    assume IsHeap($Heap);
    // ----- call  ----- Subclass.ssc(8,5)
    assert this != null;
    call Super..ctor(this);
    goto block3009;

  block3009:
    // ----- serialized AssertStatement  ----- Subclass.ssc(9,5)
    assert $Heap[this, Sub.x] == 10;
    goto block3162;
  ...
  block3196:
    // ----- return  ----- Subclass.ssc(10,3)
    assert this != null;
    assert $Heap[this, $inv] == Super && $Heap[this, $localinv] == $typeof(this);
...
{
  var b: bool where true, stack0i: int, temp0: exposeVersionType, stack0o: ref;
  ...
  block3689:
    // ----- load constant 10  ----- Subclass.ssc(12,14)
    stack0i := 10;
    // ----- store field  ----- Subclass.ssc(12,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Sub.x] := stack0i;
    assume IsHeap($Heap);
    // ----- call  ----- Subclass.ssc(13,5)
    assert this != null;
    call Super..ctor(this);
    goto block3706;

  block3706:
    // ----- serialized AssertStatement  ----- Subclass.ssc(14,5)
    assert false;
    assert this != null;
    assert $Heap[this, $inv] == Super && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Sub ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
...
{
  var stack0s: struct, t: ref where $Is(t, System.Object), stack0o: ref;
  ...
  block4454:
    // ----- load token  ----- Subclass.ssc(19,16)
    havoc stack0s;
    assume $IsTokenForType(stack0s, Sub);
    // ----- statically resolved GetTypeFromHandle call  ----- Subclass.ssc(19,5)
    t := TypeObject(Sub);
    goto block4471;

  block4471:
    // ----- serialized AssertStatement  ----- Subclass.ssc(20,5)
    assert t != null;
    goto block4624;
  ...
  block4641:
    // ----- serialized AssertStatement  ----- Subclass.ssc(21,5)
    assert $IsNotNull(t, System.Object);
    goto block4794;
