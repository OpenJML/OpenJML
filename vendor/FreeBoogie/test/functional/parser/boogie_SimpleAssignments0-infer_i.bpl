...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify SimpleAssignments0.dll /infer:i
...
{
  var val: int where InRange(val, System.Int32), a: int where InRange(a, System.Int32), stack0i: int, stack0b: bool, b: int where InRange(b, System.Int32), c: int where InRange(c, System.Int32), stack0o: ref;

  entry:
    assume $IsNotNull(this, SimpleAssignments0);
  ...
  block1292:
    // ----- load constant 3  ----- SimpleAssignments0.ssc(6,3)
    a := 3;
    // ----- load constant 0  ----- SimpleAssignments0.ssc(8,3)
    stack0i := 0;
    // ----- binary operator  ----- SimpleAssignments0.ssc(8,3)
    // ----- branch  ----- SimpleAssignments0.ssc(8,3)
    goto true1292to1326, false1292to1309;
  ...
  block1326:
    // ----- load constant 2  ----- SimpleAssignments0.ssc(14,4)
    b := 2;
    // ----- nop  ----- SimpleAssignments0.ssc(17,3)
    goto block1343;

  block1309:
    // ----- load constant -2  ----- SimpleAssignments0.ssc(10,4)
    b := -2;
    // ----- branch  ----- SimpleAssignments0.ssc(12,3)
    goto block1343;

  block1343:
    // ----- binary operator  ----- SimpleAssignments0.ssc(17,3)
    stack0i := a + b;
    // ----- copy  ----- SimpleAssignments0.ssc(17,3)
    c := stack0i;
    // ----- serialized AssertStatement  ----- SimpleAssignments0.ssc(19,3)
    assert c > 0;
    goto block1428;

  block1428:
    // ----- nop
    // ----- return  ----- SimpleAssignments0.ssc(20,2)
    return;
...
implementation SimpleAssignments0..ctor(this: ref)
{
  ...
  block1819:
    // ----- call  ----- SimpleAssignments0.ssc(1,7)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == SimpleAssignments0 ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := SimpleAssignments0;
    assume IsHeap($Heap);
    return;
