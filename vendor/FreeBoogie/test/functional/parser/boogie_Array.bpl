...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify Array.dll
...
{
  var a: ref where $IsNotNull(a, RefArray(test3.MyClass, 1)), stack0o: ref;

  entry:
    assume $IsNotNull(this, test3.MyClass);
  ...
  block3094:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(11,7)
    assert $Length(a) >= 0;
    goto block3179;

  block3179:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(13,7)
    assert $Rank(a) == 1;
    goto block3264;

  block3264:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(15,7)
    assert $IsNotNull(a, RefArray(test3.MyClass, 1));
    goto block3349;

  block3349:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(16,7)
    assert $IsNotNull(a, RefArray(test3.MyClass, 1));
    goto block3434;

  block3434:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(17,7)
    assert $IsNotNull(a, System.Array);
    goto block3519;

  block3519:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(18,7)
    assert $IsNotNull(a, System.Array);
    goto block3604;
...
{
  var a: ref where $IsNotNull(a, RefArray(RefArray(test3.MyClass, 1), 1)), stack0o: ref;
  ...
  block4760:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(24,7)
    assert $Length(a) >= 0;
    goto block4845;

  block4845:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(26,7)
    assert $Rank(a) == 1;
    goto block4930;

  block4930:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(28,7)
    assert $IsNotNull(a, System.Array);
    goto block5015;
...
{
  var a: ref where $IsNotNull(a, RefArray(test3.MyClass, 2)), stack0o: ref;
  ...
  block5916:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(34,7)
    assert $Length(a) >= 0;
    goto block6001;

  block6001:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(36,7)
    assert $Rank(a) == 2;
    goto block6086;

  block6086:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(38,7)
    assert $IsNotNull(a, System.Array);
    goto block6171;
...
{
  var a: ref where $IsNotNull(a, System.Array), stack0o: ref;
  ...
  block6987:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(44,7)
    assert $Length(a) >= 0;
    goto block7072;

  block7072:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(46,7)
    assert $Rank(a) >= 1;
    goto block7157;
...
{
  var howMany: int where InRange(howMany, System.Int32), stack0i: int, arr: ref where $Is(arr, ValueArray(System.Int32, 1)), stack0o: ref;
  ...
  block7803:
    ...
    assume IsHeap($Heap);
    // ----- serialized AssertStatement  ----- Array.ssc(52,7)
    assert $Length(arr) == howMany;
    goto block7888;

  block7888:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(53,7)
    assert $Rank(arr) == 1;
    goto block7973;

  block7973:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(55,7)
    assert $IsNotNull(arr, System.Array);
    goto block8058;

  block8058:
    // ----- nop
    // ----- return  ----- Array.ssc(56,5)
    return;
...
implementation test3.MyClass.Allocate1$System.Int32(this: ref, howMany$in: int)
{
  ...
  block8942:
    ...
    $Heap[arr, $allocated] := true;
    assume IsHeap($Heap);
    // ----- serialized AssertStatement  ----- Array.ssc(62,7)
    assert $Length(arr) == howMany;
    goto block9027;

  block9027:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(63,7)
    assert $Rank(arr) == 1;
    goto block9112;

  block9112:
    // ----- nop
    // ----- serialized AssertStatement  ----- Array.ssc(65,7)
    assert $IsNotNull(arr, System.Array);
    goto block9197;
...
{
  var a: ref where $IsNotNull(a, RefArray(System.String, 1)), stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block10081:
    // ----- nop
    // ----- load constant 0  ----- Array.ssc(72,7)
    stack0i := 0;
    // ----- array getlength  ----- Array.ssc(72,7)
    assert a != null;
    return.value := $DimLength(a, stack0i);
    // ----- branch
    goto block10183;
...
{
  var a: ref where $IsNotNull(a, RefArray(System.String, 2)), stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32);
  ...
  block10914:
    // ----- nop
    // ----- load constant 0  ----- Array.ssc(79,7)
    stack0i := 0;
    // ----- array getlength  ----- Array.ssc(79,7)
    assert a != null;
    return.value := $DimLength(a, stack0i);
    // ----- branch
    goto block11016;
...
implementation test3.MyClass..ctor(this: ref)
{
  ...
  block11373:
    ...
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == test3.MyClass ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := test3.MyClass;
    assume IsHeap($Heap);
    return;
