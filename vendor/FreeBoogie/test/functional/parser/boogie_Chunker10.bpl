...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Chunker10
...
implementation Chunker.SpecSharp.CheckInvariant$System.Boolean(this: ref, throwException$in: bool) returns ($result: bool)
{
  ...
  block3859:
    // ----- load constant 0  ----- Chunker10.ssc(5,13)
    stack0i := 0;
    // ----- load field  ----- Chunker10.ssc(5,17)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker10.ssc(5,13)
    // ----- branch
    goto true3859to3978, false3859to3876;
  ...
  block3876:
    ...
    // ----- unary operator
    // ----- branch
    goto true3876to3927, false3876to3893;
  ...
  block4012:
    // ----- load constant 0  ----- Chunker10.ssc(7,13)
    stack0i := 0;
    // ----- load field  ----- Chunker10.ssc(7,18)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- binary operator  ----- Chunker10.ssc(7,13)
    // ----- branch
  ...
  block4029:
    // ----- load field  ----- Chunker10.ssc(7,23)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker10.ssc(7,28)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker10.ssc(7,28)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker10.ssc(7,23)
    // ----- branch
  ...
  block4080:
    ...
    // ----- unary operator
    // ----- branch
    goto true4080to4131, false4080to4097;
  ...
  block4097:
    assume false;
    // ----- new object  ----- Chunker10.ssc(7,3)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == Microsoft.Contracts.ObjectInvariantException;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- Chunker10.ssc(7,3)
    assert stack50000o != null;
    call Microsoft.Contracts.ObjectInvariantException..ctor(stack50000o);
    // ----- copy  ----- Chunker10.ssc(7,3)
    stack0o := stack50000o;
    // ----- throw  ----- Chunker10.ssc(7,3)
    assert stack0o != null;
    assume false;
    return;
...
{
  var temp0: ref, stack1s: struct, stack1o: ref, temp1: exposeVersionType, local6715: ref where $Is(local6715, System.Exception), stack0i: int, stack1i: int, stack0b: bool, stack0o: ref, stack2i: int, s: ref where $Is(s, System.String), return.value: ref where $IsNotNull(return.value, System.String), stack0s: struct, SS$Display.Return.Local: ref where $IsNotNull(SS$Display.Return.Local, System.String);
  ...
  block5661:
    // ----- FrameGuard processing  ----- Chunker10.ssc(12,13)
    temp0 := this;
    // ----- load token  ----- Chunker10.ssc(12,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, Chunker);
    // ----- statically resolved GetTypeFromHandle call  ----- Chunker10.ssc(12,13)
    stack1o := TypeObject(Chunker);
    // ----- local unpack  ----- Chunker10.ssc(12,13)
    assert temp0 != null;
  ...
  block5695:
    // ----- load field  ----- Chunker10.ssc(14,11)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker10.ssc(14,15)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker10.ssc(14,11)
    stack0i := stack0i + stack1i;
    // ----- load field  ----- Chunker10.ssc(14,28)
    assert this != null;
    stack1o := $Heap[this, Chunker.src];
    // ----- string length  ----- Chunker10.ssc(14,28)
    assert stack1o != null;
    stack1i := $StringLength(stack1o);
    // ----- binary operator  ----- Chunker10.ssc(14,11)
    // ----- branch  ----- Chunker10.ssc(14,7)
    goto true5695to5746, false5695to5712;
  ...
  block5746:
    // ----- load field  ----- Chunker10.ssc(17,13)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker10.ssc(17,27)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- call  ----- Chunker10.ssc(17,9)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32(stack0o, stack1i);
    // ----- nop  ----- Chunker10.ssc(19,7)
    goto block5763;

  block5712:
    // ----- load field  ----- Chunker10.ssc(15,13)
    assert this != null;
    stack0o := $Heap[this, Chunker.src];
    // ----- load field  ----- Chunker10.ssc(15,27)
    assert this != null;
    stack1i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker10.ssc(15,30)
    assert this != null;
    stack2i := $Heap[this, Chunker.ChunkSize];
    // ----- call  ----- Chunker10.ssc(15,9)
    assert stack0o != null;
    call s := System.String.Substring$System.Int32$System.Int32(stack0o, stack1i, stack2i);
    goto block5729;

  block5729:
    // ----- branch  ----- Chunker10.ssc(16,9)
    goto block5763;
  ...
  block5780:
    // ----- load field  ----- Chunker10.ssc(19,7)
    assert this != null;
    stack0i := $Heap[this, Chunker.n];
    // ----- load field  ----- Chunker10.ssc(19,12)
    assert this != null;
    stack1i := $Heap[this, Chunker.ChunkSize];
    // ----- binary operator  ----- Chunker10.ssc(19,7)
    stack0i := stack0i + stack1i;
    // ----- store field  ----- Chunker10.ssc(19,7)
    assert this != null;
  ...
  block6188:
    ...
    // ----- binary operator
    // ----- branch
    goto true6188to6290, false6188to6205;

  true6188to6290:
    assume local6715 == stack0o;
    goto block6290;
  ...
  block6205:
    // ----- is instance
    // ----- branch
    goto true6205to6290, false6205to6222;

  true6205to6290:
    assume $As(local6715, Microsoft.Contracts.ICheckedException) != null;
    goto block6290;
  ...
  block6307:
    // ----- load token  ----- Chunker10.ssc(21,5)
    havoc stack0s;
    assume $IsTokenForType(stack0s, Chunker);
    // ----- statically resolved GetTypeFromHandle call  ----- Chunker10.ssc(21,5)
    stack0o := TypeObject(Chunker);
    // ----- local pack  ----- Chunker10.ssc(21,5)
    assert temp0 != null;
...
implementation Chunker..ctor$System.String$notnull$System.Int32(this: ref, source$in: ref, chunkSize$in: int)
{
  ...
  block7837:
    // ----- store field  ----- Chunker10.ssc(27,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.src] := source;
    assume IsHeap($Heap);
    // ----- store field  ----- Chunker10.ssc(28,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.ChunkSize] := chunkSize;
    assume IsHeap($Heap);
    // ----- load constant 0  ----- Chunker10.ssc(29,9)
    stack0i := 0;
    // ----- store field  ----- Chunker10.ssc(29,5)
    assert this != null;
    assert !($Heap[this, $inv] <: Chunker) || $Heap[this, $localinv] == System.Object;
    $Heap[this, Chunker.n] := stack0i;
    assume IsHeap($Heap);
  ...
  block8024:
    // ----- FrameGuard processing  ----- Chunker10.ssc(31,3)
    temp0 := this;
    // ----- classic pack  ----- Chunker10.ssc(31,3)
    assert temp0 != null;
