...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo Good
...
{
  var stack50000o: ref, stack0o: ref, cell1: ref where $Is(cell1, Cell), cell2: ref where $Is(cell2, Cell);
  ...
  block3740:
    ...
    stack0o := cell1;
    // ----- call  ----- Good.ssc(18,9)
    call Cell.DoStuff$Cell(stack0o);
    goto block3757;

  block3757:
    // ----- serialized AssertStatement  ----- Good.ssc(19,9)
    assert $Heap[cell2, Cell.x] == 0;
    goto block3910;
