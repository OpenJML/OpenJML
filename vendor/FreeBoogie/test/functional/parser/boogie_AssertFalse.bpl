...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify AssertFalse.dll
...
const AssertFalseTest.Field0: <ref>name;
...
implementation AssertFalseTest.Test0(this: ref)
{
  ...
  entry:
    assume $IsNotNull(this, AssertFalseTest);
    assume $Heap[this, $allocated] == true;
    goto block1496;
  ...
  block1513:
    // ----- serialized AssertStatement  ----- AssertFalse.ssc(9,5)
    assert false;
    return;
...
{
  var local0: ref where $Is(local0, AssertFalseTest), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType;
  ...
  block2363:
    // ----- copy  ----- AssertFalse.ssc(14,13)
    local0 := this;
    // ----- copy  ----- AssertFalse.ssc(14,13)
    stack0o := local0;
    // ----- load token  ----- AssertFalse.ssc(14,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, AssertFalseTest);
    // ----- statically resolved GetTypeFromHandle call  ----- AssertFalse.ssc(14,13)
    stack1o := TypeObject(AssertFalseTest);
    // ----- local unpack  ----- AssertFalse.ssc(14,13)
    assert stack0o != null;
    assert ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && $Heap[stack0o, $inv] <: AssertFalseTest && $Heap[stack0o, $localinv] == $typeof(stack0o);
  ...
  block2380:
    // ----- serialized AssertStatement  ----- AssertFalse.ssc(16,7)
    assert false;
    return;
...
{
  var local0: ref where $Is(local0, AssertFalseTest), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType, i: int where InRange(i, System.Int32), stack0i: int, stack0b: bool, local2: int where InRange(local2, System.Int32), $Heap$block3230$LoopPreheader: [ref,<x>name]x;
  ...
  block3196:
    // ----- copy  ----- AssertFalse.ssc(22,13)
    local0 := this;
    // ----- copy  ----- AssertFalse.ssc(22,13)
    stack0o := local0;
    // ----- load token  ----- AssertFalse.ssc(22,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, AssertFalseTest);
    // ----- statically resolved GetTypeFromHandle call  ----- AssertFalse.ssc(22,13)
    stack1o := TypeObject(AssertFalseTest);
    // ----- local unpack  ----- AssertFalse.ssc(22,13)
    assert stack0o != null;
    assert ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && $Heap[stack0o, $inv] <: AssertFalseTest && $Heap[stack0o, $localinv] == $typeof(stack0o);
    $Heap[stack0o, $localinv] := System.Object;
    havoc temp0;
  ...
  block3213:
    // ----- load constant 0  ----- AssertFalse.ssc(24,12)
    i := 0;
    goto block3230$LoopPreheader;

  block3230:
    // ----- default loop invariant: allocation and ownership are stable  ----- AssertFalse.ssc(24,23)
    assume (forall $o: ref :: $Heap$block3230$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block3230$LoopPreheader[$ot, $allocated] == true && $Heap$block3230$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block3230$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block3230$LoopPreheader[$ot, $ownerFrame]) && $Heap$block3230$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- AssertFalse.ssc(24,23)
    assume (forall $o: ref :: ($Heap$block3230$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block3230$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block3230$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block3230$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- AssertFalse.ssc(24,23)
    assert (forall $o: ref :: $o != null && $Heap$block3230$LoopPreheader[$o, $allocated] == true ==> $Heap$block3230$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block3230$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 10  ----- AssertFalse.ssc(24,23)
    stack0i := 10;
    // ----- binary operator  ----- AssertFalse.ssc(24,23)
    // ----- branch  ----- AssertFalse.ssc(24,23)
  ...
  block3264:
    // ----- serialized AssertStatement  ----- AssertFalse.ssc(25,7)
    assert false;
    return;

  block3247:
    // ----- copy  ----- AssertFalse.ssc(24,31)
    local2 := i;
    // ----- load constant 1  ----- AssertFalse.ssc(24,31)
    stack0i := 1;
    // ----- binary operator  ----- AssertFalse.ssc(24,31)
  ...
  block3230$LoopPreheader:
    $Heap$block3230$LoopPreheader := $Heap;
    goto block3230;
...
{
  var local0: ref where $Is(local0, AssertFalseTest), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType, i: int where InRange(i, System.Int32), stack0i: int, stack0b: bool, stack50000o: ref, local2: int where InRange(local2, System.Int32), $Heap$block4267$LoopPreheader: [ref,<x>name]x;
  ...
  block4233:
    // ----- copy  ----- AssertFalse.ssc(31,13)
    local0 := this;
    // ----- copy  ----- AssertFalse.ssc(31,13)
    stack0o := local0;
    // ----- load token  ----- AssertFalse.ssc(31,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, AssertFalseTest);
    // ----- statically resolved GetTypeFromHandle call  ----- AssertFalse.ssc(31,13)
    stack1o := TypeObject(AssertFalseTest);
    // ----- local unpack  ----- AssertFalse.ssc(31,13)
    assert stack0o != null;
    assert ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && $Heap[stack0o, $inv] <: AssertFalseTest && $Heap[stack0o, $localinv] == $typeof(stack0o);
    $Heap[stack0o, $localinv] := System.Object;
    havoc temp0;
  ...
  block4250:
    // ----- load constant 0  ----- AssertFalse.ssc(33,12)
    i := 0;
    goto block4267$LoopPreheader;

  block4267:
    // ----- default loop invariant: allocation and ownership are stable  ----- AssertFalse.ssc(33,23)
    assume (forall $o: ref :: $Heap$block4267$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block4267$LoopPreheader[$ot, $allocated] == true && $Heap$block4267$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block4267$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block4267$LoopPreheader[$ot, $ownerFrame]) && $Heap$block4267$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- AssertFalse.ssc(33,23)
    assume (forall $o: ref :: ($Heap$block4267$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block4267$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block4267$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block4267$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- AssertFalse.ssc(33,23)
    assert (forall $o: ref :: $o != null && $Heap$block4267$LoopPreheader[$o, $allocated] == true ==> $Heap$block4267$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block4267$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- load constant 10  ----- AssertFalse.ssc(33,23)
    stack0i := 10;
    // ----- binary operator  ----- AssertFalse.ssc(33,23)
    // ----- branch  ----- AssertFalse.ssc(33,23)
    goto true4267to4301, false4267to4284;
  ...
  block4301:
    // ----- serialized AssertStatement  ----- AssertFalse.ssc(38,7)
    assert false;
    return;

  block4284:
    // ----- new object  ----- AssertFalse.ssc(35,9)
    havoc stack50000o;
    ...
    // ----- call  ----- AssertFalse.ssc(35,9)
    assert stack50000o != null;
    call F..ctor(stack50000o);
    // ----- copy  ----- AssertFalse.ssc(35,9)
    stack0o := stack50000o;
    // ----- store field  ----- AssertFalse.ssc(35,9)
    assert this != null;
    assert !($Heap[this, $inv] <: AssertFalseTest) || $Heap[this, $localinv] == System.Object;
    $Heap[this, AssertFalseTest.Field0] := stack0o;
    assume IsHeap($Heap);
    // ----- copy  ----- AssertFalse.ssc(33,31)
    local2 := i;
    // ----- load constant 1  ----- AssertFalse.ssc(33,31)
    stack0i := 1;
    // ----- binary operator  ----- AssertFalse.ssc(33,31)
    stack0i := local2 + stack0i;
    // ----- copy  ----- AssertFalse.ssc(33,31)
    i := stack0i;
    // ----- copy
  ...
  block4267$LoopPreheader:
    $Heap$block4267$LoopPreheader := $Heap;
    goto block4267;
...
implementation AssertFalseTest..ctor(this: ref)
{
  ...
  entry:
    ...
    assume $Heap[this, $allocated] == true;
    assume ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame]) || $Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame])) && $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assume $Heap[this, AssertFalseTest.Field0] == null;
    goto block5049;
  ...
  block5066:
    // ----- call  ----- AssertFalse.ssc(3,21)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == AssertFalseTest ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := AssertFalseTest;
    assume IsHeap($Heap);
    return;
