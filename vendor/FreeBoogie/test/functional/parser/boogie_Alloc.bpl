...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify Alloc.dll
...
const Alloc.gt: <ref>name;

const Stru.o: <ref>name;
...
{
  var a: ref where $Is(a, T), x: ref where $Is(x, T), stack50000o: ref, stack0o: ref, b: ref where $Is(b, T);
  ...
  block1734:
    // ----- call  ----- Alloc.ssc(7,5)
    call x := Alloc.GimmieOne();
    // ----- new object  ----- Alloc.ssc(8,5)
    havoc stack50000o;
    ...
    // ----- copy  ----- Alloc.ssc(8,5)
    b := stack0o;
    // ----- serialized AssertStatement  ----- Alloc.ssc(9,5)
    assert a != b;
    goto block1819;

  block1819:
    // ----- nop
    // ----- serialized AssertStatement  ----- Alloc.ssc(10,5)
    assert x != b;
    goto block1904;

  block1904:
    // ----- nop
    // ----- return  ----- Alloc.ssc(11,3)
    return;
...
{
  var a: ref where $IsNotNull(a, T), stack50000o: ref, stack0o: ref, b: ref where $Is(b, T);
  ...
  block2907:
    ...
    // ----- copy  ----- Alloc.ssc(18,5)
    b := stack0o;
    // ----- serialized AssertStatement  ----- Alloc.ssc(19,5)
    assert $Heap[a, T.next] != b;
    goto block2992;
...
{
  var a: ref where $IsNotNull(a, T), c: ref where $Is(c, T), d: ref where $Is(d, T), stack50000o: ref, stack0o: ref, b: ref where $Is(b, T);
  ...
  block4012:
    ...
    assert b != null;
    call T.M(b);
    // ----- serialized AssertStatement  ----- Alloc.ssc(27,5)
    assert b != $Heap[a, T.next];
    goto block4097;

  block4097:
    // ----- nop
    // ----- serialized AssertStatement  ----- Alloc.ssc(28,5)
    assert b != c;
    goto block4182;

  block4182:
    // ----- nop
    // ----- serialized AssertStatement  ----- Alloc.ssc(29,5)
    assert b != d;
    goto block4267;

  block4267:
    // ----- nop
    // ----- serialized AssertStatement  ----- Alloc.ssc(30,5)
    assert $Heap[a, T.next] == null || $Heap[$Heap[a, T.next], T.next] != b;
    goto block4369;

  block4369:
    // ----- nop
    // ----- serialized AssertStatement  ----- Alloc.ssc(31,5)
    assert $Heap[a, T.next] == null || $Heap[$Heap[a, T.next], T.next] == null || $Heap[$Heap[$Heap[a, T.next], T.next], T.next] != b;
    goto block4488;
...
implementation Alloc.M3$T$notnull(a$in: ref)
{
  ...
  block5508:
    ...
    // ----- copy  ----- Alloc.ssc(35,5)
    b := stack0o;
    // ----- serialized AssertStatement  ----- Alloc.ssc(36,5)
    assert $Heap[b, T.next] == null;
    goto block5593;
...
implementation Alloc.M4$T$notnull(a$in: ref)
{
  ...
  block6222:
    ...
    // ----- copy  ----- Alloc.ssc(40,5)
    b := stack0o;
    // ----- serialized AssertStatement  ----- Alloc.ssc(41,5)
    assert $Heap[b, T.next] != a;
    goto block6307;
...
{
  var old_gt: ref where $Is(old_gt, T), stack50000o: ref, stack0o: ref, b: ref where $Is(b, T);
  ...
  block7361:
    // ----- load field  ----- Alloc.ssc(48,5)
    old_gt := $Heap[ClassRepr(Alloc), Alloc.gt];
    // ----- new object  ----- Alloc.ssc(49,5)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == T;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    ...
    // ----- copy  ----- Alloc.ssc(49,5)
    b := stack0o;
    // ----- serialized AssumeStatement  ----- Alloc.ssc(50,5)
    assume $Heap[ClassRepr(Alloc), Alloc.gt] == null || (($Heap[$Heap[ClassRepr(Alloc), Alloc.gt], $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[$Heap[ClassRepr(Alloc), Alloc.gt], $ownerRef], $inv] <: $Heap[$Heap[ClassRepr(Alloc), Alloc.gt], $ownerFrame]) || $Heap[$Heap[$Heap[ClassRepr(Alloc), Alloc.gt], $ownerRef], $localinv] == $BaseClass($Heap[$Heap[ClassRepr(Alloc), Alloc.gt], $ownerFrame])) && $Heap[$Heap[ClassRepr(Alloc), Alloc.gt], $inv] == $typeof($Heap[ClassRepr(Alloc), Alloc.gt]) && $Heap[$Heap[ClassRepr(Alloc), Alloc.gt], $localinv] == $typeof($Heap[ClassRepr(Alloc), Alloc.gt]));
    goto block7463;

  block7463:
    // ----- nop
    // ----- serialized AssertStatement  ----- Alloc.ssc(51,5)
    assert b != old_gt;
    goto block7548;

  block7548:
    // ----- nop
    // ----- serialized AssertStatement  ----- Alloc.ssc(52,5)
    assert b != $Heap[ClassRepr(Alloc), Alloc.gt];
    goto block7633;

  block7633:
    // ----- nop
    // ----- serialized AssertStatement  ----- Alloc.ssc(53,5)
    assert $Heap[ClassRepr(Alloc), Alloc.gt] == null || $Heap[$Heap[ClassRepr(Alloc), Alloc.gt], T.next] == null || $Heap[$Heap[ClassRepr(Alloc), Alloc.gt], T.next] != b;
    goto block7752;

  block7752:
    // ----- nop
    // ----- return  ----- Alloc.ssc(54,3)
    return;
...
implementation T.get_Next(this: ref) returns ($result: ref)
{
  ...
  block8364:
    // ----- load field  ----- Alloc.ssc(63,7)
    assert this != null;
    return.value := $Heap[this, T.next];
    // ----- branch
    goto block8381;
...
{
  var s: struct where true, stack50000o: ref, stack0o: ref, t: ref where $Is(t, T);
  ...
  block9146:
    ...
    // ----- copy  ----- Alloc.ssc(75,5)
    t := stack0o;
    // ----- serialized AssertStatement  ----- Alloc.ssc(76,5)
    assert cast($StructGet(s, Stru.o),ref) != t;
    goto block9231;

  block9231:
    // ----- nop
    // ----- return  ----- Alloc.ssc(77,3)
    return;
...
{
  var a: ref where $IsNotNull(a, RefArray(T, 1)), j: int where InRange(j, System.Int32), stack50000o: ref, stack0o: ref, t: ref where $Is(t, T);
  ...
  block11050:
    ...
    // ----- copy  ----- Alloc.ssc(82,5)
    t := stack0o;
    // ----- serialized AssertStatement  ----- Alloc.ssc(83,5)
    assert RefArrayGet($Heap[a, $elements], j) != t;
    goto block11135;
...
{
  var sa: ref where $IsNotNull(sa, ValueArray(Stru, 1)), j: int where InRange(j, System.Int32), stack50000o: ref, stack0o: ref, t: ref where $Is(t, T);
  ...
  block11900:
    ...
    // ----- copy  ----- Alloc.ssc(89,5)
    t := stack0o;
    // ----- serialized AssertStatement  ----- Alloc.ssc(90,5)
    assert cast($StructGet(cast(ValueArrayGet($Heap[sa, $elements], j),struct), Stru.o),ref) != t;
    goto block11985;
