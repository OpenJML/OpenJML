...
// Command Line Options: /nologo -nologo /nologo /prover:blank /nologo /print:boogie_tmp.@TIME@.bpl /nologo /proverLog:boogie_tmp.@TIME@.simplify /nologo /nologo /nologo /nologo /nologo WhileBad
...
{
  var n: int where InRange(n, System.Int32), m: int where InRange(m, System.Int32), i: int where InRange(i, System.Int32), stack0o: ref, stack0b: bool, local3791: int where InRange(local3791, System.Int32), stack0i: int, return.value: int where InRange(return.value, System.Int32), SS$Display.Return.Local: int where InRange(SS$Display.Return.Local, System.Int32), $Heap$block3060$LoopPreheader: [ref,<x>name]x;
  ...
  block3026:
    // ----- load constant 0  ----- WhileBad.ssc(6,9)
    m := 0;
    goto block3043;

  block3043:
    // ----- load constant 0  ----- WhileBad.ssc(7,9)
    i := 0;
    goto block3060$LoopPreheader;

  block3060:
    // ----- default loop invariant: allocation and ownership are stable  ----- WhileBad.ssc(9,23)
    assume (forall $o: ref :: $Heap$block3060$LoopPreheader[$o, $allocated] == true ==> $Heap[$o, $allocated] == true) && (forall $ot: ref :: $Heap$block3060$LoopPreheader[$ot, $allocated] == true && $Heap$block3060$LoopPreheader[$ot, $ownerFrame] != $PeerGroupPlaceholder ==> $Heap[$ot, $ownerRef] == $Heap$block3060$LoopPreheader[$ot, $ownerRef] && $Heap[$ot, $ownerFrame] == $Heap$block3060$LoopPreheader[$ot, $ownerFrame]) && $Heap$block3060$LoopPreheader[$BeingConstructed, $NonNullFieldsAreInitialized] == $Heap[$BeingConstructed, $NonNullFieldsAreInitialized];
    // ----- default loop invariant: $inv field  ----- WhileBad.ssc(9,23)
    assume (forall $o: ref :: ($Heap$block3060$LoopPreheader[$o, $inv] == $Heap[$o, $inv] && $Heap$block3060$LoopPreheader[$o, $localinv] == $Heap[$o, $localinv]) || $Heap$block3060$LoopPreheader[$o, $allocated] != true);
    assume (forall $o: ref :: $Heap$block3060$LoopPreheader[$o, $allocated] != true && $Heap[$o, $allocated] == true ==> $Heap[$o, $inv] == $typeof($o) && $Heap[$o, $localinv] == $typeof($o));
    // ----- default loop invariant: $ownerRef and $ownerFrame fields  ----- WhileBad.ssc(9,23)
    assert (forall $o: ref :: $o != null && $Heap$block3060$LoopPreheader[$o, $allocated] == true ==> $Heap$block3060$LoopPreheader[$o, $ownerRef] == $Heap[$o, $ownerRef] && $Heap$block3060$LoopPreheader[$o, $ownerFrame] == $Heap[$o, $ownerFrame]);
    // ----- serialized LoopInvariant  ----- WhileBad.ssc(9,23)
    assert m == i;
    goto block3213;
  ...
  block3230:
    // ----- binary operator  ----- WhileBad.ssc(8,16)
    // ----- branch  ----- WhileBad.ssc(8,9)
    goto true3230to3315, false3230to3247;
  ...
  block3247:
    // ----- copy  ----- WhileBad.ssc(11,13)
    m := i;
    goto block3264;

  block3264:
    // ----- copy  ----- WhileBad.ssc(12,13)
    local3791 := m;
    // ----- load constant 1  ----- WhileBad.ssc(12,13)
    stack0i := 1;
    // ----- binary operator  ----- WhileBad.ssc(12,13)
    stack0i := local3791 + stack0i;
    // ----- copy  ----- WhileBad.ssc(12,13)
    m := stack0i;
    // ----- copy  ----- WhileBad.ssc(12,13)
    stack0i := local3791;
  ...
  block3332:
    // ----- copy  ----- WhileBad.ssc(14,9)
    return.value := m;
    // ----- branch
    goto block3349;

  block3281:
    // ----- nop  ----- WhileBad.ssc(12,13)
    goto block3298;
  ...
  block3570:
    ...
    // ----- copy  ----- WhileBad.ssc(15,5)
    stack0i := return.value;
    // ----- return  ----- WhileBad.ssc(15,5)
    $result := stack0i;
    return;

  block3060$LoopPreheader:
    $Heap$block3060$LoopPreheader := $Heap;
    goto block3060;
