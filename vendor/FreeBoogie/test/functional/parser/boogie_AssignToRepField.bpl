...
// Command Line Options: -nologo /prover:blank /print:boogie_tmp.@TIME@.bpl /proverLog:boogie_tmp.@TIME@.simplify /proverMatchDepth:5 AssignToRepField.dll
...
const Abc.f: <ref>name;

const AssignToRepField.f: <ref>name;

const AssignToRepField.a: <ref>name;

const Abc.g: <ref>name;
...
{
  var stack50000o: ref, stack0o: ref, t: ref where $Is(t, T), stack0i: int, x: ref where $Is(x, ValueArray(System.Int32, 1));

  entry:
    assume $IsNotNull(this, AssignToRepField);
    ...
    assume $Heap[this, AssignToRepField.f] == null;
    assume $Heap[this, AssignToRepField.a] == null;
    goto block1258;
  ...
  block1275:
    // ----- call  ----- AssignToRepField.ssc(8,3)
    assert this != null;
    call System.Object..ctor(this);
    // ----- new object  ----- AssignToRepField.ssc(9,5)
    havoc stack50000o;
    ...
    // ----- call  ----- AssignToRepField.ssc(9,5)
    assert stack50000o != null;
    call T..ctor(stack50000o);
    // ----- copy  ----- AssignToRepField.ssc(9,5)
    stack0o := stack50000o;
    // ----- copy  ----- AssignToRepField.ssc(9,5)
    t := stack0o;
    // ----- load constant 25  ----- AssignToRepField.ssc(10,5)
    stack0i := 25;
    // ----- new array  ----- AssignToRepField.ssc(10,5)
    assert 0 <= stack0i;
    havoc x;
    assume $Heap[x, $allocated] == false && $Length(x) == stack0i;
    assume $IsNotNull(x, ValueArray(System.Int32, 1));
    assume $Heap[x, $ownerRef] == x && $Heap[x, $ownerFrame] == $PeerGroupPlaceholder;
    assume $Heap[x, $inv] == ValueArray(System.Int32, 1) && $Heap[x, $localinv] == ValueArray(System.Int32, 1) && ($Heap[x, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[x, $ownerRef], $inv] <: $Heap[x, $ownerFrame]) || $Heap[$Heap[x, $ownerRef], $localinv] == $BaseClass($Heap[x, $ownerFrame]));
    assume (forall $i: int :: cast(ValueArrayGet($Heap[x, $elements], $i),int) == 0);
    $Heap[x, $allocated] := true;
    assume IsHeap($Heap);
    // ----- call  ----- AssignToRepField.ssc(11,5)
    call AssignToRepField.Sqrt();
    // ----- store field  ----- AssignToRepField.ssc(12,5)
    assert this != null;
    assert !($Heap[this, $inv] <: AssignToRepField) || $Heap[this, $localinv] == System.Object;
    assert t == null || $Heap[t, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[t, $ownerRef] == this && $Heap[t, $ownerFrame] == AssignToRepField);
    $Heap[this, AssignToRepField.f] := t;
    call $UpdateOwnersForRep(this, AssignToRepField, t);
    assume IsHeap($Heap);
    // ----- store field  ----- AssignToRepField.ssc(13,5)
    assert this != null;
    assert !($Heap[this, $inv] <: AssignToRepField) || $Heap[this, $localinv] == System.Object;
    assert x == null || $Heap[x, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[x, $ownerRef] == this && $Heap[x, $ownerFrame] == AssignToRepField);
    $Heap[this, AssignToRepField.a] := x;
    call $UpdateOwnersForRep(this, AssignToRepField, x);
    assume IsHeap($Heap);
    // ----- return  ----- AssignToRepField.ssc(14,3)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == AssignToRepField ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := AssignToRepField;
    assume IsHeap($Heap);
    return;
...
{
  var b: bool where true, stack0o: ref;
  ...
  block1598:
    // ----- call  ----- AssignToRepField.ssc(17,3)
    assert this != null;
    call System.Object..ctor(this);
    stack0o := null;
    // ----- store field  ----- AssignToRepField.ssc(18,5)
    assert this != null;
    assert !($Heap[this, $inv] <: AssignToRepField) || $Heap[this, $localinv] == System.Object;
    assert stack0o == null || $Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[stack0o, $ownerRef] == this && $Heap[stack0o, $ownerFrame] == AssignToRepField);
    $Heap[this, AssignToRepField.f] := stack0o;
    call $UpdateOwnersForRep(this, AssignToRepField, stack0o);
    assume IsHeap($Heap);
    stack0o := null;
    // ----- store field  ----- AssignToRepField.ssc(19,5)
    assert this != null;
    assert !($Heap[this, $inv] <: AssignToRepField) || $Heap[this, $localinv] == System.Object;
    assert stack0o == null || $Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[stack0o, $ownerRef] == this && $Heap[stack0o, $ownerFrame] == AssignToRepField);
    $Heap[this, AssignToRepField.a] := stack0o;
    call $UpdateOwnersForRep(this, AssignToRepField, stack0o);
    assume IsHeap($Heap);
    // ----- return  ----- AssignToRepField.ssc(20,3)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == AssignToRepField ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := AssignToRepField;
...
implementation AssignToRepField..ctor$System.Int32.array(this: ref, x$in: ref)
{
  ...
  block1853:
    // ----- call  ----- AssignToRepField.ssc(23,3)
    assert this != null;
    call System.Object..ctor(this);
    // ----- store field  ----- AssignToRepField.ssc(24,5)
    assert this != null;
    assert !($Heap[this, $inv] <: AssignToRepField) || $Heap[this, $localinv] == System.Object;
    assert x == null || $Heap[x, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[x, $ownerRef] == this && $Heap[x, $ownerFrame] == AssignToRepField);
    $Heap[this, AssignToRepField.a] := x;
    call $UpdateOwnersForRep(this, AssignToRepField, x);
    assume IsHeap($Heap);
    // ----- return  ----- AssignToRepField.ssc(25,3)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == AssignToRepField ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := AssignToRepField;
...
implementation AssignToRepField..ctor$T(this: ref, t$in: ref)
{
  ...
  block2057:
    // ----- call  ----- AssignToRepField.ssc(28,3)
    assert this != null;
    call System.Object..ctor(this);
    // ----- store field  ----- AssignToRepField.ssc(29,5)
    assert this != null;
    assert !($Heap[this, $inv] <: AssignToRepField) || $Heap[this, $localinv] == System.Object;
    assert t == null || $Heap[t, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[t, $ownerRef] == this && $Heap[t, $ownerFrame] == AssignToRepField);
    $Heap[this, AssignToRepField.f] := t;
    call $UpdateOwnersForRep(this, AssignToRepField, t);
    assume IsHeap($Heap);
    // ----- return  ----- AssignToRepField.ssc(30,3)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == AssignToRepField ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := AssignToRepField;
...
implementation AssignToRepField.M(this: ref)
{
  ...
  block2261:
    stack0o := null;
    // ----- store field  ----- AssignToRepField.ssc(33,5)
    assert this != null;
    assert !($Heap[this, $inv] <: AssignToRepField) || $Heap[this, $localinv] == System.Object;
    assert stack0o == null || $Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[stack0o, $ownerRef] == this && $Heap[stack0o, $ownerFrame] == AssignToRepField);
    $Heap[this, AssignToRepField.f] := stack0o;
    call $UpdateOwnersForRep(this, AssignToRepField, stack0o);
    assume IsHeap($Heap);
    // ----- return  ----- AssignToRepField.ssc(34,3)
    return;
...
{
  var local0: ref where $Is(local0, AssignToRepField), stack0o: ref, stack1s: struct, stack1o: ref, temp0: exposeVersionType;
  ...
  block2856:
    // ----- copy  ----- AssignToRepField.ssc(37,13)
    local0 := this;
    // ----- copy  ----- AssignToRepField.ssc(37,13)
    stack0o := local0;
    // ----- load token  ----- AssignToRepField.ssc(37,13)
    havoc stack1s;
    assume $IsTokenForType(stack1s, AssignToRepField);
    // ----- statically resolved GetTypeFromHandle call  ----- AssignToRepField.ssc(37,13)
    stack1o := TypeObject(AssignToRepField);
    // ----- local unpack  ----- AssignToRepField.ssc(37,13)
    assert stack0o != null;
    assert ($Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[stack0o, $ownerRef], $inv] <: $Heap[stack0o, $ownerFrame]) || $Heap[$Heap[stack0o, $ownerRef], $localinv] == $BaseClass($Heap[stack0o, $ownerFrame])) && $Heap[stack0o, $inv] <: AssignToRepField && $Heap[stack0o, $localinv] == $typeof(stack0o);
  ...
  block2873:
    stack0o := null;
    // ----- store field  ----- AssignToRepField.ssc(38,7)
    assert this != null;
    assert !($Heap[this, $inv] <: AssignToRepField) || $Heap[this, $localinv] == System.Object;
    assert stack0o == null || $Heap[stack0o, $ownerFrame] == $PeerGroupPlaceholder || ($Heap[stack0o, $ownerRef] == this && $Heap[stack0o, $ownerFrame] == AssignToRepField);
    $Heap[this, AssignToRepField.f] := stack0o;
  ...
  block2924:
    // ----- copy  ----- AssignToRepField.ssc(39,5)
    stack0o := local0;
    // ----- load token  ----- AssignToRepField.ssc(39,5)
    havoc stack1s;
    assume $IsTokenForType(stack1s, AssignToRepField);
    // ----- statically resolved GetTypeFromHandle call  ----- AssignToRepField.ssc(39,5)
    stack1o := TypeObject(AssignToRepField);
    // ----- local pack  ----- AssignToRepField.ssc(39,5)
    assert stack0o != null;
    assert $Heap[stack0o, $localinv] == System.Object;
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == stack0o && $Heap[$p, $ownerFrame] == AssignToRepField ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
  ...
  block2890:
    // ----- return  ----- AssignToRepField.ssc(40,3)
    return;
...
implementation AssignToRepField.Sqrt()
{
  ...
  block3332:
    // ----- return  ----- AssignToRepField.ssc(42,31)
    return;
...
implementation T..ctor(this: ref)
{
  ...
  block3485:
    // ----- call  ----- AssignToRepField.ssc(45,14)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return
    assert this != null;
...
{
  var b: bool where true, stack50000o: ref, stack0o: ref, t: ref where $Is(t, T), temp0: exposeVersionType, temp1: exposeVersionType, stack0b: bool, temp2: exposeVersionType, temp3: exposeVersionType;

  entry:
    assume $IsNotNull(this, Abc);
    assume $Heap[this, $allocated] == true;
    assume ($Heap[this, $ownerFrame] == $PeerGroupPlaceholder || !($Heap[$Heap[this, $ownerRef], $inv] <: $Heap[this, $ownerFrame]) || $Heap[$Heap[this, $ownerRef], $localinv] == $BaseClass($Heap[this, $ownerFrame])) && $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    b := b$in;
    assume $Heap[this, Abc.g] == null;
    goto block3978;
  ...
  block3995:
    // ----- new object  ----- AssignToRepField.ssc(52,5)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == T;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- AssignToRepField.ssc(52,5)
    assert stack50000o != null;
    call T..ctor(stack50000o);
    // ----- copy  ----- AssignToRepField.ssc(52,5)
    stack0o := stack50000o;
    // ----- copy  ----- AssignToRepField.ssc(52,5)
    t := stack0o;
    // ----- copy  ----- AssignToRepField.ssc(53,5)
    stack0o := t;
    assert stack0o != null;
    stack0o := stack0o;
    // ----- store field  ----- AssignToRepField.ssc(53,5)
    assert this != null;
    havoc temp0;
    $Heap[this, $exposeVersion] := temp0;
    $Heap[this, Abc.f] := stack0o;
    assume IsHeap($Heap);
    // ----- store field  ----- AssignToRepField.ssc(54,5)
    assert this != null;
    havoc temp1;
    $Heap[this, $exposeVersion] := temp1;
    $Heap[this, Abc.g] := t;
    assume IsHeap($Heap);
    // ----- copy  ----- AssignToRepField.ssc(55,5)
    stack0b := b;
    // ----- unary operator  ----- AssignToRepField.ssc(55,5)
    // ----- branch  ----- AssignToRepField.ssc(55,5)
    goto true3995to4029, false3995to4012;
  ...
  block4029:
    // ----- store field  ----- AssignToRepField.ssc(58,5)
    assert this != null;
    havoc temp2;
    $Heap[this, $exposeVersion] := temp2;
    $Heap[this, Abc.g] := t;
    assume IsHeap($Heap);
    // ----- copy  ----- AssignToRepField.ssc(59,5)
    stack0o := t;
    assert stack0o != null;
    stack0o := stack0o;
    // ----- store field  ----- AssignToRepField.ssc(59,5)
    assert this != null;
    havoc temp3;
    $Heap[this, $exposeVersion] := temp3;
    $Heap[this, Abc.f] := stack0o;
    assume IsHeap($Heap);
    // ----- call  ----- AssignToRepField.ssc(60,5)
    assert this != null;
    call System.Object..ctor(this);
    // ----- return  ----- AssignToRepField.ssc(61,3)
    assert this != null;
    assert $Heap[this, $inv] == System.Object && $Heap[this, $localinv] == $typeof(this);
    assert (forall $p: ref :: $p != null && $Heap[$p, $allocated] == true && $Heap[$p, $ownerRef] == this && $Heap[$p, $ownerFrame] == Abc ==> $Heap[$p, $inv] == $typeof($p) && $Heap[$p, $localinv] == $typeof($p));
    $Heap[this, $inv] := Abc;
    assume IsHeap($Heap);
    return;

  block4012:
    // ----- new object  ----- AssignToRepField.ssc(56,7)
    havoc stack50000o;
    assume $Heap[stack50000o, $allocated] == false && stack50000o != null && $typeof(stack50000o) == T;
    assume $Heap[stack50000o, $ownerRef] == stack50000o && $Heap[stack50000o, $ownerFrame] == $PeerGroupPlaceholder;
    $Heap[stack50000o, $allocated] := true;
    // ----- call  ----- AssignToRepField.ssc(56,7)
    assert stack50000o != null;
    call T..ctor(stack50000o);
    // ----- copy  ----- AssignToRepField.ssc(56,7)
    stack0o := stack50000o;
    // ----- copy  ----- AssignToRepField.ssc(56,7)
    t := stack0o;
    goto block4029;
