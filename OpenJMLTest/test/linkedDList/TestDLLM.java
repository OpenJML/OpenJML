public class TestDLLM {
    ...
    static public class DLL<T> {
        static public class Link<T> {
            ...
            //@ public invariant links().length == values().length;
            //@ public invariant next != null ==> links().length == 1 + next.links().length;
            ...
            //@ ensures links().length == 1;
            //@ ensures values().length == 1;
            //@ pure
            public Link(T v) { 
                value = v;
            }
            ...
            private void insert(int n, T v) {
                ...
                //@ assume links().length == values().length;
                if (n == 0) {
                    ...
                    //@ assert link.links().length == this.links().length;
                    link.previous = this;
                    this.next = link;
                    //@ halt;
                } else {
