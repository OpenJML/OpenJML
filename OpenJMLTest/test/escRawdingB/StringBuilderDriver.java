...
//    }
    ...
    private static void testDebug(String s, StringBuilder sb) {
    	//@ assume s.length() < 1000;
        //StringBuilder sb = new StringBuilder();
        char[] chars = {'t', 'e', 's', 't'};
        int x = sb.length();
        sb.insert(0, chars);
...
//        //@ assert x == 11;
        sb.insert(0, chars);
//        //@ assert sb.stringLength == x + chars.length;
...
//            //@ reachable
//        	int z = sb.length() + 1;
//            //@ reachable                  // FIXME - this line not reachable when line 658 is uncommented
//        	//@ assert z == 1 + sb.stringLength;
//            //@ reachable
//            sb.insert(z, chars, 0, 0);
//            //@ unreachable
//        } catch (StringIndexOutOfBoundsException ex) {
//            //@ reachable
//  //          System.out.println("insert() with offset too large correctly threw an exception");
