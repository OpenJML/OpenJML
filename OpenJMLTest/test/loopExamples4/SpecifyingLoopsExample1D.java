public class SpecifyingLoopsExample1D {
...
//@ requires \nonnullelements(argv);
//@ requires \forall int i; 0 <= i < argv.length; \invariant_for(argv[i]);
    public static void main(String [] argv) {
        final var inst = new SpecifyingLoopsExample1D();
        String tests[] = argv; //{"", "jml", "ramp", "purge", "jumpstart" };
        int failures = 0;
