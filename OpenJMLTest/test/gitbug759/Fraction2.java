public class Fraction2 {
    ...
    /*@ public invariant 0 < denominator < Integer.MAX_VALUE;
      @ public invariant -Integer.MAX_VALUE < numerator < Integer.MAX_VALUE;
      @ public invariant numerator == 0 ==> denominator == 1;
      @ //public invariant GCD.gcd(GCD.abs(numerator), denominator) == 1;
    */

    /*@ requires -Integer.MAX_VALUE < numerator < Integer.MAX_VALUE;
      @ requires 0 <denominator < Integer.MAX_VALUE;
      @ old int gcd = GCD.gcd(GCD.abs(numerator), denominator);
 ...
 */
    ...
    /*@ requires f != null;
      ...
      @ old int gcd = GCD.gcd(GCD.abs((int)new_numerator), (int)new_denominator);
...
// @ assert GCD.gcd(result.numerator,result.denominator) == 1;
    ...
    /*@ requires -Integer.MAX_VALUE < numerator < Integer.MAX_VALUE;
      @ requires 0 < denominator < Integer.MAX_VALUE;
      @ requires GCD.gcd(GCD.abs(numerator),denominator)==1;
    ...
    public Fraction2 Inverse(){
        //@ ghost int n = GCD.abs(numerator);
        //@ assume GCD.lemma2a(n,denominator);
 ...
 // @ assert GCD.gcd(result.numerator,result.denominator) == 1;
    ...
    public Fraction2 Reciprocal(){
        ...
        //@ assert GCD.gcd(numerator,denominator) == 1;
        //@ assume GCD.lemma2c(numerator, denominator);
        //@ assert GCD.gcd(n,d) == 1;
