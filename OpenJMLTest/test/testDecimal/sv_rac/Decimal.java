...
@org.jmlspecs.annotation.CodeSafeMath public class Decimal extends Object{
    ...
    public static final short DECIMAL_OVERFLOW   = (short)0x9F15; // FIXME - adding m() here causes a translation error; Without the m(), the compiler does the constant folding and OpenJML never sees the out of range cast
