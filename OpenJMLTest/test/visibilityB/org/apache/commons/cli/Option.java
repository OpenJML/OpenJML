...
public class Option implements Cloneable, Serializable
{
    ...
    private /*@ spec_public @*/ final String opt;

    /** the long representation of the option */
    private /*@ spec_public @*/  String longOpt;

    /** the name of the argument for this option */
    private /*@ spec_public @*/  String argName;

    /** description of the option */
    private /*@ spec_public @*/ String description;

    /** specifies whether this option is required to be present */
    private /*@ spec_public @*/ boolean required;

    /** specifies whether the argument value of this Option is optional */
    private /*@ spec_public @*/ boolean optionalArg;

    /** the number of argument values this option can have */
    private /*@ spec_public @*/ int numberOfArgs = UNINITIALIZED;

    /** the type of this Option */
    private /*@ spec_public @*/ Class<?> type = String.class;

    /** the list of argument values **/
    private /*@ spec_public @*/ List<String> values = new ArrayList<String>();

    /** the character that is the value separator */
    private /*@ spec_public @*/ char valuesep;
     ...
     */
    public Option(String opt, String description2) throws IllegalArgumentException
    {
        this(opt, null, false, description2);
    }
     ...
     * Option characters in <code>opt</code>.
     */
    public Option(String opt, boolean hasArg, String description2) throws IllegalArgumentException
    {
        this(opt, null, hasArg, description2);
    }
     ...
     * Option characters in <code>opt</code>.
     */
    public Option(String opt, String longOpt, boolean hasArg, String description2)
