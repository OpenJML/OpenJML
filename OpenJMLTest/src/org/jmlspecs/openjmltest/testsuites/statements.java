...
public class statements extends TCBase {
    ...
    @Test public void testFor() {
        helpTCText("A.java"," class A { void m() { \n //@ loop_invariant i>=0; decreasing -i; \n for (int i=0; i<10; i++) {}  \n}}"
                );
    }
    ...
    @Test public void testForWithModifies2a() {
        helpTCText("A.java"," class A { int j; void m() { \n //@ loop_modifies j; \n for (int i=0; i<10; i++) {}  \n}}"
                );
    }
    ...
    @Test public void testForEach() {
        helpTCText("A.java"," class A { void m(java.util.List list) { \n //@ loop_invariant o != null; decreasing 6; \n for (Object o: list) {}  \n}}"
                );
    }

    @Test public void testWhile() {
        helpTCText("A.java"," class A { void m() { int i = 0; \n //@ loop_invariant i>=0; decreasing i; \n while (i>=0) {}  \n}}"
                );
    }
    ...
    @Test public void testLoop2() {
        helpTCText("A.java"," class A { boolean j; void m() { \n //@ loop_invariant j;\n  \n}}"
    ...
    @Test public void testAssert() {
        helpTCText("A.java"," class A { Object o; void m() { \n /*@ assume true; assert o==o;*/\n  \n}}"
                );
    }
    ...
    @Test public void testUnreachable() {
        helpTCText("A.java"," class A { Object o; void m() { int i; \n //@ unreachable; \n i = 0; \n}}"
                );
    }
    ...
    @Test public void testSet1() {
        expectedExit = 1;
        helpTCText("A.java"," class A { void m() { int i; \n //@ ghost int j; set j = 1 \n i = 0; \n}}"
    ...
    @Test public void testSet3() {
        helpTCText("A.java"," class A { boolean o; void m() { int i; \n //@ ghost boolean j; set j =  (o <==> \\old(o)); \n i = 0; \n}}"
                );
    }
    ...
    @Test public void testSynchronized3() {
        helpTCText("A.java"," class A { Object o; synchronized void m() { int i; \n  { i = 0; } \n}}"
                );
    }
    ...
    @Test public void testEmptyBlock() { // Bug 3316853
        helpTCText("A.java"," public class A { void m() { { } }  { { } } static { { } }  }"
                );
    }
