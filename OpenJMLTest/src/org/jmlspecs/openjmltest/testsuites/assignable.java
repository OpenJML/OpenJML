...
public class assignable extends TCBase {
    ...
    public void testAssignableField() {
        helpTCText(null, " class A { int k; boolean b; Object o; \n//@ assignable A.k;\n void m(){} }"
    ...
    public void testAssignableField2() {
        helpTCText(null, " class A { class B { int p; } int k; boolean b; Object o;  B bb; \n//@ assignable bb.p;\n void m(){} }");
    }
    ...
    public void testAssignableArray4() {
        helpTCText("A.java","public class A { int[] k; boolean b; Object[] o; \n//@ assignable k[true],k[true .. false], k[false ..], k[false .. *];\n void m() {} }"
    ...
    public void testAssignableArray5() {
        helpTCText("A.java","public class A { int[] k; Object b; Object[] o; \n//@ assignable k[b];\n void m(boolean b) {} }"
                ,"/A.java:2: error: Expected an integral type as an index, not boolean, for indexable type int[]",18
                );
    }
    ...
    public void testAssignableSuper() {
        helpTCText("A.java","public class A extends B { int[] k; Object b; Object[] o; \n//@ assignable super.kk, super.*;\n void m(boolean b) {} }  class B{ int kk; }"
                );
    }
    ...
    public void testAssignableArray9() {
        helpTCText("A.java","public class A { B[] o; \n//@ assignable o[*].kk;\n void m(boolean b) {} }  class B{ int kk; }"
                );
    }
