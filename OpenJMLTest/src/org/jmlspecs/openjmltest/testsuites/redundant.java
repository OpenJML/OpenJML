...
public class redundant extends TCBase {
    ...
    public void testRedundant() {
        helpTCText("A.java","public class A { /*@ ensures true; implies_that  ensures false; for_example ensures true; */\n void m(){} }");
    }

    /** implies_that and for_example with behavior, example */
    @Test
    public void testRedundant1() {
        helpTCText("A.java","public class A { /*@ ensures true; implies_that behavior ensures false; for_example example ensures true; */\n void m(){} }");
    }

    /** implies_that and for_example with normal_behavior, normal_example */
    @Test
    public void testRedundant1a() {
        helpTCText("A.java","public class A { /*@ ensures true; implies_that normal_behavior ensures false; for_example normal_example ensures true; */\n void m(){} }");
    }

    /** implies_that and for_example with exceptional_behavior, exceptional_example */
    @Test
    public void testRedundant1b() {
        helpTCText("A.java","public class A { /*@ ensures true; implies_that exceptional_behavior signals_only Exception; for_example exceptional_example requires true; */\n void m(){} }");
    }
    ...
    public void testRedundant2() {
        expectedExit = 0;
        helpTCText("A.java","public class A { /*@ ensures true; implies_that example ensures false; for_example behavior ensures true; */\n void m(){} }"
    ...
    public void testRedundant2a() {
        expectedExit = 0;
        helpTCText("A.java","public class A { /*@ ensures true; implies_that normal_example ensures false; for_example normal_behavior ensures true; */\n void m(){} }"
    ...
    public void testRedundant2b() {
        expectedExit = 0;
        helpTCText("A.java","public class A { /*@ ensures true; implies_that exceptional_example requires false; for_example exceptional_behavior requires true; */\n void m(){} }"
    ...
    public void testRedundant3() {
        helpTCText("A.java","public class A { /*@ ensures true; implies_that  ensures false; also requires true; for_example ensures true; also normal_example ensures false; */\n void m(){} }");
    }

    /** visibility */
    @Test
    public void testRedundant4() {
        helpTCText("A.java","public class A { /*@ ensures true; implies_that public behavior ensures false; */\n void m(){} }");
    }
    
    /** visibility */
    @Test
    public void testRedundant4b() {
        helpTCText("A.java","public class A { /*@ ensures true; for_example public normal_example ensures false; */\n void m(){} }");
    }
