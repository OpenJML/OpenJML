...
public class modifiers extends TCBase {
    ...
    @Test public void testClassMods9() {
        helpTCText("t/A.java",
                """
                package t; import org.jmlspecs.annotation.*;
   ...
   @Test public void testOnlyModelClass7a() {
    ...
    @Test public void testCUMods() {
        helpTCText("t/A.java",
                """
                @Pure package t; import org.jmlspecs.annotation.*;
                 public /*@ pure */ @Pure class A{}
                """
    ...
    @Test public void testCUMods3() {
        helpTCText("t/A.java",
                """
                package t; /*@ pure */ import org.jmlspecs.annotation.*;
                 public /*@ pure */ class A{}
                """
...
//                ,"/t/A.java:2: error: A declaration may not be both model and final",84
    ...
    @Test public void testQuantified() {
        helpTCText("A.java",
                """
                import org.jmlspecs.annotation.*; public class A{ A(int i) {}
    ...
    @Test public void testInvariant2() {
        ...
        helpTCText("A.java",
                """
                import org.jmlspecs.annotation.*; public class A{ int m() { return 0; }
    ...
    @Test public void testInvariant2a() {
        ...
        helpTCText("A.java",
                """
                import org.jmlspecs.annotation.*; public class A{ A(int i){} int m() { return 0; }
    ...
    @Test public void testAxiom() {
        helpTCText("A.java",
                ...
                import org.jmlspecs.annotation.*; public class A{ A(int i) {}
                  //@ axiom true;
                  //@ public axiom true; // ERROR
                  //@ pure axiom true; // ERROR
                  //@ private axiom true; // ERROR
                  //@ public private axiom true; // ERROR
                  //@ non_null axiom true; // ERROR
                  //@ spec_public axiom true; // ERROR
                  void m() {} }
                """
    ...
    @Test public void testAnnotatedCast2() {
        helpTCText("A.java",
                """
                import org.jmlspecs.annotation.*; class A { void m() {
