...
public class esc2 extends EscBase {
    ...
    public esc2(String options, String solver) {
    ...
    public void testShowStatementErrors() {
        ...
        helpTCX("tt.TestJava",
                "package tt; \n" 
                        ...
                        ,"/tt/TestJava.java:13: error: Incorrectly formed or terminated show statement near here -- perhaps a missing semicolon",19
                        );
    }
