...
//                +"    //@ assert b;\n"
    ...
    public void testBindLambdaA() {
        ...
        helpTCX("tt.TestJava","package tt; \n"
                ...
                +"  }\n"
                +"  //@ inline \n"
                +"  final public boolean m(Object aaa, java.util.function.@org.jmlspecs.annotation.NonNull Function<Object,Object> f) {\n"
                +"       Object a = aaa; return a == f.apply(null);"
                +"  }\n"
                +"  }\n"
                );
    ...
    public void testBindLambda2() {
        ...
        helpTCX("tt.TestJava","package tt; \n"
                ...
                +"  }\n"
                +"  //@ inline \n"
                +"  final public int m(int aa, int b, java.util.function.@org.jmlspecs.annotation.NonNull Function<Integer,Integer> f) {\n"
