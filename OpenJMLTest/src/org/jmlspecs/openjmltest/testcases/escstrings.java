...
//    }
    ...
    public void testStringCharAt1() {
        helpTCX("tt.TestJava","package tt; \n"
                ...
                ,"$SPECS/specs/java/lang/String.jml:334: warning: Associated declaration",30
                ,"$SPECS/specs/java/lang/CharSequence.jml:79: warning: Precondition conjunct is false: 0 <= index < charArray.length",34
                );
    }
