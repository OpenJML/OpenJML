...
public class escgeneric extends EscBase {
    ...
    public void testTypeOf() {
    	main.addOptions("-checkFeasibility=basic");  // Part of test
        helpTCX("tt.TestJava","package tt; \n"
                +"public class TestJava { \n"
    ...
    public void testTypeParameter2() {
        ...
        helpTCX("tt.TestJava","package tt; \n"
                ...
                +"  public void ma(/*@ non_null*/TestG<Integer>.@org.jmlspecs.annotation.NonNull TestH i, Integer j) {\n"
                +"    i.mm(j);\n"
                +"  }\n"
                +"  public void mb(/*@ non_null*/TestG<Object>.@org.jmlspecs.annotation.NonNull TestH i, Object j) {\n"
                +"    i.mm(j);\n"
                +"  }\n"
                +"  public void mc(/*@ non_null*/TestG<String>.@org.jmlspecs.annotation.NonNull TestH i, String j) {\n"
                +"    i.mm(j);\n"
                +"  }\n"
                +"}\n"
                +"class TestG<E> {\n"
