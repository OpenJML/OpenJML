...
// TODO - are these tests duplicated elsewhere?
    ...
    @Test public void testTryResources() {
        helpTCX("tt.TestJava","package tt; \n"
                ...
                +"       //@ assignable TestJava.flag, this.content;\n"
                +"       //@ ensures TestJava.flag == 1;\n"
                +"       public void close() { TestJava.flag = 1; /*@ set _isAutoCloseable = false; */  }\n"
                +"    }\n"
    ...
    @Test public void testTryResources2() {
        helpTCX("tt.TestJava","package tt; \n"
                ...
                +"       public void close() { TestJava.flag = 2;  /*@ set _isAutoCloseable = false; */ }\n"
                +"    }\n"
    ...
    @Test public void testTryResources2b() {
        ...
        helpTCX("tt.TestJava","package tt; \n"
                ...
                +"    static public int flag = 0;\n"
                +"    public static class RR implements AutoCloseable {\n"
                +"       /*@ public normal_behavior ensures true; */ public RR() { /*@ set _isAutoCloseable = false; */ }\n"
                +"       //@ public invariant !_isAutoCloseable;\n"
                ...
                +"    }\n"
                +"    public static class RR2 implements AutoCloseable {\n"
                +"       /*@ public normal_behavior ensures true; */ public RR2() { /*@ set _isAutoCloseable = false; */ }\n"
                +"       //@ public invariant !_isAutoCloseable;\n"
                +"       //@ public exceptional_behavior\n"
                +"       //@ assignable TestJava.flag, this.content;\n"
                +"       //@ signals_only EE2;\n"
                ...
                +"  }\n"
                +"}"
                ,"/tt/TestJava.java:36: warning: There is no feasible path to program point before explicit assert statement in method tt.TestJava.mmm()",11
                );
    }
