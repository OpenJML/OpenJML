...
//    final int SecondaryError = 64;
  ...
  public JmlEclipseProblem(IFile ifile, String message, int id, int severity,
    ...
    super(ifile == null ? null : ifile.getFullPath().toString().toCharArray(),
            ...
            startPosition, endPosition, line, 0);  // FIXME - last arg is column
   ...
   */
  // FIXME - the arguments to the IProblem get lost.
  ...
  /**
   * Constructs and reports a JmlEclipseProblem 
   ...
   */
//  private static void report(IProblemRequestor req, JavaScanner scanner, 
...
//    if (lineEnd < lineStart) lineEnd = scanner.eofPosition; // Fixes an apparent bug
//    req.acceptProblem(new JmlEclipseProblem(scanner.ifile, message, id, severity, 
//            startPosition, endPosition, line, scanner.getSourceString(),
//            lineStart, lineEnd));
//  }
