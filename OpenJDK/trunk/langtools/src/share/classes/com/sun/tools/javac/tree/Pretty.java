...
public class Pretty extends JCTree.Visitor {
    ...
    public void print(Object s) throws IOException {
        if (s == null) s = "<<<ERROR>>>"; // DRC - This is defensive. s should not be null, but in case it is
                                    // making this assignment avoids aborting the whole pretty-printing
                                    // and makes it easier to debug the problem.
...
//where
    ...
    public void visitLiteral(JCLiteral tree) {
        try {
            switch (tree.typetag) {
                case INT:
                case SHORT: // DRC - added SHORT and BYTE
                case BYTE:
                ...
                case CHAR:
                    ...
                    break;
                case BOOLEAN:
                    if (tree.value instanceof Number) print(((Number)tree.value).intValue() == 1 ? "true" : "false"); // DRC - original had just one line: print(((Number)tree.value).intValue() == 1 ? "true" : "false");
