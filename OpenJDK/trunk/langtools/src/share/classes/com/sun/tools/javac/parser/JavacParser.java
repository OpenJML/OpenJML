...
public class JavacParser implements Parser {
    ...
    protected JCErroneous syntaxError(int pos, List<JCTree> errs, String key, TokenKind... args) { // DRC - changed to protected
        setErrorEndPos(pos);
     ...
     */
    protected void reportSyntaxError(int pos, String key, Object... args) { // DRC - changed from private to protected (or just added?)
    ...
    protected JCExpression term3() {
        ...
        case UNDERSCORE: case IDENTIFIER: case ASSERT: case ENUM:
            ...
            if ((mode & EXPR) != 0 && peekToken(ARROW)) {
            	...
            	t = toP(F.at(token.pos).Ident(ident())); // FIXME -  - is the position OK
            	t = primarySuffix(t,typeArgs); // DRC - extracted into method
            }
...
//        return toP(t);
     ...
     *  @param dc       The documentation comment for the variable declarations, or null.
     */
    public JCVariableDecl variableDeclaratorRest(int pos, JCModifiers mods, JCExpression type, Name name,
    ...
    public JCTree.JCCompilationUnit parseCompilationUnit() {
        ...
        //if (token.kind == MONKEYS_AT) // OPENJML - removed
            mods = modifiersOpt();
     ...
     */
    JCTree importDeclaration(JCModifiers mods) {  // OPENJML -- added mods argument?
        int pos = token.pos;
        nextToken();
