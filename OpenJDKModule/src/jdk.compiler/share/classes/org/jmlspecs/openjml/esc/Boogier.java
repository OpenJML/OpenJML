...
//    }
    ...
    public void visitApply(JCMethodInvocation that) { 
        ...
        if (that.meth instanceof JCIdent) {
            ...
            utils.warning("esc.not.implemented","BoogieBlocker.visitApply for " + that.meth.getClass());
            msym = null;
            obj = null;
        ...
        for (JmlTypeClause c: typeSpecs.clauses) {  // FIXME - decls?
            ...
            if (c instanceof JmlTypeClauseDecl) {
                ...
                if (token == invariantClause) {
                    ...
                    utils.warning("esc.not.implemented","JmlEsc does not yet implement (and ignores) " + token.name());
