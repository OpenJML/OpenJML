...
public class Pretty extends JCTree.Visitor {
    ...
    public String lineSep = System.getProperty("line.separator"); // OPENJML - package to public
    ...
    public static class UncheckedIOException extends Error { // OPENJML - private to public
        static final long serialVersionUID = -4032692679158424751L;
        public UncheckedIOException(IOException e) { // OPENJML - package to public
...
//where
    ...
    public void visitIf(JCIf tree) {
        try {
            print("if ");
            if (tree.cond != null && tree.cond.hasTag(PARENS)) { // OPENJML test for null added for robustness against bad trees
                printExpr(tree.cond);
            } else {
                print("(");
                printExpr(tree.cond);
