 ...
 *************************************************************************/
	...
	// OPENJML - next three debug statements
...
//        Assert.checkNonNull(c.modle, c.sourcefile.toString());
    ...
    //where
         ...
         */
        protected boolean classNameMatchesFileName(ClassSymbol c, // OPENJML - private to protected, removed static FIXME - why not static?
                                                        Env<AttrContext> env) {
