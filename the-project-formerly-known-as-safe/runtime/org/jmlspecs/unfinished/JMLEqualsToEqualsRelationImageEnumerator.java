...
/*@ nullable_by_default @*/ 
public class JMLEqualsToEqualsRelationImageEnumerator
    ...
    /*@ normal_behavior
      ...
      @    ensures owner == null;
      @*/
    JMLEqualsToEqualsRelationImageEnumerator(/*@ non_null @*/
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLEqualsToEqualsRelationImageEnumerator(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
             || !(oth instanceof JMLEqualsToEqualsRelationImageEnumerator)){
            return false;
        } else {
            JMLEqualsToEqualsRelationImageEnumerator js
                = (JMLEqualsToEqualsRelationImageEnumerator) oth;
        ...
        JMLValueSet abstractValue()
    {
        ...
        JMLEqualsToEqualsRelationImageEnumerator enum2
            = (JMLEqualsToEqualsRelationImageEnumerator) clone();
