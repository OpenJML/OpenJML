 ...
 *  JMLValueToEqualsRelation}, and as such as can be treated as a
 *  binary relation or a set valued function also.  See the
 *  documentation for {@link JMLValueToEqualsRelation} and for the
 ...
 * @see JMLValueToEqualsRelation#toFunction()
 */
//-@ immutable
public /*@ pure @*/
// FIXME: adapt this file to non-null-by-default and remove the following modifier.
/*@ nullable_by_default @*/ 
class JMLValueToEqualsMap extends JMLValueToEqualsRelation {
     ...
     * @see #JMLValueToEqualsMap(JMLValueEqualsPair)
     */
    /*@  public normal_behavior
      ...
      @*/
    public JMLValueToEqualsMap(/*@ non_null @*/ JMLType dv,
                                   /*@ non_null @*/ Object rv)
    {
        super(dv, rv);
    }
     ...
     * @see #singletonMap(JMLValueEqualsPair)
     * @see #JMLValueToEqualsMap(JMLType, Object)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
      ...
      @*/
    public JMLValueToEqualsMap(/*@ non_null @*/
     ...
     */
    public static final /*@ non_null @*/ JMLValueToEqualsMap EMPTY
        = new JMLValueToEqualsMap();
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLValueToEqualsMap(dv, rv));
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        ...
        singletonMap(/*@ non_null @*/ JMLType dv,
                     /*@ non_null @*/ Object rv)
    {
        return new JMLValueToEqualsMap(dv, rv);
    }
    ...
    /*@ public normal_behavior
      @    requires pair != null;
      @    ensures \result != null
      @         && \result.equals(new JMLValueToEqualsMap(pair));
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        JMLValueToEqualsMap
        singletonMap(/*@ non_null @*/ JMLValueEqualsPair pair)
    {
        return new JMLValueToEqualsMap(pair);
    }
     ...
     * @see JMLValueToEqualsRelation#isDefinedAt
     * @see JMLValueToEqualsRelation#elementImage
     * @see JMLValueToEqualsRelation#image
     */
    /*@  public normal_behavior
    ...
    /*@ also
      @   public normal_behavior
      @     ensures \result instanceof JMLValueToEqualsMap
      @          && ((JMLValueToEqualsMap)\result)
      @                .theRelation.equals(this.theRelation);
      @*/
    //@ pure
    public /*@ non_null @*/ Object clone() 
    {
        return new JMLValueToEqualsMap(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToEqualsMap extend(/*@ non_null @*/ JMLType dv,
                                       /*@ non_null @*/ Object rv) 
    {
        JMLValueToEqualsMap newMap = this.removeDomainElement(dv);
        newMap = newMap.disjointUnion(new JMLValueToEqualsMap(dv, rv));
        return newMap;
    } //@ nowarn Exception;

    /** Return a new map that is like this but has no association for the
     *  given domain element.
     * @see JMLValueToEqualsRelation#removeFromDomain
     */
    /*@  public normal_behavior
     ...
     * @see JMLValueToEqualsRelation#restrictDomainTo
     */
    /*@  public normal_behavior
      @    requires dom != null;
      @    ensures (\forall JMLValueEqualsPair pair; ; 
     ...
     * @see #restrictedTo
     * @see JMLValueToEqualsRelation#restrictRangeTo
     */
    /*@  public normal_behavior
      @    requires rng != null;
      @    ensures (\forall JMLValueEqualsPair pair; ;
     ...
     * @see #disjointUnion
     * @see JMLValueToEqualsRelation#union
     */
    /*@  public normal_behavior
      @    requires othMap != null;
      @    requires int_size()
    ...
    public /*@ non_null @*/ 
        JMLValueToEqualsMap
        extendUnion(/*@ non_null @*/ JMLValueToEqualsMap othMap) 
        throws IllegalStateException
    {
        JMLValueToEqualsMap newMap 
            = this.restrictedTo(this.domain_.difference(othMap.domain_));
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            return
                new JMLValueToEqualsMap(newMap.imagePairSet_
        ...
        throws IllegalStateException
    {
        ...
        JMLValueToEqualsRelation newRel;
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            newRel = new JMLValueToEqualsRelation(newMap.imagePairSet_
                                                      .union(othMap
                                                             .imagePairSet_),
                                                      newMap.domain_
                                                      .union(othMap.domain_),
    ...
    public /*@ non_null @*/ 
        JMLValueToEqualsMap 
        disjointUnion(/*@ non_null @*/ JMLValueToEqualsMap othMap) 
        throws JMLMapException, IllegalStateException
    {
        ...
        if (overlappingDom.isEmpty()) {
            if (this.size_ <= Integer.MAX_VALUE - othMap.size_) {
                return new JMLValueToEqualsMap(this.imagePairSet_
                                                   .union(othMap
                                                          .imagePairSet_),
                                                   this.domain_
                                                   .union(othMap.domain_),
