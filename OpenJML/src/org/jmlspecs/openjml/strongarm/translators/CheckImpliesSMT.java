...
public class CheckImpliesSMT extends MethodProverSMT {
    ...
    public CheckImpliesSMT(Context context){
        ...
        jmlesc.assertionAdder = new JmlAssertionAdder(context, true, false, false);
    }
    ...
    public JCExpression convertToImplication(JmlMethodDecl p, JmlMethodDecl q){
        ...
        //treeutils.makeAnd(pos, lhs, rhs)
        
        SMTTranslator smttrans = getTranslator(context, p.sym.toString()); 
        
        smttrans.convertDeclaration(p.cases);
...
//        return treeutils.makeBinary(0,  JCTree.Tag.AND, P, Q);
    ...
    public IProverResult prove(JmlMethodDecl methodDecl, String proverToUse, JmlMethodDecl p, JmlMethodDecl q) {
        ...
        try {
            ...
            try {
                ...
                JCExpression converted = null;//convertToImplication(p, q);
