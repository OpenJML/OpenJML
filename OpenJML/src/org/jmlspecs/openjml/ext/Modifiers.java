...
public class Modifiers extends JmlExtension {
    ...
    static public final ModifierKind FUNCTION = new IJmlClauseKind.ModifierKind("function", false);
    static public final ModifierKind HELPER = new IJmlClauseKind.ModifierKind("helper", true);
    static public final ModifierKind IMMUTABLE = new IJmlClauseKind.ModifierKind("immutable", false);
