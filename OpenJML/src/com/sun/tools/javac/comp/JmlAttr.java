...
//      and are subject to definite assignment checking.
    ...
    public void checkVarMods(JmlVariableDecl tree) {
        ...
        if (tree.sym !=null && tree.sym.owner.kind == Kinds.TYP) {  // Field declarations
        ...
        // null FieldSpecs
        if (tree.sym != null && tree.sym.owner.kind == Kinds.TYP) {
...
//        }
    ...
    public void visitJmlVariableDecl(JmlVariableDecl that) {
        ...
        if (that.type != null && !that.type.isPrimitive()) {
