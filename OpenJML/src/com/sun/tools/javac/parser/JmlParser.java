        ...
        if (S.token() == Token.CUSTOM) { // Note that declarations may start
            ...
            if (S.jmlToken() != JmlToken.ENDJMLCOMMENT) {
                ...
                if (jtoken == JmlToken.ASSUME || jtoken == JmlToken.ASSERT) {
                    ...
                    st = toP(jmlF.at(pos).JmlStatementSpec(specs)); // FIXME - test pos and endPos
                    needSemi = false;
...
//                    return st;
    ...
    public JmlConstraintMethodSig parseMethodName() {
    	...
    	if (S.token() == Token.NEW) {
            ...
            log.error(S.pos(), "jml.bad.construct", "constraint method");
            return null;
        }
    ...
    public JmlMethodClause getClause() {
        ...
        if (jt != null) switch (jt) {
            ...
            case CALLABLE:
                ...
                S.setJmlKeyword(true);
                accept(SEMI);
                e = toP(jmlF.at(S.pos()).Erroneous()); // FIXME - implement
            ...
            switch (jt) {
                ...
                case BSJAVAMATH:
                    ExpressionExtension ne = ExpressionExtension.find(S.pos(),
                            jt, context, this);
                    if (ne == null) {
                        log.error(S.pos(), "jml.no.such.extension", jt
                                .internedName());
