...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLEqualsSet
    implements JMLCollection
{

    //*********************** equational theory ***********************

    /*@ public invariant (\forall JMLEqualsSet s2; s2 != null;
      @                    (\forall Object e1, e2; ;
    ...
    /*@ public normal_behavior
      ...
      @
      @       ensures \result <==> !(new JMLEqualsSet()).has(e1);
      @     also
      @       ensures \result <==>
      ...
      @     also
      @       ensures \result <==>
      @           (new JMLEqualsSet()).remove(e1).equals(new JMLEqualsSet());
      @     also
      @       ensures \result <==>
      ...
      @    also
      @      ensures \result <==>
      @         (new JMLEqualsSet(e1)).equals(new JMLEqualsSet().insert(e1));
      @    also
      @      ensures \result <==>
      @         s.isProperSubset(s2)
      ...
      @
      @      ensures \result <==> (new JMLEqualsSet()).isEmpty();
      @ 
      @      ensures \result <==> !s.insert(e1).isEmpty();
      @
      @      ensures \result <==>
      @         (new JMLEqualsSet(null)).has(e2) == (e2 == null);
      @
      @      ensures \result <==>
      @         (e1 != null
      @          ==> new JMLEqualsSet(e1).has(e2)
      @              == (e1.equals(e2)));
      @
      static public pure model boolean equational_theory(JMLEqualsSet s,
                                                  JMLEqualsSet s2,
                                                  Object e1,
                                                  Object e2);
      @*/
     ...
     */
    protected final /*@ nullable @*/ JMLListEqualsNode the_list;
    //@                                      in objectState;
    ...
    protected JMLEqualsSet (/*@ nullable @*/ JMLListEqualsNode ls, int sz) {
        //@ set owner = null;
        the_list = ls;
        size = sz;
     ...
     * @see #JMLEqualsSet()
     */
    public static final /*@ non_null @*/ JMLEqualsSet EMPTY
        = new JMLEqualsSet();
    ...
    public static /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSet singleton(Object e)
    {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSet convertFrom(/*@ non_null @*/ Object[] a)
    {
        /*@ non_null @*/ JMLEqualsSet ret = EMPTY;
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSet convertFrom(/*@ non_null @*/ java.util.Collection c)
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSet convertFrom(/*@ non_null @*/ JMLCollection c)
        throws ClassCastException
    {
        /*@ non_null @*/ JMLEqualsSet ret = EMPTY;
    ...
    /*@ 
      ...
      @*/  
    public /*@ non_null @*/ JMLEqualsSet insert(Object elem)
    ...
    /*@ protected normal_behavior
      ...
      @*/  
    protected /*@ non_null @*/ JMLEqualsSet fast_insert(Object elem) {
        return new JMLEqualsSet(  // cons() clones if necessary
                                JMLListEqualsNode.cons(elem, the_list),
                                size+1);
    }
    ...
    /*@ public normal_behavior
      ...
      @   public normal_example
      @     forall Object a, b, c;
      @     requires this.equals(new JMLEqualsSet(a).insert(b).insert(c))
      @              && int_size() == 3;
      @     ensures \result != null && \result.int_size() == 8
      @          && \result.has(EMPTY)
      @          && \result.has(new JMLEqualsSet(a))
      @          && \result.has(new JMLEqualsSet(b))
      @          && \result.has(new JMLEqualsSet(c))
      @          && \result.has(new JMLEqualsSet(a).insert(b))
      @          && \result.has(new JMLEqualsSet(a).insert(c))
      @          && \result.has(new JMLEqualsSet(b).insert(c))
      @          && \result.has(new JMLEqualsSet(a).insert(b).insert(c));
      @*/
    public /*@ non_null @*/ JMLEqualsSet powerSet()
        throws IllegalStateException
    {
        if (size >= 32) {
        ...
        while (elems.hasMoreElements()) { 
            ...
            while (size_i_and_smaller_subsets.hasMoreElements()) {
                JMLEqualsSet subset = (JMLEqualsSet)
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsSetEnumerator elements() {
    ...
    public /*@ non_null @*/ String toString() {
        String newStr = "{";
        JMLListEqualsNode setWalker = the_list;
        if (setWalker != null) {
