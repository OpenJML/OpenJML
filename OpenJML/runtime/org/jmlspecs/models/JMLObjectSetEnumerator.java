    ...
    implements JMLEnumeration, JMLObjectType
{
    ...
    //@ protected represents uniteratedElems <- new JMLObjectSet(currentNode);
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLObjectSetEnumerator(/*@ non_null @*/ JMLObjectSet s) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLObjectSetEnumerator(new JMLObjectSet(currentNode));
    } //@ nowarn Post;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLObjectSetEnumerator)) {
            return false;
        } else {
            JMLObjectSetEnumerator js = (JMLObjectSetEnumerator) oth;
            if (currentNode == null) {
