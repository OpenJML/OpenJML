// @(#)$Id: JMLInfiniteInteger.java,v 1.34 2007/02/08 14:05:50 leavens Exp $
    ...
    extends JMLComparable
{
    ...
    /*@  public normal_behavior
      ...
      @*/
    /*@ non_null @*/ BigInteger finiteValue() throws ArithmeticException;
    ...
    /*@ also
      ...
      @*/
    int compareTo(/*@ non_null @*/ Object o) throws ClassCastException;
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ non_null @*/ JMLInfiniteInteger abs();
    ...
    /*@ public normal_behavior
      ...
      @   |}
      @*/
    /*@ non_null @*/ JMLInfiniteInteger
        max(/*@ non_null @*/ JMLInfiniteInteger n);
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ non_null @*/ JMLInfiniteInteger
        min(/*@ non_null @*/ JMLInfiniteInteger n);
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ non_null @*/ JMLInfiniteInteger negate();
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ non_null @*/ JMLInfiniteInteger
        add(/*@ non_null @*/ JMLInfiniteInteger n);
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ non_null @*/ JMLInfiniteInteger
        subtract(/*@ non_null @*/ JMLInfiniteInteger n);
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ non_null @*/ JMLInfiniteInteger
        multiply(/*@ non_null @*/ JMLInfiniteInteger n);
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ non_null @*/ JMLInfiniteInteger
        divide(/*@ non_null @*/ JMLInfiniteInteger n)
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ non_null @*/ JMLInfiniteInteger
        remainder(/*@ non_null @*/ JMLInfiniteInteger n)
        throws ArithmeticException;
    ...
    /*@ public normal_behavior
      ...
      @*/
    /*@ non_null @*/ JMLInfiniteInteger
        mod(/*@ non_null @*/ JMLInfiniteInteger n)
        throws ArithmeticException;
    ...
    /*@ public normal_behavior
      ...
      @     signals_only ArithmeticException;
      @*/
    /*@ non_null @*/ JMLInfiniteInteger pow(int n) throws ArithmeticException;
