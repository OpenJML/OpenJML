    ...
    implements JMLEnumeration, JMLValueType
{
     ...
     */
    //@ public model JMLValueSequence uniteratedElems; in objectState;
    ...
    /*@ protected represents uniteratedElems
      @                  <- new JMLValueSequence(currentNode, remaining);
      @*/
    ...
    public /*@ non_null @*/ Object clone() {
        return
            new JMLValueSequenceEnumerator(new JMLValueSequence(currentNode,
                                                                  remaining));
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLValueSequenceEnumerator)) {
            ...
            JMLValueSequenceEnumerator js
                = (JMLValueSequenceEnumerator) oth;
            if (currentNode == null) {
