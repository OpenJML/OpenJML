...
/** Pairs of {@link JMLType} and {@link JMLType}, used in the types
 * {@link JMLValueToValueRelation} and {@link JMLValueToValueMap}.
 *
...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLValueValuePair implements JMLType {
     ...
     */
    public JMLValueValuePair(/*@ non_null @*/ JMLType dv,
                               /*@ non_null @*/ JMLType rv)
        throws NullPointerException
    {
        if (dv == null) {
            throw new NullPointerException("Attempt to create a"
                                           + " JMLValueValuePair with null"
                                           + " key");
        }
        if (rv == null) {
            throw new NullPointerException("Attempt to create a"
    ...
    /*@ also
      @  public model_program {
      @    return new JMLValueValuePair(key, value);
      @  }
      @*/
    ...
    /*@ also
      @  public normal_behavior
      @    requires obj != null && obj instanceof JMLValueValuePair;
      @    ensures \result == 
      @            ( ((JMLValueValuePair)obj).key.equals(key) 
      @              && ((JMLValueValuePair)obj).value.equals(value) );
      @ also 
      @  public normal_behavior
      @    requires obj == null || !(obj instanceof JMLValueValuePair);
      @    ensures !\result;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        if (obj != null && obj instanceof JMLValueValuePair) {
            JMLValueValuePair pair = (JMLValueValuePair)obj;
