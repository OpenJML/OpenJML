...
public class JMLObjectToObjectRelationImageEnumerator
    ...
    /*@ normal_behavior
      ...
      @    ensures owner == null;
      @*/
    JMLObjectToObjectRelationImageEnumerator(/*@ non_null @*/
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLObjectToObjectRelationImageEnumerator(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
             || !(oth instanceof JMLObjectToObjectRelationImageEnumerator)){
            return false;
        } else {
            JMLObjectToObjectRelationImageEnumerator js
                = (JMLObjectToObjectRelationImageEnumerator) oth;
        ...
        JMLValueSet abstractValue()
    {
        ...
        JMLObjectToObjectRelationImageEnumerator enum2
