...
/*@ nullable_by_default @*/ 
public class JMLValueToEqualsRelationImageEnumerator
    ...
    /*@ normal_behavior
      ...
      @    ensures owner == null;
      @*/
    JMLValueToEqualsRelationImageEnumerator(/*@ non_null @*/
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLValueToEqualsRelationImageEnumerator(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
             || !(oth instanceof JMLValueToEqualsRelationImageEnumerator)){
            return false;
        } else {
            JMLValueToEqualsRelationImageEnumerator js
                = (JMLValueToEqualsRelationImageEnumerator) oth;
        ...
        JMLValueSet abstractValue()
    {
        ...
        JMLValueToEqualsRelationImageEnumerator enum2
            = (JMLValueToEqualsRelationImageEnumerator) clone();
