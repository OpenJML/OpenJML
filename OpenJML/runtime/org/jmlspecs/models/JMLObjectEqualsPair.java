 ...
 * {@link JMLObjectToEqualsRelation} and {@link JMLObjectToEqualsMap}.
 *
...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLObjectEqualsPair implements JMLType {
     ...
     */
    public JMLObjectEqualsPair(/*@ non_null @*/ Object dv,
                               /*@ non_null @*/ Object rv)
        throws NullPointerException
    {
        if (dv == null) {
            throw new NullPointerException("Attempt to create a"
                                           + " JMLObjectEqualsPair with null"
                                           + " key");
        }
        if (rv == null) {
            throw new NullPointerException("Attempt to create a"
    ...
    /*@ also
      @  public model_program {
      @    return new JMLObjectEqualsPair(key, value);
      @  }
      @*/
    ...
    /*@ also
      @  public normal_behavior
      @    requires obj != null && obj instanceof JMLObjectEqualsPair;
      @    ensures \result == 
      @            ( ((JMLObjectEqualsPair)obj).key == key 
      @              && ((JMLObjectEqualsPair)obj).value.equals(value) );
      @ also 
      @  public normal_behavior
      @    requires obj == null || !(obj instanceof JMLObjectEqualsPair);
      @    ensures !\result;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        if (obj != null && obj instanceof JMLObjectEqualsPair) {
            JMLObjectEqualsPair pair = (JMLObjectEqualsPair)obj;
