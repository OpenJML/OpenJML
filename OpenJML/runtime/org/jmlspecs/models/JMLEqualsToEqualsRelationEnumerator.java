...
/*@ nullable_by_default @*/ 
public class JMLEqualsToEqualsRelationEnumerator
    ...
    protected
        ...
        //@ set returnsNull = false;
        imagePairEnum
            = (JMLEqualsToEqualsRelationImageEnumerator)ipEnum.clone();
    ...
    public Object nextElement() throws JMLNoSuchElementException {
        if (imageEnum.hasMoreElements()) {
            ...
            return new JMLEqualsEqualsPair(key, (Object)v);
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsEqualsPair nextPair()
        throws JMLNoSuchElementException {
        Object p = nextElement();  //@ nowarn Pre;
        //@ assume p != null && p instanceof JMLEqualsEqualsPair;
        JMLEqualsEqualsPair aPair = (JMLEqualsEqualsPair) p;
        //@ assume aPair != null;
        return aPair;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLEqualsToEqualsRelationEnumerator(imagePairEnum,
                                                          imageEnum,
                                                          key);
    } //@ nowarn Post;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
            ...
            JMLEqualsToEqualsRelationEnumerator js
                = (JMLEqualsToEqualsRelationEnumerator) oth;
        ...
        JMLValueSet abstractValue()
    {
        ...
        JMLEqualsToEqualsRelationEnumerator enum2
            = (JMLEqualsToEqualsRelationEnumerator) clone();
        while (enum2.hasMoreElements()) {
            //@ assume enum2.moreElements;
            JMLEqualsEqualsPair aPair = enum2.nextPair();
