    ...
    implements JMLEnumeration, JMLObjectType
{
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLEqualsSetEnumerator(/*@ non_null @*/ JMLEqualsSet s) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLEqualsSetEnumerator(new JMLEqualsSet(currentNode));
    } //@ nowarn Post;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLEqualsSetEnumerator)) {
            ...
            JMLEqualsSetEnumerator js = (JMLEqualsSetEnumerator) oth;
            if (currentNode == null) {
