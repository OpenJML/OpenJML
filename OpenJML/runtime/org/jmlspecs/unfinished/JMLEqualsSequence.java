    ...
    implements JMLCollection
{
    ...
    /*@  public normal_behavior
      ...
      @*/
    /*@ model public JMLEqualsSequence prefix(\bigint n) //FIXME, non_null
    ...
    /*@
      ...
      @*/
    /*@
      model public JMLEqualsSequence removePrefix(\bigint n) //FIXME,  @non_null@
        throws JMLSequenceException {
        if (n < 0 || n > length) {
            throw new
            ...
            if (n == 0) {
                ...
                return new JMLEqualsSequence(pfx_list, length-n);
            }
        }
    }@*/  
    ...
    model public  non_null  JMLEqualsSequence removeItemAt(\bigint index)
        ...
        if (0 <= index && index < length()) {
            ...
            return new JMLEqualsSequence(new_list, length()-1);
        } else {
            throw new
    ...
    model public  non_null  JMLEqualsSequence
        ...
        if (0 <= index && index < length()) {
            ...
            return new JMLEqualsSequence(new_list, length());
        } else {
            throw new
    ...
    /*@ //FIXME, _ alsoIfValue _
      ...
      @*/
    /*@
    model public non_null JMLEqualsSequence insertAfterIndex(\bigint afterThisOne,
    ...
    /*@ 
      model public  
        non_null JMLEqualsSequence insertBeforeIndex(\bigint beforeThisOne, Object item)
    ...
    public /*@ non_null @*/ JMLEqualsBag toBag() {
        ...
        JMLEqualsSequenceEnumerator elems = elements();
