 ...
 * @see JMLEqualsToEqualsRelationEnumerator
 ...
 */
//+OPENJML@ immutable
public /*@ pure @*/ class JMLEqualsToEqualsRelation
    ...
    /*@ public invariant
      ...
      @            obj != null
      @         && obj instanceof JMLEqualsEqualsPair
      @         && ((JMLEqualsEqualsPair)obj).key != null
      @         && ((JMLEqualsEqualsPair)obj).value != null);
      @ public invariant_redundantly
      @      (* Every element of 'theRelation'is a JMLEqualsEqualsPair
      @         whose key and value are not null *);
      @*/

    //@ public invariant elementType == \type(JMLEqualsEqualsPair);
    ...
    public JMLEqualsToEqualsRelation()
    {
        ...
        //@ set elementType = \type(JMLEqualsEqualsPair);
     ...
     * @see #JMLEqualsToEqualsRelation(JMLEqualsEqualsPair)
     */
    /*@  public normal_behavior
      ...
      @*/
    public JMLEqualsToEqualsRelation(/*@ non_null @*/ Object dv,
                                        /*@ non_null @*/ Object rv)
    {
        //@ set owner = null;
        //@ set containsNull = false;
    ...
    /** Initialize this to be a relation containing a single association
     *  given by the pair.
     * @see #singleton(JMLEqualsEqualsPair)
     * @see #JMLEqualsToEqualsRelation(Object, Object)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
      ...
      @*/
    public JMLEqualsToEqualsRelation(/*@ non_null @*/
    ...
    /*@  protected normal_behavior
      ...
      @*/
    protected
        JMLEqualsToEqualsRelation(/*@ non_null @*/ JMLValueSet ipset, 
     ...
     */
    public static final /*@ non_null @*/ JMLEqualsToEqualsRelation EMPTY
        = new JMLEqualsToEqualsRelation();
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLEqualsToEqualsRelation(dv, rv));
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToEqualsRelation
        singleton(/*@ non_null @*/ Object dv,
                  /*@ non_null @*/ Object rv) {
        return new JMLEqualsToEqualsRelation(dv, rv);
    }
    ...
    public static /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToEqualsRelation
        singleton(/*@ non_null @*/ JMLEqualsEqualsPair pair)
    {
     ...
     * @see #image
     * @see JMLEqualsToEqualsMap#apply
     */
    /*@  public normal_behavior
    ...
    {
        JMLEqualsToEqualsRelationImageEnumerator imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet image(/*@ non_null @*/ JMLEqualsSet dom)
    {
    ...
    {
        JMLEqualsToEqualsRelation invRel
            = new JMLEqualsToEqualsRelation();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet inverseImage(/*@ non_null @*/ JMLEqualsSet rng)
    {
        JMLEqualsSet invImg = new JMLEqualsSet();
        JMLEqualsToEqualsRelationImageEnumerator imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(/*@ non_null @*/ JMLEqualsEqualsPair pair)
    {
    ...
    /*@ also
      @  public normal_behavior
      @    ensures \result instanceof JMLEqualsToEqualsRelation
      @         && ((JMLEqualsToEqualsRelation)\result)
      @                    .theRelation.equals(this.theRelation);
      @*/
    public Object clone()
    {
        return new
            JMLEqualsToEqualsRelation(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        ...
        JMLEqualsToEqualsRelation rel
            = (JMLEqualsToEqualsRelation)obj;
    ...
    public /*@ pure @*/ /*@ non_null @*/ 
        JMLEqualsToEqualsRelation add(/*@ non_null @*/ Object dv,
                                         /*@ non_null @*/ Object rv)
        throws NullPointerException, IllegalStateException
    {
        ...
        return new JMLEqualsToEqualsRelation(newImagePairSet,
                                                newDom, newSize);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation insert(/*@ non_null @*/
                                         JMLEqualsEqualsPair pair)
     ...
     * @see #remove(JMLEqualsEqualsPair)
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation removeFromDomain(/*@ nullable @*/ Object dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation remove(Object dv, Object rv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation remove(/*@ non_null @*/
                                            JMLEqualsEqualsPair pair)
    {
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation 
        union(/*@ non_null @*/ JMLEqualsToEqualsRelation othRel)
        throws IllegalStateException
    {
        JMLValueSet newImagePairSet = new JMLValueSet();
        JMLEqualsSet newDom = domain_;
        ...
        return new JMLEqualsToEqualsRelation(newImagePairSet, newDom,
                                                newSize);
    }
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation
        intersection(/*@ non_null @*/ JMLEqualsToEqualsRelation othRel)
    {
        JMLValueSet newImagePairSet = new JMLValueSet();
    ...
    public /*@ non_null @*/  
        JMLEqualsToEqualsRelation
        difference(/*@ non_null @*/ JMLEqualsToEqualsRelation othRel)
    {
        JMLValueSet newImagePairSet = new JMLValueSet();
        JMLEqualsSet newDom = new JMLEqualsSet();
        int newSize = 0;
    ...
    /*@  public normal_behavior
      @    ensures \result != null &&
      @      \result.equals(new JMLEqualsToEqualsRelationEnumerator(this));
      @*/
    public /*@ non_null @*/
        JMLEqualsToEqualsRelationEnumerator associations()
    {
        return new JMLEqualsToEqualsRelationEnumerator(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToEqualsRelationEnumerator elements()
    {
        return associations();
    }
    ...
    /*@ public normal_behavior
      ...
      @                pv != null && pv instanceof JMLEqualsEqualsPair
      @             && this.isDefinedAt(((JMLEqualsEqualsPair)pv).key)
      @             && this.elementImage(((JMLEqualsEqualsPair)pv).key)
      @                    .has(((JMLEqualsEqualsPair)pv).value));
      @             
      @*/
    public /*@ non_null @*/ JMLValueSet toSet() {
        JMLEqualsToEqualsRelationEnumerator pairEnum = this.associations();
        JMLValueSet ret = new JMLValueSet();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLEqualsEqualsPair p = pairEnum.nextPair();
            ret = ret.insert(p);
        }
        return ret;
    } //@ nowarn Exception;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToEqualsRelationImageEnumerator imagePairs() {
        return new JMLEqualsToEqualsRelationImageEnumerator(this);
    }
