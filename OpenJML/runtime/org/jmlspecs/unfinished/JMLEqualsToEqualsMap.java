 ...
 *  documentation for {@link JMLEqualsToEqualsRelation} and for the
 ...
 * @see JMLEqualsToEqualsRelation#toFunction()
 */
//+OPENJML@ immutable
public /*@ pure @*/
// FIXME: adapt this file to non-null-by-default and remove the following modifier.
/*@ nullable_by_default @*/ 
class JMLEqualsToEqualsMap extends JMLEqualsToEqualsRelation {
     ...
     * @see #JMLEqualsToEqualsMap(JMLEqualsEqualsPair)
     */
    /*@  public normal_behavior
      ...
      @*/
    public JMLEqualsToEqualsMap(/*@ non_null @*/ Object dv,
                                   /*@ non_null @*/ Object rv)
    {
        super(dv, rv);
    }
     ...
     * @see #singletonMap(JMLEqualsEqualsPair)
     * @see #JMLEqualsToEqualsMap(Object, Object)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
      ...
      @*/
    public JMLEqualsToEqualsMap(/*@ non_null @*/
    ...
    protected JMLEqualsToEqualsMap(JMLValueSet ipset,
                                      JMLEqualsSet dom,
                                      int sz)
    {
        super(ipset, dom, sz);
     ...
     */
    public static final /*@ non_null @*/ JMLEqualsToEqualsMap EMPTY
        = new JMLEqualsToEqualsMap();
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLEqualsToEqualsMap(dv, rv));
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        ...
        singletonMap(/*@ non_null @*/ Object dv,
                     /*@ non_null @*/ Object rv)
    {
        return new JMLEqualsToEqualsMap(dv, rv);
    }
    ...
    /*@ public normal_behavior
      @    requires pair != null;
      @    ensures \result != null
      @         && \result.equals(new JMLEqualsToEqualsMap(pair));
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToEqualsMap
        singletonMap(/*@ non_null @*/ JMLEqualsEqualsPair pair)
    {
        return new JMLEqualsToEqualsMap(pair);
    }
     ...
     * @see JMLEqualsToEqualsRelation#isDefinedAt
     * @see JMLEqualsToEqualsRelation#elementImage
     * @see JMLEqualsToEqualsRelation#image
     */
    /*@  public normal_behavior
    ...
    {
        JMLEqualsSet img = elementImage(dv);
        if (img.int_size() == 1) {
    ...
    /*@ also
      @   public normal_behavior
      @     ensures \result instanceof JMLEqualsToEqualsMap
      @          && ((JMLEqualsToEqualsMap)\result)
      @                .theRelation.equals(this.theRelation);
      @*/
    //@ pure
    public /*@ non_null @*/ Object clone() 
    {
        return new JMLEqualsToEqualsMap(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
     ...
     * @see JMLEqualsToEqualsRelation#insert(Object, Object)
     */
    /*@  public normal_behavior
      @    requires dv != null && rv != null;
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToEqualsMap extend(/*@ non_null @*/ Object dv,
                                       /*@ non_null @*/ Object rv) 
    {
        JMLEqualsToEqualsMap newMap = this.removeDomainElement(dv);
        newMap = newMap.disjointUnion(new JMLEqualsToEqualsMap(dv, rv));
        return newMap;
    } //@ nowarn Exception;

    /** Return a new map that is like this but has no association for the
     *  given domain element.
     * @see JMLEqualsToEqualsRelation#removeFromDomain
     */
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToEqualsMap removeDomainElement(Object dv)
    {
     ...
     * @see JMLEqualsToEqualsRelation#restrictDomainTo
     */
    /*@  public normal_behavior
      @    requires dom != null;
     ...
     * @see #restrictedTo
     * @see JMLEqualsToEqualsRelation#restrictRangeTo
     */
    /*@  public normal_behavior
      @    requires rng != null;
      @    ensures (\forall JMLEqualsEqualsPair pair; ;
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsMap
        rangeRestrictedTo(/*@ non_null @*/ JMLEqualsSet rng)
    {
     ...
     * @see #disjointUnion
     * @see JMLEqualsToEqualsRelation#union
     */
    /*@  public normal_behavior
      @    requires othMap != null;
      @    requires int_size()
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsMap
        extendUnion(/*@ non_null @*/ JMLEqualsToEqualsMap othMap) 
        throws IllegalStateException
    {
        JMLEqualsToEqualsMap newMap 
            = this.restrictedTo(this.domain_.difference(othMap.domain_));
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            return
                new JMLEqualsToEqualsMap(newMap.imagePairSet_
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsMap
        clashReplaceUnion(JMLEqualsToEqualsMap othMap,
                          Object errval)
        throws IllegalStateException
    {
        ...
        JMLEqualsToEqualsRelation newRel;
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            newRel = new JMLEqualsToEqualsRelation(newMap.imagePairSet_
                                                      .union(othMap
                                                             .imagePairSet_),
                                                      newMap.domain_
                                                      .union(othMap.domain_),
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsMap 
        disjointUnion(/*@ non_null @*/ JMLEqualsToEqualsMap othMap) 
        throws JMLMapException, IllegalStateException
    {
        ...
        if (overlappingDom.isEmpty()) {
            if (this.size_ <= Integer.MAX_VALUE - othMap.size_) {
                return new JMLEqualsToEqualsMap(this.imagePairSet_
                                                   .union(othMap
                                                          .imagePairSet_),
                                                   this.domain_
                                                   .union(othMap.domain_),
