 ...
 */
//+OPENJML@ immutable
public /*@ pure @*/ class JMLValueToObjectRelation
    ...
    /*@ public invariant
      ...
      @            obj != null
      @         && obj instanceof JMLValueObjectPair
      @         && ((JMLValueObjectPair)obj).key != null
      @         && ((JMLValueObjectPair)obj).value != null);
      @ public invariant_redundantly
      @      (* Every element of 'theRelation'is a JMLValueObjectPair
     ...
     * @see #JMLValueToObjectRelation(JMLValueObjectPair)
     */
    /*@  public normal_behavior
      ...
      @*/
    public JMLValueToObjectRelation(/*@ non_null @*/ JMLType dv,
                                        /*@ non_null @*/ Object rv)
    {
        //@ set owner = null;
        //@ set containsNull = false;
    ...
    /** Initialize this to be a relation containing a single association
     *  given by the pair.
     * @see #singleton(JMLValueObjectPair)
     * @see #JMLValueToObjectRelation(JMLType, Object)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
      ...
      @*/
    public JMLValueToObjectRelation(/*@ non_null @*/
    ...
    /*@  protected normal_behavior
      ...
      @*/
    protected
        JMLValueToObjectRelation(/*@ non_null @*/ JMLValueSet ipset, 
     ...
     * @see #JMLValueToObjectRelation()
     */
    public static final /*@ non_null @*/ JMLValueToObjectRelation EMPTY
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLValueToObjectRelation(dv, rv));
      @*/
    ...
    public static /*@ pure @*/ /*@ non_null @*/
        JMLValueToObjectRelation
        singleton(/*@ non_null @*/ JMLValueObjectPair pair)
    {
    ...
    /*@  public normal_behavior
      ...
      @                  (\exists JMLValueObjectPair pair;
      @                      theRelation.has(pair);
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectSet elementImage(/*@ nullable @*/ JMLType dv)
    {
    ...
    /*@  public normal_behavior
      ...
      @    ensures_redundantly
      @              (\forall JMLValueObjectPair pair;
      @                      theRelation.has(pair);
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectSet image(/*@ non_null @*/ JMLValueSet dom)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLObjectToValueRelation inverse()
    {
        JMLObjectToValueRelation invRel
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet inverseImage(/*@ non_null @*/ JMLObjectSet rng)
    {
        JMLValueSet invImg = new JMLValueSet();
        JMLValueToObjectRelationImageEnumerator imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(/*@ non_null @*/ JMLValueObjectPair pair)
    {
    ...
    /*@ also
      @  public normal_behavior
      @    ensures \result instanceof JMLValueToObjectRelation
      @         && ((JMLValueToObjectRelation)\result)
      @                    .theRelation.equals(this.theRelation);
      @*/
    public Object clone()
    {
        return new
            JMLValueToObjectRelation(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    /*@ also
      @  public normal_behavior
      @    requires obj != null && obj instanceof JMLValueToObjectRelation;
      @    ensures \result == 
      @            this.theRelation.equals(
      @                    ((JMLValueToObjectRelation)obj).theRelation);
      @ also 
      @  public normal_behavior
      @    requires obj == null
      @          || !(obj instanceof JMLValueToObjectRelation);
      @    ensures !\result;
      @*/
    ...
    /*@  public normal_behavior
      ...
      @           this.theRelation.insert(new JMLValueObjectPair(dv, rv)));
      @*/
    public /*@ pure @*/ /*@ non_null @*/ 
        JMLValueToObjectRelation add(/*@ non_null @*/ JMLType dv,
                                         /*@ non_null @*/ Object rv)
        throws NullPointerException, IllegalStateException
    {
        ...
        return new JMLValueToObjectRelation(newImagePairSet,
                                                newDom, newSize);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToObjectRelation insert(/*@ non_null @*/
                                         JMLValueObjectPair pair)
    ...
    /*@  public normal_behavior
      ...
      @                      <==> \result.theRelation
      @                            .has(new JMLValueObjectPair(val,r))
      @                          && !val.equals(dv))));
      @ implies_that
      @   public normal_behavior
      @    requires dv == null;
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToObjectRelation removeFromDomain(/*@ nullable @*/ JMLType dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
    ...
    /*@  public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result.theRelation.equals(
      @                theRelation.remove(new JMLValueObjectPair(dv, rv)));
      @   also
      @    requires dv == null || rv == null;
      @    ensures \result != null && \result.equals(this);
      @*/
    public /*@ non_null @*/ 
        JMLValueToObjectRelation remove(JMLType dv, Object rv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToObjectRelation remove(/*@ non_null @*/
                                            JMLValueObjectPair pair)
    {
    ...
    public /*@ non_null @*/ 
        JMLValueToObjectRelation 
        union(/*@ non_null @*/ JMLValueToObjectRelation othRel)
        throws IllegalStateException
    {
        JMLValueSet newImagePairSet = new JMLValueSet();
        JMLValueSet newDom = domain_;
        ...
        return new JMLValueToObjectRelation(newImagePairSet, newDom,
                                                newSize);
    }
    ...
    public /*@ non_null @*/ 
        JMLValueToObjectRelation
        intersection(/*@ non_null @*/ JMLValueToObjectRelation othRel)
    {
        JMLValueSet newImagePairSet = new JMLValueSet();
        JMLValueSet newDom = new JMLValueSet();
        int newSize = 0;
    ...
    public /*@ non_null @*/  
        JMLValueToObjectRelation
        difference(/*@ non_null @*/ JMLValueToObjectRelation othRel)
    {
        JMLValueSet newImagePairSet = new JMLValueSet();
        JMLValueSet newDom = new JMLValueSet();
        int newSize = 0;
    ...
    /*@  public normal_behavior
      @    requires dom != null;
      @    ensures (\forall JMLValueObjectPair pair; pair != null;
    ...
    /*@  public normal_behavior
      @    ensures \result != null &&
      @      \result.equals(new JMLValueToObjectRelationEnumerator(this));
      @*/
    public /*@ non_null @*/
        JMLValueToObjectRelationEnumerator associations()
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToObjectRelationEnumerator elements()
    {
        return associations();
    }
    ...
    /*@ public normal_behavior
      ...
      @                pv != null && pv instanceof JMLValueObjectPair
      @             && this.isDefinedAt(((JMLValueObjectPair)pv).key)
      @             && this.elementImage(((JMLValueObjectPair)pv).key)
      @                    .has(((JMLValueObjectPair)pv).value));
      @             
      @*/
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToObjectRelationImageEnumerator imagePairs() {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueToObjectMap toFunction()
    {
        JMLValueSet newDom = domain_;
