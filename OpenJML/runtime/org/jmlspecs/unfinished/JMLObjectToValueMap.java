 ...
 *  JMLObjectToValueRelation}, and as such as can be treated as a
 *  binary relation or a set valued function also.  See the
 *  documentation for {@link JMLObjectToValueRelation} and for the
 ...
 * @see JMLObjectToValueRelation#toFunction()
 */
//+OPENJML@ immutable
public /*@ pure @*/
// FIXME: adapt this file to non-null-by-default and remove the following modifier.
/*@ nullable_by_default @*/ 
class JMLObjectToValueMap extends JMLObjectToValueRelation {
     ...
     * @see #JMLObjectToValueMap(JMLObjectValuePair)
     */
    /*@  public normal_behavior
     ...
     * @see #singletonMap(JMLObjectValuePair)
     * @see #JMLObjectToValueMap(Object, JMLType)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
      ...
      @*/
    public JMLObjectToValueMap(/*@ non_null @*/
     ...
     * @see #JMLObjectToValueMap()
     */
    public static final /*@ non_null @*/ JMLObjectToValueMap EMPTY
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLObjectToValueMap(dv, rv));
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        ...
        singletonMap(/*@ non_null @*/ Object dv,
                     /*@ non_null @*/ JMLType rv)
    {
        return new JMLObjectToValueMap(dv, rv);
    }
    ...
    /*@ public normal_behavior
      @    requires pair != null;
      @    ensures \result != null
      @         && \result.equals(new JMLObjectToValueMap(pair));
      @*/
    public static /*@ pure @*/ /*@ non_null @*/
        JMLObjectToValueMap
        singletonMap(/*@ non_null @*/ JMLObjectValuePair pair)
    {
        return new JMLObjectToValueMap(pair);
    }
     ...
     * @see JMLObjectToValueRelation#isDefinedAt
     * @see JMLObjectToValueRelation#elementImage
     * @see JMLObjectToValueRelation#image
     */
    /*@  public normal_behavior
    ...
    /*@ also
      @   public normal_behavior
      @     ensures \result instanceof JMLObjectToValueMap
      @          && ((JMLObjectToValueMap)\result)
      @                .theRelation.equals(this.theRelation);
      @*/
    //@ pure
    public /*@ non_null @*/ Object clone() 
    {
        return new JMLObjectToValueMap(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectToValueMap extend(/*@ non_null @*/ Object dv,
                                       /*@ non_null @*/ JMLType rv) 
    {
     ...
     * @see JMLObjectToValueRelation#removeFromDomain
     */
    /*@  public normal_behavior
     ...
     * @see JMLObjectToValueRelation#restrictDomainTo
     */
    /*@  public normal_behavior
      @    requires dom != null;
      @    ensures (\forall JMLObjectValuePair pair; ; 
     ...
     * @see #restrictedTo
     * @see JMLObjectToValueRelation#restrictRangeTo
     */
    /*@  public normal_behavior
      @    requires rng != null;
      @    ensures (\forall JMLObjectValuePair pair; ;
     ...
     * @see #disjointUnion
     * @see JMLObjectToValueRelation#union
     */
    /*@  public normal_behavior
      @    requires othMap != null;
      @    requires int_size()
    ...
    public /*@ non_null @*/ 
        JMLObjectToValueMap
        extendUnion(/*@ non_null @*/ JMLObjectToValueMap othMap) 
        throws IllegalStateException
    {
        JMLObjectToValueMap newMap 
            = this.restrictedTo(this.domain_.difference(othMap.domain_));
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            return
                new JMLObjectToValueMap(newMap.imagePairSet_
        ...
        throws IllegalStateException
    {
        ...
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            newRel = new JMLObjectToValueRelation(newMap.imagePairSet_
                                                      .union(othMap
                                                             .imagePairSet_),
                                                      newMap.domain_
                                                      .union(othMap.domain_),
    ...
    public /*@ non_null @*/ 
        JMLObjectToValueMap 
        disjointUnion(/*@ non_null @*/ JMLObjectToValueMap othMap) 
        throws JMLMapException, IllegalStateException
    {
        ...
        if (overlappingDom.isEmpty()) {
            if (this.size_ <= Integer.MAX_VALUE - othMap.size_) {
                return new JMLObjectToValueMap(this.imagePairSet_
                                                   .union(othMap
                                                          .imagePairSet_),
                                                   this.domain_
                                                   .union(othMap.domain_),
