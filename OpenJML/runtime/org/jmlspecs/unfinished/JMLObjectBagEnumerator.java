...
/*@ nullable_by_default @*/ 
public class JMLObjectBagEnumerator
    implements JMLEnumeration, JMLObjectType
{
    /** The elements that have not yet been returned by nextElement.
     */
    //@ public model JMLObjectBag uniteratedElems;   in objectState;

    /** The bag underlying this enumerator.
     */
    protected /*@ non_null @*/ JMLObjectBag currentBag;
    //@                                        in uniteratedElems;
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLObjectBagEnumerator(/*@ non_null @*/ JMLObjectBag b) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLObjectBagEnumerator(abstractValue());
    } //@ nowarn Post;

    /** Return the abstract value of this bag enumerator.
     */
    protected /*@ pure non_null @*/ JMLObjectBag abstractValue() {
        JMLObjectBag absVal = currentBag;
        if (currentCount > 0) {
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLObjectBagEnumerator)) {
            return false;
        } else {
            JMLObjectBagEnumerator jb = (JMLObjectBagEnumerator) oth;
