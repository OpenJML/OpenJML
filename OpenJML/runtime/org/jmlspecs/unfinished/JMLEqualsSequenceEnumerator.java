...
/*@ nullable_by_default @*/ 
public class JMLEqualsSequenceEnumerator
    implements JMLEnumeration, JMLObjectType
{

    /** The elements that have not yet been returned by nextElement.
     */
    //@ public model JMLEqualsSequence uniteratedElems; in objectState;
    ...
    /*@ protected represents uniteratedElems
      @                  <- new JMLEqualsSequence(currentNode, remaining);
      @*/
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLEqualsSequenceEnumerator(/*@ non_null @*/ JMLEqualsSequence s) {
        //@ set owner = null;
    ...
    /*@ also
      ...
      @    ensures \old(uniteratedElems).itemAt(0) .equals(\result)
    ...
    public /*@ non_null @*/ Object clone() {
        return
            new JMLEqualsSequenceEnumerator(new JMLEqualsSequence(currentNode,
                                                                  remaining));
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLEqualsSequenceEnumerator)) {
            return false;
        } else {
            JMLEqualsSequenceEnumerator js
                = (JMLEqualsSequenceEnumerator) oth;
            if (currentNode == null) {
