...
/*@ nullable_by_default @*/ 
public class JMLObjectToValueRelationImageEnumerator
    ...
    /*@ normal_behavior
      ...
      @    ensures owner == null;
      @*/
    JMLObjectToValueRelationImageEnumerator(/*@ non_null @*/
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLObjectToValueRelationImageEnumerator(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
             || !(oth instanceof JMLObjectToValueRelationImageEnumerator)){
            return false;
        } else {
            JMLObjectToValueRelationImageEnumerator js
                = (JMLObjectToValueRelationImageEnumerator) oth;
        ...
        JMLValueSet abstractValue()
    {
        ...
        JMLObjectToValueRelationImageEnumerator enum2
