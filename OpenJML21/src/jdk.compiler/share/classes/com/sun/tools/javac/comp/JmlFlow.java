...
public class JmlFlow extends Flow  {
    ...
    public boolean aliveAfter(Env<AttrContext> env, JCTree that, TreeMaker make) {
        ...
        try {
            SnippetAliveAnalyzer analyzer = new JmlSnippetAliveAnalyzer();
    ...
    public boolean breaksToTree(Env<AttrContext> env, JCTree breakTo, JCTree body, TreeMaker make) {
        ...
        Log.DiagnosticHandler diagHandler = new Log.DiscardDiagnosticHandler(log);
        try {
            SnippetBreakToAnalyzer analyzer = new JmlSnippetBreakToAnalyzer(breakTo);
...
//            }
    ...
    class JmlSnippetAliveAnalyzer extends SnippetAliveAnalyzer implements IJmlVisitor {
...
//            }
    ...
    class JmlSnippetBreakToAnalyzer extends SnippetBreakToAnalyzer implements IJmlVisitor {

        public JmlSnippetBreakToAnalyzer(JCTree breakTo) {
            super(breakTo);
        }
